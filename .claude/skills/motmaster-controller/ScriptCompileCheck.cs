...
//
// Compiled together with ScriptSmokeTest.cs (the console entry point, same folder) by
// verify-scripts.ps1 - this file is the check logic, that one is the CLI wrapper.
...
namespace MOTMasterScriptCheck
{
