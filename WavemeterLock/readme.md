...
* [v 2.1.1] September 8th 2026: Reduced CPU usage by throttling the main polling loop and the lock block checking loop, which were previously spinning unthrottled.
