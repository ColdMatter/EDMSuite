...
namespace Analysis
{
    //Note that this has been temporarily disabled to break the dependency of SharedCode on
    // the NI libraries. This means that, for the moment, only fixed gates are supported.
