...
{
    public partial class PTabView : CaFBECHardwareController.Controls.GenericView
    {
        protected PTabController castController;

        public PTabView(PTabController controllerInstance) : base(controllerInstance)
        {
            InitializeComponent();
            castController = (PTabController)controller;
            ...
            this.DataGraph.ChartAreas[0].AxisY.IsLogarithmic = true;
            this.DataGraph.ChartAreas[0].AxisY.LabelStyle.Format = "0.0E0#";
