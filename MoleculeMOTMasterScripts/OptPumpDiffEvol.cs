...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["yShimOPCurrent"] = 5.0;// -1.92
        ...
        Parameters["v0IntensityRampEndValue"] = 8.2;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        */
        ...
        p.AddEdge("dipoleTrapAOM", cafOPStartTime, false);
        p.AddEdge("dipoleTrapAOM", cafOPStartTime + (int)Parameters["CaFOPDuration"], true);
