...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        //Shim fields for OP
        Parameters["xShimOPCurrent"] = -7.5;// 5.0
        Parameters["yShimOPCurrent"] = 6.0;// -1.92
        Parameters["zShimOPCurrent"] = -4.0;// -0.22 is zero
        ...
        Parameters["SecondMicrowavePulseDuration"] = 13;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        */
        ...
        p.AddEdge("v00MOTAOM", motRecaptureTime, false);
