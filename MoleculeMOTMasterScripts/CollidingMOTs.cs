...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["RbMOTLoadTime"] = 70000;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int secondImageTime = firstImageTime + 3000;
        int thridImageTime = secondImageTime + 3000;
        int fourthImageTime = thridImageTime + 3000;
        int fithImageTime = fourthImageTime + 3000;
        int sixthImageTime = fithImageTime + 3000;
        int seventhImageTime = sixthImageTime + 3000;
        int eightImageTime = seventhImageTime + 3000;
        ...
        p.AddEdge("rb3DCooling", sixthImageTime + 3000, true);
        ...
        p.AddEdge("rbAbsImagingBeam", sixthImageTime + 3200 + (int)Parameters["FreeExpansionTime"], false);
        p.AddEdge("rbAbsImagingBeam", sixthImageTime + 3200 + 150 + (int)Parameters["FreeExpansionTime"], true);
        p.AddEdge("rbAbsImagingBeam", sixthImageTime + 7200 + (int)Parameters["FreeExpansionTime"], false);
        p.AddEdge("rbAbsImagingBeam", sixthImageTime + 7200 + 150 + (int)Parameters["FreeExpansionTime"], true);

        p.Pulse(0, sixthImageTime + 3200 + (int)Parameters["FreeExpansionTime"], (int)Parameters["Frame0TriggerDuration"], "rbAbsImgCamTrig"); //trigger camera to take image of cloud
        p.Pulse(0, sixthImageTime + 7200 + (int)Parameters["FreeExpansionTime"], (int)Parameters["Frame0TriggerDuration"], "rbAbsImgCamTrig"); //trigger camera to take image of probe
        p.Pulse(0, sixthImageTime + 11200 + (int)Parameters["FreeExpansionTime"], (int)Parameters["Frame0TriggerDuration"], "rbAbsImgCamTrig"); //trigger camera to take image of background
        */
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        // B Field
        p.AddAnalogValue("MOTCoilsCurrent", rbMOTLoadingStartTime, 0.5);
        p.AddAnalogValue("MOTCoilsCurrent", moleculeMOTLoadingStartTime, 1.0);
        //p.AddAnalogValue("MOTCoilsCurrent", (int)Parameters["Frame0Trigger"], 0.0);
        p.AddAnalogValue("MOTCoilsCurrent", sixthImageTime + 3000, 0.0);
        ...
        p.AddAnalogValue("rb3DCoolingFrequency", rbMOTLoadingEndTime, (double)Parameters["NewCoolingFrequency"]);
        //p.AddAnalogValue("rbRepumpFrequency", rbMOTLoadingEndTime, (double)Parameters["NewRepumpFrequency"]);
        //p.AddAnalogValue("rbRepumpFrequency", sixthImageTime + 3150, (double)Parameters["MOTRepumpLoadingFrequency"]);

        //p.AddAnalogValue("rb3DCoolingAttenuation", rbMOTLoadingStartTime, 0.0);
        //p.AddLinearRamp("rb3DCoolingAttenuation", moleculeMOTLoadingStartTime + 500, 500, (double)Parameters["RbCoolingIntensityRampEndValue"]);
