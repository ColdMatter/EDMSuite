...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["slowingRepumpAOMOffDuration"] = 130000;
        ...
        Parameters["yShimLoadCurrentOP"] = 2.0;//-1.92;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        */
        ...
        p.Pulse(0, molassesStartTime - 1500, motRecaptureTime + 5000, "bXSlowingShutter"); //B-X shutter closed after blow away
        ...
        p.AddEdge("rb2DMOTShutter", molassesEndTime + (int)Parameters["OPDuration"]-1800, false);
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("xShimCoilCurrent", mqtStartTime + 100, (double)Parameters["xShimLoadCurrent"]);
        p.AddAnalogValue("yShimCoilCurrent", mqtStartTime + 100, (double)Parameters["yShimLoadCurrent"]);
        p.AddAnalogValue("zShimCoilCurrent", mqtStartTime + 100, (double)Parameters["zShimLoadCurrent"]);
