...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["MOTRecaptureDuration"] = 10000;

        // Camera
        Parameters["Frame0Trigger"] = (int)Parameters["MOTSwitchOffTime"] + (int)Parameters["MolassesDuration"] + 100;
        ...
        Parameters["v0FrequencyNewValue"] = 16.0; //set this to MHz detuning desired if doing frequency jump (positive for blue detuning)
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(patternStartBeforeQ, (int)Parameters["MOTSwitchOffTime"] + (int)Parameters["MolassesDuration"], (int)Parameters["MOTRecaptureDuration"], "bTrigger"); //// B Field pulse for the BOP (top MOT coil) - bottom coil is in analog section
