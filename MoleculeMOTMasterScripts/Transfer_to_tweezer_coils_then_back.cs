...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["TweezerImageDur"] = 100;
        ...
        */
        ...
        Parameters["TweezerCoilsHold"] = 10000;

        Parameters["FinalCoilsHold"] = 4000;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int TweezerHandoverStart1 = TweezerHandoverEnd + (int)Parameters["TweezerCoilsHold"];
        int MoveBackStart = TweezerHandoverStart1 + (int)Parameters["HandoverDur"];
        int FinalHandoverStart = MoveBackStart + (int)Parameters["MoveTime"];
        int FinalHandoverEnd = FinalHandoverStart + (int)Parameters["HandoverDur"];
        int Coilsoff = FinalHandoverEnd + (int)Parameters["FinalCoilsHold"];
        ...
        addDDSPattern(p, "image", FinalHandoverEnd+250,
            (double)Parameters["FreqCVB1"], (double)Parameters["FreqCVB2"], (double)Parameters["FreqCVB3"], (double)Parameters["FreqCVB4"],
            (double)Parameters["BMOTAmpDDS1"], (double)Parameters["BMOTAmpDDS2"], (double)Parameters["BMOTAmpDDS3"], (double)Parameters["BMOTAmpDDS4"]);
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(0, FinalHandoverEnd, (int)Parameters["FinalCoilsHold"], "cameraTrigger"); //Tweezer camera trig
        ...
        //p.AddEdge("test10", FinalCoilsHold - 250, true); //Shutter CaF light to tweezer chamber - OPEN
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        */
        ...
        p.AddLinearRamp("TweezerCoils", TweezerHandoverStart, (int)Parameters["HandoverDur"], 1.8);

        //Hold in tweezer coils
        p.AddAnalogValue("TweezerCoils", TweezerHandoverEnd, 1.8);

        //Hand back to T coils
        p.AddLinearRamp("transferCoils", TweezerHandoverStart1, (int)Parameters["HandoverDur"], 10.0);
        p.AddLinearRamp("TweezerCoils", TweezerHandoverStart1, (int)Parameters["HandoverDur"], 0.0);

        //Hand back to MOT coils
        p.AddLinearRamp("MOTCoilsCurrent", FinalHandoverStart, (int)Parameters["HandoverDur"], (double)Parameters["BlueMOTField"]);
        p.AddLinearRamp("transferCoils", FinalHandoverStart, (int)Parameters["HandoverDur"], 0.0);

        // Hold in MOT coils
        p.AddAnalogValue("MOTCoilsCurrent", FinalHandoverEnd, (double)Parameters["BlueMOTField"]);

        // All coils off
        p.AddAnalogValue("TweezerCoils", Coilsoff, 0.0);
        p.AddAnalogValue("MOTCoilsCurrent", Coilsoff, 0.0);
        p.AddAnalogValue("transferCoils", Coilsoff, 0.0);
        return p;
    }
