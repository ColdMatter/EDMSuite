...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["FreeExpansionTime"] = 1300;

        Parameters["RbMOTLoadTime"] = 2000;

        Parameters["FluorescenceImagingFrequency"] = 0.1;
        ...
        Parameters["SecondMicrowavePulseDuration"] = 8;
        ...
        Parameters["xShimImagingCurrent"] = 0.0;// -1.35 is zero
        Parameters["yShimImagingCurrent"] = 0.0;// -1.92 is zero
        Parameters["zShimImagingCurrent"] = 0.0;// -0.22 is zero
        ...
        //Rb light:
        Parameters["ImagingFrequency"] = 2.5;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        //p.AddEdge("rb3DCooling", motRecaptureTime, false);
        //p.AddEdge("rb3DCooling", motRecaptureTime + 25, true);
        ...
        p.AddEdge("rbRepump", motRecaptureTime, false);
        ...
        p.AddEdge("rbAbsImagingBeam", motRecaptureTime, false);
        p.AddEdge("rbAbsImagingBeam", motRecaptureTime + 15, true);
        p.AddEdge("rbAbsImagingBeam", motRecaptureTime + 12000, false);
        p.AddEdge("rbAbsImagingBeam", motRecaptureTime + 12000 + 15, true);

        p.Pulse(0, motRecaptureTime, 15, "cameraTrigger");
        p.Pulse(0, motRecaptureTime + 12000, 15, "cameraTrigger");
        p.Pulse(0, motRecaptureTime + 24000, 15, "cameraTrigger");
        ...
        //p.Pulse(0, motRecaptureTime, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger"); // camera trigger

        //Mechanical CaF shutters:
        p.Pulse(0, secondMicrowavePulseTime - 1500, finalImageTime - secondMicrowavePulseTime + 4000, "bXSlowingShutter"); //B-X shutter closed after blow away
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("MOTCoilsCurrent", motRecaptureTime - (int)Parameters["FreeExpansionTime"], -0.05);
        ...
        p.AddAnalogValue("xShimCoilCurrent", mqtStartTime + 10000, (double)Parameters["xShimImagingCurrent"]);
        p.AddAnalogValue("yShimCoilCurrent", mqtStartTime + 10000, (double)Parameters["yShimImagingCurrent"]);
        p.AddAnalogValue("zShimCoilCurrent", mqtStartTime + 10000, (double)Parameters["zShimImagingCurrent"]);
        ...
        p.AddAnalogValue("rb3DCoolingFrequency", motRecaptureTime - 1000, (double)Parameters["FluorescenceImagingFrequency"]);
        return p;
    }
