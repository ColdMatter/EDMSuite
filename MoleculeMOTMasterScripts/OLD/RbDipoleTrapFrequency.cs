...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["DipoleTrapReleaseTime"] = 30;
        Parameters["DipoleTrapReholdTime"] = 30;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int dipoleTrapRestartTime = dipoleTrapEndTime + (int)Parameters["DipoleTrapReleaseTime"];
        int dipoleTrapSecondEndTime = dipoleTrapRestartTime + (int)Parameters["DipoleTrapReholdTime"];
        int cameraTrigger1 = dipoleTrapSecondEndTime + (int)Parameters["FreeExpansionTime"];
        ...
        p.AddEdge("dipoleTrapAOM", dipoleTrapRestartTime, true);
        p.AddEdge("dipoleTrapAOM", dipoleTrapSecondEndTime, false);
