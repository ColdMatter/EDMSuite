...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        //Transport MQT:
        Parameters["ExtMQTHoldDuration"] = 100000;//180000;
        ...
        Parameters["DurationIntMagTrapTweezer"] = 100;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int motRecaptureTime = mqtExternalEndTime - 50000;//- 1000;
        ...
        {
            p.AddEdge("cafOptPumpingShutter", OPbiasfieldSettleTime + (int)Parameters["OPDuration"], false);
