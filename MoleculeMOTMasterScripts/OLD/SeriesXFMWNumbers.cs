...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["OPShutterOpeningDelay"] = 1400;
        Parameters["OPShutterClosingDelay"] = 1500;
        ...
        // Blow away
        // Not in use in the script, but required for
        // LoadMoleculeMOTNoSlowingEdge to work
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int motRecaptureTime = fmwEndTime + (int)Parameters["WaitBeforeMOTRecapture"];
