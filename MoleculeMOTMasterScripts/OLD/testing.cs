...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["MolassesHoldDuration"] = 700;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int firstImageTime = motRampEndTime + (int)Parameters["WaitBeforeImage"];
        int cmotRampStartTime = firstImageTime + (int)Parameters["MOTHoldDuration"];
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("v00Intensity", molassesEndTime, (double)Parameters["v0IntensityRampEndValue"]);
        // v0 Frequency
