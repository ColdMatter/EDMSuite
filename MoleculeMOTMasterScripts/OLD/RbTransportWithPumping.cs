...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["PatternLength"] = 450000;
        ...
        Parameters["OpticalPumpingDuration"] = 30;//40;
        ...
        //Rb light
        Parameters["ImagingFrequency"] = 2.4;//Resonance at aroun 2.9
        ...
        Parameters["OPRepumpFrequency"] = 8.2; //6.9
        ...
        Parameters["MagTrapInternalGradient"] = 1.0;
        ...
        Parameters["MagneticTrapDuration"] = 160000;//180000; //Accel 3500
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int rbMagnteticTrapStartTime = rbMolassesEndTime + (int)Parameters["RbOPDuration"] + (int)Parameters["OPWaitbeforestart"];
        ...
        int rbMagnteticTrapTransferToExternalStartTime = rbMagnteticTrapStartTime + 20000;
        ...
        //int cameraTrigger1 = rbMagnteticTrapTransferToExternalStartTime + 200;
        int cameraTrigger1 = InternalTweezerMagTrapEndTime+200;
        ...
        int swtichAllOn = (int)Parameters["PatternLength"]-100;
        ...
        p.AddEdge("rbRepump", rbMagnteticTrapStartTime, true); //switch off repump light for magnetic trap after optical pumping
        ...
        p.AddEdge("rbAbsImagingBeam", startMotionTime, true);
        ...
        p.AddEdge("rbAbsImagingBeam", cameraTrigger1 + 500 + 1000, true);
        ...
        //Camera
        p.Pulse(0, cameraTrigger1, (int)Parameters["Frame0TriggerDuration"], "rbAbsImgCamTrig"); //fluo image in transport track in tweezer chamber
        ...
        p.AddEdge("rbOpticalPumpingAOM", rbMolassesEndTime, false); // turn on to pump atoms
        p.AddEdge("rbOpticalPumpingAOM", rbMagnteticTrapStartTime, true);

        
        p.AddEdge("rbOPShutter", 0, false);
        //p.AddEdge("rbOPShutter", rbMagnteticTrapStartTime - 250, false);
        p.AddEdge("rbOPShutter", rbMagnteticTrapStartTime, true);
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        //int cameraTrigger1 = rbMolassesEndTime + (int)Parameters["DelayFromTransferStart"];
        //int cameraTrigger1 = rbMagnteticTrapTransferToExternalStartTime + 200;
        int cameraTrigger1 = rbMagnteticTrapEndTime + 50;
        ...
        */
        ...
        p.AddAnalogValue("rbRepumpFrequency", rbMolassesEndTime, (double)Parameters["OPRepumpFrequency"]);
        ...
        // Shim Fields OP
        p.AddAnalogValue("xShimCoilCurrent", rbMolassesEndTime, (double)Parameters["xShimLoadCurrentOP"]);
        p.AddAnalogValue("yShimCoilCurrent", rbMolassesEndTime, (double)Parameters["yShimLoadCurrentOP"]);
        p.AddAnalogValue("zShimCoilCurrent", rbMolassesEndTime, (double)Parameters["zShimLoadCurrentOP"]);
