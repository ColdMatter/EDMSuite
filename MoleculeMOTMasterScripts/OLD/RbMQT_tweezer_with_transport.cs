...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["PatternLength"] = 700000;
        ...
        Parameters["DipoleTrapVCASpillVoltage"] = 4.0;
    }
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        //p.AddLinearRamp("transferCoilsShunt2", DipoleTrapSwitchOnTime + 5000, 1000, (double)Parameters["DipoleTrapVCASpillVoltage"]);
        //p.AddAnalogValue("transferCoilsShunt2", DipoleTrapSwitchOnTime + 5000, (double)Parameters["DipoleTrapVCASpillVoltage"]);
        //p.AddLinearRamp("transferCoilsShunt2", DipoleTrapSwitchOnTime + 10000, 1000, 6.0);
        //p.AddAnalogValue("transferCoilsShunt2", DipoleTrapSwitchOnTime + 10000, 6.0);
