...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["SlowingChirpUpperThreshold"] = 1.0;//0.0
        Parameters["SlowingChirpLowerThreshold"] = -1.5; //-1.25

        //Polynomial Ramp
        Parameters["weight1"] = 1.0;
        Parameters["weight2"] = -0.5;
        Parameters["weight3"] = 1.0/6.0;
        Parameters["weight4"] = -1.0/24.0;
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
       ...
       // p.AddAnalogValue("triggerDelay", 0, (double)Parameters["triggerDelay"]);
        ...
        (double)Parameters["SlowingChirpUpperThreshold"],
        (double)Parameters["SlowingChirpLowerThreshold"],
