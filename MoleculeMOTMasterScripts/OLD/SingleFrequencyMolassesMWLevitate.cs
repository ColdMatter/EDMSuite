...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["MicrowavePulseDuration"] = 15;
        Parameters["SecondMicrowavePulseDuration"] = 6;
        Parameters["LevitateWait"] = 1;

        Parameters["v00ChirpDuration"] = 10;// 200;
        Parameters["v00ChirpWait"] = 100;
        Parameters["v00ChirpAmplitude"] = 0.8; // 0.4V on PC ~ 0.2V on TCL = 70.5MHz
        ...
        Parameters["MOTCoilsCurrentLevitateValue"] = 0.65;
        Parameters["CoilsSwitchOffTime"] = 20000;

        // Shim fields
        Parameters["xShimLoadCurrent"] = 2.195; // 1.202;// 1.219;
        Parameters["yShimLoadCurrent"] = -0.175; //2.4
        Parameters["zShimLoadCurrent"] = 0.32;// -6.425; //-6.39
        Parameters["zShimLevitateCurrent"] = 0.32;// -6.425; //-6.39
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("zShimCoilCurrent", biasStartTime, (double)Parameters["zShimLevitateCurrent"]);
        ...
        p.AddAnalogValue("v00Frequency", microwavePulseTime, ((double)Parameters["lockAomFrequency"] - (double)Parameters["v0FrequencyImageValue"] / 2 - (double)Parameters["calibOffset"]) / (double)Parameters["calibGradient"]); //jump aom frequency back to normal for imaging 
