...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        // Camera
        Parameters["Frame0Trigger"] = 15000;
        ...
        Parameters["v0IntensitySwitchDelay"] = 0;
        Parameters["v0IntensityImageValue"] = 7.78;
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("v00Intensity", (int)Parameters["Frame0Trigger"] - (int)Parameters["v0IntensitySwitchDelay"], (double)Parameters["v0IntensityImageValue"]);
        p.AddAnalogValue("v00Intensity", (int)Parameters["Frame0Trigger"] + 1000, (double)Parameters["v0IntensityRampStartValue"]);
