...
// After the compression a molasses is made with switching off of the magnetic field and
// then the cloud is expanded in absence of v00 light to extimate the temperature
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["v0IntensityMolassesRampStartValue"] = 5.6;
        Parameters["v0IntensityMolassesRampEndValue"] = 8.0;
        ...
        Parameters["MolassesHighIntensityHoldDuration"] = 100;
        Parameters["MolassesRampDuration"] = 100;
        Parameters["MolassesLowIntensityHoldDuration"] = 200;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int molassesRampStartTime = molassesStartTime + (int)Parameters["MolassesHighIntensityHoldDuration"];
        int molassesRampEndTime = molassesRampStartTime + (int)Parameters["MolassesRampDuration"];
        int molassesEndTime = molassesRampEndTime + (int)Parameters["MolassesLowIntensityHoldDuration"];
        int imagingLightOnTime = molassesEndTime + (int)Parameters["ExpansionTime"];
        int imageTime = imagingLightOnTime + (int)Parameters["WaitBeforeImage"];
        int endOfTime = imageTime + 3000;

        MOTMasterScriptSnippet lm = new LoadMoleculeMOT(p, Parameters);
        //V00 AOM switch:
        p.Pulse(0, cmotEndTime, molassesStartTime - cmotEndTime, "v00MOTAOM");
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("v00Intensity", cmotEndTime, (double)Parameters["v0IntensityMolassesRampStartValue"]);
        p.AddLinearRamp("v00Intensity", molassesRampStartTime, (int)Parameters["MolassesRampDuration"], (double)Parameters["v0IntensityMolassesRampEndValue"]);
