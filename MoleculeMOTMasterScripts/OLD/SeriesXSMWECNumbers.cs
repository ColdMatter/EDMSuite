...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["WaitBeforeMOTRecapture"] = 100;
        ...
        // External coil B field
        Parameters["ECRampUpDuration"] = 10000;
        Parameters["ECRampDownDuration"] = 10000;
        Parameters["ECRampEndValue"] = 7.2;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int motRecaptureTime = smwEndTime + (int)Parameters["WaitBeforeMOTRecapture"];
        ...
        p.Pulse(0, molassesEndTime - (int)Parameters["v00ShutterClosingDelay"],
                motRecaptureTime - molassesEndTime - (int)Parameters["v00ShutterOpeningDelay"], "v00MOTShutter");
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        // External B field
        p.AddLinearRamp("transferCoils", mqtStartTime, (int)Parameters["ECRampUpDuration"], (double)Parameters["ECRampEndValue"]);
        p.AddLinearRamp("transferCoils", mqtEndTime - (int)Parameters["ECRampDownDuration"], (int)Parameters["ECRampDownDuration"], -0.1);
        // Shim Fields
