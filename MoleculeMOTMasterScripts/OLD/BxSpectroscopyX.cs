...
public class Patterns : MOTMasterScript
{
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(patternStartBeforeQ, (int)Parameters["Frame0Trigger"] + 500, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger"); //camera trigger for first frame
        ...
        p.Pulse(patternStartBeforeQ, (int)Parameters["Frame0Trigger"], 500, "v00MOTAOM");
        p.Pulse(patternStartBeforeQ, (int)Parameters["Frame0Trigger"], 500, "cafOptPumpingAOM");
