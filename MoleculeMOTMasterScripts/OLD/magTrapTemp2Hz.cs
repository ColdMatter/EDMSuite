...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["MOTCoilsCurrentTopMolassesValue"] = 0.06; //0.21
        Parameters["MOTCoilsCurrentBottomMolassesValue"] = 0.0;
        Parameters["MOTCoilsCurrentTopMagTrapValue"] = 0.65;
        Parameters["MOTCoilsCurrentTopImagingValue"] = 0.0;
        Parameters["MOTCoilsCurrentBottomMagTrapValue"] = 0.65;
        Parameters["MOTCoilsCurrentBottomImagingValue"] = 0.0;
        ...
        Parameters["v0IntensityF0PumpValue"] = 7.95;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int imageTime = magTrapStartTime + (int)Parameters["MagTrapDuration"] + (int)Parameters["ExpansionTime"];
        ...
        //p.Pulse(patternStartBeforeQ, magTrapStartTime, (int)Parameters["MagTrapDuration"], "motAOM"); // turn off the MOT light to release the cloud
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("MOTCoilsCurrentTop", magTrapStartTime, (double)Parameters["MOTCoilsCurrentTopMagTrapValue"]);
        p.AddAnalogValue("MOTCoilsCurrentTop", magTrapEndTime, 0.0);
        p.AddAnalogValue("MOTCoilsCurrentTop", imageTime, (double)Parameters["MOTCoilsCurrentTopImagingValue"]);
        ...
        p.AddAnalogValue("MOTCoilsCurrentBottom", magTrapStartTime, (double)Parameters["MOTCoilsCurrentBottomMagTrapValue"]);
        p.AddAnalogValue("MOTCoilsCurrentTop", magTrapEndTime, 0.0);
        p.AddAnalogValue("MOTCoilsCurrentBottom", imageTime, (double)Parameters["MOTCoilsCurrentBottomImagingValue"]);
        ...
        p.AddAnalogValue("v0IntensityRamp", v0F0PumpStartTime, (double)Parameters["v0IntensityF0PumpValue"]);
        p.AddAnalogValue("v0IntensityRamp", imageTime, (double)Parameters["v0IntensityImageValue"]);

        // v0 F=1 AOM
        p.AddAnalogValue("motAOMAmp", 0, 7.17);
        // Turn off F=1 AOM for pumping into F=1
        //p.AddAnalogValue("motAOMAmp", v0F0PumpStartTime, 10);
        // Turn back on for imaging
        //p.AddAnalogValue("motAOMAmp", imageTime, 7.17);
