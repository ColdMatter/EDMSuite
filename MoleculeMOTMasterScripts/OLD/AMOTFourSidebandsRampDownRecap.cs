...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        */
        ...
        Parameters["SidebandAmpRampEnd1"] = 3.5;// 3.5;
        Parameters["SidebandAmpRampEnd2"] = 4.0;// 3.75;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        //p.Pulse(patternStartBeforeQ, 20000, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger"); 
