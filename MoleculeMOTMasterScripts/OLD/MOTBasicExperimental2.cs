...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["v0IntensityLoadValue"] = 10.0;
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        // v0 Intensity Ramp
        p.AddAnalogValue("v0IntensityRamp", 0, (double)Parameters["v0IntensityLoadValue"]);
        p.AddAnalogValue("v0IntensityRamp", 5500, (double)Parameters["v0IntensityImageValue"]);
