...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["MOTCoilsSwitchOff"] = 26000;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
       ...
       //p.Pulse(patternStartBeforeQ, (int)Parameters["Frame0Trigger"], (int)Parameters["Frame0TriggerDuration"], "cameraTrigger"); //camera trigger for first frame
        ...
        //p.Pulse(patternStartBeforeQ, 1000, (int)Parameters["MagTrapStartTime"] + (int)Parameters["MagTrapDuration"] + 1000, "bXSlowingShutter"); //Takes 14ms to start closing
        //p.Pulse(patternStartBeforeQ, (int)Parameters["MagTrapStartTime"] - 1500, (int)Parameters["MagTrapDuration"]+2500, "v00MOTShutter");


        p.Pulse(patternStartBeforeQ, (int)Parameters["MagTrapStartTime"], (int)Parameters["MagTrapDuration"], "v00MOTAOM"); 
        p.Pulse(patternStartBeforeQ, (int)Parameters["MagTrapStartTime"] + (int)Parameters["MagTrapDuration"]+2000, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger"); //camera trigger for first frame
        return p;
    }
