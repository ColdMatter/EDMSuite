...
public class Patterns : MOTMasterScript
{
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int motLoadEndTime = (int)Parameters["TCLBlockStart"] + (int)Parameters["RbMOTLoadTime"];
        ...
        p.Pulse(0, motRecaptureTime - 25 - (int)Parameters["SecondMicrowavePulseDuration"], (int)Parameters["SecondMicrowavePulseDuration"], "microwaveB"); //2nd pulse
