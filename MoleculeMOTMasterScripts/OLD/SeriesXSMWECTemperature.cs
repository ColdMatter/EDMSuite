...
public class Patterns : MOTMasterScript
{
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("MOTCoilsCurrent", smwEndTime, -0.05);
        // External B field
        p.AddLinearRamp("transferCoils", mqtStartTime, (int)Parameters["ECRampUpDuration"], (double)Parameters["ECRampEndValue"]);
        //p.AddLinearRamp("transferCoils", smwEndTime - (int)Parameters["ECRampDownDuration"], (int)Parameters["ECRampDownDuration"], -0.1);
        p.AddLinearRamp("transferCoils", smwEndTime - 100, 100, -0.1);
        // Shim Fields
