...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["BlueMOTCoilsCurrentValue"] = 2.0;
        ...
        Parameters["MolassesDetuning2"] = 27.05;
        ...
        //Parameters["SidebandFreqMolasses3"] = (double)Parameters["SidebandFreq3"] - (double)Parameters["MolassesDetuning2"] / 2.0; //- F = 2
        Parameters["SidebandFreqMolasses4"] = (double)Parameters["SidebandFreq3"] - (double)Parameters["MolassesDetuning2"] / 2.0; //+ F = 2

        Parameters["BlueMOTDetuning1"] = 15.00;
        Parameters["BlueMOTDetuning2"] = 18.00;
        Parameters["BlueMOTDetuning3"] = 16.00;
        Parameters["BlueMOTDetuning4"] = 14.00;

        //Blue MOT configuration
        Parameters["SidebandFreqBlueMOT1"] = (228.00 - (double)Parameters["BlueMOTDetuning1"]) / 2.0; //+ F = 1- I
        Parameters["SidebandFreqBlueMOT2"] = (354.00 - (double)Parameters["BlueMOTDetuning2"]) / 2.0; //- F = 0 II
        Parameters["SidebandFreqBlueMOT3"] = (380.00 - (double)Parameters["BlueMOTDetuning3"]) / 2.0; //- F = 2 IIIb
        Parameters["SidebandFreqBlueMOT4"] = (380.00 - (double)Parameters["BlueMOTDetuning4"]) / 2.0; //+ F = 1+ IIIa
        ...
        Parameters["SidebandAmpBlueMOT1"] = 10.0;
        Parameters["SidebandAmpBlueMOT2"] = 7.0;
        Parameters["SidebandAmpBlueMOT3"] = 6.0;
        Parameters["SidebandAmpBlueMOT4"] = 4.2;
        ...
        Parameters["BlueMOTCoilRampTime"] = 1000;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int blueMOTEnd = molassesEnd + (int)Parameters["BlueMOTDuration"];
        int imageTime = molassesEnd + (int)Parameters["FreeExpTime"];
        int sequenceEnd = imageTime + 10000;
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddLinearRamp("MOTCoilsCurrent", molassesEnd, (int)Parameters["BlueMOTCoilRampTime"], (double)Parameters["BlueMOTCoilsCurrentValue"]);
        ...
        p.AddAnalogValue("Rf1Freq", molassesEnd, ((double)Parameters["SidebandFreqBlueMOT1"] - (double)Parameters["POS150OffsetFreq"]) / (double)Parameters["POS150Gradient"]);
        p.AddAnalogValue("Rf2Freq", molassesEnd, ((double)Parameters["SidebandFreqBlueMOT2"] - (double)Parameters["POS300OffsetFreq"]) / (double)Parameters["POS300Gradient"]);
        p.AddAnalogValue("Rf3Freq", molassesEnd, ((double)Parameters["SidebandFreqBlueMOT3"] - (double)Parameters["POS300OffsetFreq"]) / (double)Parameters["POS300Gradient"]);
        p.AddAnalogValue("Rf4Freq", molassesEnd, ((double)Parameters["SidebandFreqBlueMOT4"] - (double)Parameters["POS300OffsetFreq"]) / (double)Parameters["POS300Gradient"]);


        // End sequency
        p.AddAnalogValue("Rf1Freq", sequenceEnd, ((double)Parameters["SidebandFreq1"] - (double)Parameters["POS150OffsetFreq"]) / (double)Parameters["POS150Gradient"]);
        p.AddAnalogValue("Rf2Freq", sequenceEnd, ((double)Parameters["SidebandFreq2"] - (double)Parameters["POS300OffsetFreq"]) / (double)Parameters["POS300Gradient"]);
        p.AddAnalogValue("Rf3Freq", sequenceEnd, ((double)Parameters["SidebandFreq3"] - (double)Parameters["POS300OffsetFreq"]) / (double)Parameters["POS300Gradient"]);
        p.AddAnalogValue("Rf4Freq", sequenceEnd, ((double)Parameters["SidebandFreq4"] - (double)Parameters["POS300OffsetFreq"]) / (double)Parameters["POS300Gradient"]);
        ...
        p.AddAnalogValue("Rf1Amp", molassesEnd, (double)Parameters["SidebandAmpBlueMOT1"]);
        p.AddAnalogValue("Rf2Amp", molassesEnd, (double)Parameters["SidebandAmpBlueMOT2"]);
        p.AddAnalogValue("Rf3Amp", molassesEnd, (double)Parameters["SidebandAmpBlueMOT3"]);
        p.AddAnalogValue("Rf4Amp", molassesEnd, (double)Parameters["SidebandAmpBlueMOT4"]);


        // End sequence
        p.AddAnalogValue("Rf1Amp", sequenceEnd, (double)Parameters["SidebandAmp1"]);
        p.AddAnalogValue("Rf2Amp", sequenceEnd, (double)Parameters["SidebandAmp2"]);
        p.AddAnalogValue("Rf3Amp", sequenceEnd, (double)Parameters["SidebandAmp3"]);
        p.AddAnalogValue("Rf4Amp", sequenceEnd, (double)Parameters["SidebandAmp4"]);
