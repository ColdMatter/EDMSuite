...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["PatternLength"] = 550000; //100000
        ...
        Parameters["RbMolassesDuration"] = 1454;
        Parameters["RbOpticalPumpingDuration"] = 50;
        ...
        Parameters["MagTrapDuration"] = 70000;
        ...
        // BX poke
        Parameters["PokeDetuningValue"] = -1.38;//-1.37
        ...
        Parameters["yShimLoadCurrent"] = 0.0;  //4
        ...
        //Rb light detunings:
        Parameters["ImagingFrequency"] = 3.25; //Resonance at aroun 2.65
        Parameters["MOTCoolingLoadingFrequency"] = 4.4;//5.4 usewd to be
        Parameters["MOTRepumpLoadingFrequency"] = 6.6; //6.9
        Parameters["FirstFieldRampFrequencyEndValue"] = 4.2;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int cameraTrigger1 = magTrapStartTime + (int)Parameters["MagTrapDuration"] + (int)Parameters["WaitBeforeImage"];
        ...
        */
        ...
        p.AddEdge("rb2DCooling", atomMOTLoadingEndTime - 500, true);
        p.AddEdge("rbPushBeam", 0, false);
        p.AddEdge("rbPushBeam", atomMOTLoadingEndTime - 500, true);
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddLinearRamp("MOTCoilsCurrent", moleculeMOTLoadingStartTime, 500, (double)Parameters["CaFMOTLoadGradient"]);
        ...
        p.AddLinearRamp("rb3DCoolingFrequency", moleculeMOTLoadingStartTime, 500, (double)Parameters["FirstFieldRampFrequencyEndValue"]);


        //p.AddAnalogValue("rb3DCoolingFrequency", moleculeMOTLoadingEndTime, (double)Parameters["RbCoolingFrequencyCMOT"]);//Rb CMOT
        p.AddLinearRamp("rb3DCoolingFrequency", moleculeMOTLoadingEndTime, (int)Parameters["MOTCoilsCurrentRampDuration"], (double)Parameters["RbCoolingFrequencyCMOT"]);
