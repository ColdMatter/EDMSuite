...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["MolassesHoldTime"] = 400;

        Parameters["Frame0Trigger"] = 4000;
        
        //Recapture to MOT:
        Parameters["MOTWaitBeforeImage"] = 300;//300;
        ...
        Parameters["MOTHoldTime"] = 20000;
        Parameters["v0IntensityRampStartValue"] = 5.6;// 6.9;
        Parameters["v0IntensityRampEndValue"] = 7.3; //7.8;
        Parameters["v0IntensityMolassesValue"] = 10.0;//5.6;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int finalImageTime = cafMOTLoadEndTime + (int)Parameters["v0IntensityRampDuration"];
        //int finalImageTime = motRecaptureTime + (int)Parameters["MOTWaitBeforeImage"];
        //int finalImageTime = molassesStartTime + (int)Parameters["MOTWaitBeforeImage"];
        //int finalImageTime = motSwitchOffTime - 2000;
        ...
        */
        ...
        for (int t = 0; t < 10; t++)
            p.Pulse(0, finalImageTime + (t*2000), (int)Parameters["Frame0TriggerDuration"], "cameraTrigger"); // camera trigger
