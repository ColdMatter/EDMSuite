...
public class Patterns : MOTMasterScript
{
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.AddEdge("dipoleTrapAOM", patternStartBeforeQ + (int)Parameters["Frame0Trigger"] + 1000, false);
        
        p.Pulse(patternStartBeforeQ, (int)Parameters["Frame0Trigger"] + 6000, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger"); //camera trigger for second frame
