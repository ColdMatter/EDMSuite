...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        */
        ...
        Parameters["ODTPlainHoldDuration"] = 500;   //  5 ms dark hold, lets untrapped molecules leave
        Parameters["ODTRampDownDuration"] = 5000;   // 50 ms depth ramp, molasses ON throughout
        Parameters["MolLowDuration"] = 1000;        // 10 ms molasses at the low depth
        Parameters["ODTRampUpDuration"] = 0;        // adiabatic recompression; 0 = none

        Parameters["ODT_atten_low"] = 3.0;          // depth at the end of the ramp down
        Parameters["ODT_atten_recompress"] = 10.0;  // depth after recompression
