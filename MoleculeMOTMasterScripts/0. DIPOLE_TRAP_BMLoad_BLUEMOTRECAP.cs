...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["xShimBM"] = -1.8;
        Parameters["yShimBM"] = -6.0;
        Parameters["zShimBM"] = 0.5;
        // SLOWING //
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int MOTRECAP = ODTLoadEnd + (int)Parameters["ODTHoldTime"];
        ...
        addDDSPattern(p, "BlueMOTRECAPRampStart", MOTRECAP,
            (double)Parameters["FreqCVB1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["FreqCVB3"], (double)Parameters["FreqCVB4"],
            (double)Parameters["MOTAmpDDS1"], (double)Parameters["LightoffDDS2"], (double)Parameters["MOTAmpDDS3"], (double)Parameters["MOTAmpDDS4"]);
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("xShimCoilCurrent", MOTRECAP, (double)Parameters["xShimBM"]);
        p.AddAnalogValue("yShimCoilCurrent", MOTRECAP, (double)Parameters["yShimBM"]);
        p.AddAnalogValue("zShimCoilCurrent", MOTRECAP, (double)Parameters["zShimBM"]);
        ...
        p.AddAnalogValue("MOTCoilsCurrent", MOTRECAP, (double)Parameters["BlueMOTField1"]);
        p.AddAnalogValue("MOTCoilsCurrent", MOTRECAP + (int)Parameters["Frame0TriggerDuration1"]+1000, 0.0);
        ...
        p.AddAnalogValue("ODT70att", MOTRECAP, 10.0);
        p.AddAnalogValue("ODT90att", MOTRECAP, 0.0);
