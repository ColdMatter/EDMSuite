...
public class Patterns : MOTMasterScript
{
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int Image1 = ODTLoadEnd + (int)Parameters["FreeExpTime"];
        int Image2 = Image1 + (int)Parameters["ODTHoldTime"];
        ...
        addDDSPattern(p, "Image1", Image1,
            (double)Parameters["LambdaF1minusLoad"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["LambdaF1plusLoad"],
            (double)Parameters["Lambda0AmpLoad"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS3"], (double)Parameters["Lambda3AmpLoad"]);

        addDDSPattern(p, "Dark", Image1 + (int)Parameters["Frame0TriggerDuration"],
            (double)Parameters["MOTFreqDDS1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["MOTFreqDDS4"],
            (double)Parameters["LightoffDDS1"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS3"], (double)Parameters["LightoffDDS4"]);

        addDDSPattern(p, "Image2", Image2,
            (double)Parameters["LambdaF1minusLoad"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["LambdaF1plusLoad"],
            (double)Parameters["Lambda0AmpLoad"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS3"], (double)Parameters["Lambda3AmpLoad"]);
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(0, Image1, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");
        p.Pulse(0, Image2, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("MOTCoilsCurrent", Image2 + (int)Parameters["Frame0TriggerDuration1"] + 1000, 0.0);
        ...
        p.AddAnalogValue("ODT70att", Image2 + (int)Parameters["Frame0TriggerDuration1"] + 1000, 10.0);
        p.AddAnalogValue("ODT90att",  Image2 + (int)Parameters["Frame0TriggerDuration1"] + 1000, 0.0);
