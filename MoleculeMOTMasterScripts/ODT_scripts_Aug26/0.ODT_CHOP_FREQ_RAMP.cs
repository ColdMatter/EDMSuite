...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["xShimBM"] = -6.5;//-5.2;
        Parameters["yShimBM"] = -4.5;//2.0;
        Parameters["zShimBM"] = 0.3;//3.68;
        ...
        Parameters["FreqCVB2_cap"] = 140.25;
        Parameters["FreqCVB3_cap"] = 175.58; //- F = 2sig- delta_a
        Parameters["FreqCVB4_cap"] = 177.49; //+ F = 2sig+ delta_b

        Parameters["FreqCVB2_load"] = 139.75;
        Parameters["FreqCVB3_load"] = 175.88; //- F = 2sig- delta_a
        Parameters["FreqCVB4_load"] = 176.91; //+ F = 2sig+ delta_b

        Parameters["BMFreqRamp_AmplitudeDDS2"] = -0.000833;
        Parameters["BMFreqRamp_AmplitudeDDS3"] = 0.0005;
        Parameters["BMFreqRamp_AmplitudeDDS4"] = -0.000967;

        Parameters["LambdaCoolingDuration"] = 400;
        Parameters["LambdaPreODTDuration"] = 0;

        Parameters["BlueMOTField"] = 1.3;
        Parameters["BlueMOTField1"] = 1.3;

        Parameters["BlueMOTRampDuration"] = 6000;
        Parameters["ODTBMLoadDuration"] = 400;
        Parameters["ODTBMFreqRampDuration"] = 600;
        Parameters["ODTBMLoadDuration2"] = 1000;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int ODTBMHoldStart = BlueMOTRampStart + (int)Parameters["BlueMOTRampDuration"];
        int ODTBMFreqRampStart = ODTBMHoldStart + (int)Parameters["ODTBMLoadDuration"];
        int ODTBMHoldStart2 = ODTBMFreqRampStart + (int)Parameters["ODTBMFreqRampDuration"];
        int ODTLambdaLoadStart = ODTBMHoldStart2 + (int)Parameters["ODTBMLoadDuration2"];
        ...
        addDDSPattern(p, "BlueMOTRampStart", BlueMOTRampStart,
            (double)Parameters["FreqCVB1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["FreqCVB3_cap"], (double)Parameters["FreqCVB4_cap"],
            (double)Parameters["MOTAmpDDS1"], (double)Parameters["LightoffDDS2"], (double)Parameters["MOTAmpDDS3"], (double)Parameters["MOTAmpDDS4"]);
        
        addDDSPattern(p, "BlueMOTFreqRampStart", ODTBMFreqRampStart,
            (double)Parameters["FreqCVB1"], (double)Parameters["FreqCVB2_cap"], (double)Parameters["FreqCVB3_cap"], (double)Parameters["FreqCVB4_cap"],
            (double)Parameters["MOTAmpDDS1"], (double)Parameters["MOTAmpDDS2"], (double)Parameters["MOTAmpDDS3"], (double)Parameters["MOTAmpDDS4"],
            0.0, (double)Parameters["BMFreqRamp_AmplitudeDDS2"], (double)Parameters["BMFreqRamp_AmplitudeDDS3"], (double)Parameters["BMFreqRamp_AmplitudeDDS4"]);
        
        addDDSPattern(p, "BlueMOTFreqRampEnd", ODTBMHoldStart2,
            (double)Parameters["FreqCVB1"], (double)Parameters["FreqCVB2_load"], (double)Parameters["FreqCVB3_load"], (double)Parameters["FreqCVB4_load"],
            (double)Parameters["MOTAmpDDS1"], (double)Parameters["MOTAmpDDS2"], (double)Parameters["MOTAmpDDS3"], (double)Parameters["MOTAmpDDS4"]);
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        */
        ...
        p.AddAnalogValue("ODT70att", BlueMOTRampStart + (int)Parameters["ODTdelay"], 0.0);
        p.AddAnalogValue("ODT90att", BlueMOTRampStart + (int)Parameters["ODTdelay"], (double)Parameters["ODT_atten"]);
