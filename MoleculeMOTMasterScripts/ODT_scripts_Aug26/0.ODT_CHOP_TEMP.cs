...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["FreqCVB3"] = 175.78; //- F = 2sig- delta_a
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int Recap = ODTLoadEnd + (int)Parameters["ODTHoldTime"] + (int)Parameters["FreeExpTime"];
        ...
        /*
        addDDSPattern(p, "SFstart", ODTLoadEnd,
            (double)Parameters["SF"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["MOTFreqDDS4"],
        ...
        */
        addDDSPattern(p, "ODTHold", ODTLoadEnd,
            (double)Parameters["SF"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["MOTFreqDDS4"],
            (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS3"], (double)Parameters["LightoffDDS4"]);
        
        addDDSPattern(p, "TempImage", Recap,
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(0, Recap, (int)Parameters["TempTriggerDuration"], "cameraTrigger");
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        */
        ...
        p.AddAnalogValue("MOTCoilsCurrent", Recap, 0.0);
        ...
        p.AddAnalogValue("ODT70att", Recap - (int)Parameters["FreeExpTime"], 10.0);
        p.AddAnalogValue("ODT90att", Recap - (int)Parameters["FreeExpTime"], 0.0);
