...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["SecondMicrowavePulseDuration"] = 1;
        ...
        Parameters["PokeDetuningValue"] = -1.42;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int secondMicrowavePulseTime = blowAwayTime + (int)Parameters["BlowAwayDuration"] + 50;
