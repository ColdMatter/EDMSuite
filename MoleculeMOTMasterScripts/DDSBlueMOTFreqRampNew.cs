...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        */
        ...
        //Conveyor belt frequency start
        Parameters["FreqCVB1"] = 100.0; //+ F = 1Delta 
        Parameters["FreqCVB3"] = 173.5; //- F = 2sig- delta_a
        Parameters["FreqCVB4"] = 174.0; //+ F = 2sig+ delta_b

        //Conveyor belt frequency compressed
        Parameters["FreqCVB1comp"] = 100.0; //+ F = 1Delta 
        Parameters["FreqCVB3comp"] = 173.317; //- F = 2sig- delta_a
        Parameters["FreqCVB4comp"] = 174.942; //+ F = 2sig+ delta_b

        Parameters["BlueMOTField"] = 1.5;
        Parameters["BlueMOTRampDuration"] = 2000;
        Parameters["BlueMOTDuration"] = 1000;

        Parameters["RecapLoadTime"] = 100;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int Recap = BlueMOTRampEnd + (int)Parameters["BlueMOTDuration"];
        ...
        addDDSPattern(p, "BlueMOTRampEnd", BlueMOTRampEnd,
            (double)Parameters["FreqCVB1comp"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["FreqCVB3comp"], (double)Parameters["FreqCVB4comp"],
            (double)Parameters["MOTAmpDDS1"], (double)Parameters["LightoffDDS2"], (double)Parameters["MOTAmpDDS3"], (double)Parameters["MOTAmpDDS4"]);
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        //p.Pulse(0, Recap - (int)Parameters["Frame0TriggerDuration"], (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");

        p.Pulse(0, Recap + (int)Parameters["RecapLoadTime"], (int)Parameters["Frame0TriggerDuration"], "cameraTrigger"); //camera trigger for recap
