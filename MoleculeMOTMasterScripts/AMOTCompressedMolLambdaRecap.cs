...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["SidebandMolFreq1"] = 210.00 / 2.0; //+ F = 1- 
        Parameters["SidebandMolFreq2"] = 288.00 / 2.0; //- F = 0
        Parameters["SidebandMolFreq3"] = 384.00 / 2.0; //- F = 2
        Parameters["SidebandMolFreq4"] = 336.00 / 2.0; //+ F = 1+
        ...
        Parameters["MolDuration"] = 200;
        Parameters["LambdaCoolingDuration"] = 8000;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int MolStart = motEndTime + (int)Parameters["FrequencySettleTime"];
        int MolEnd = MolStart + (int)Parameters["MolDuration"];
        int lambdaCoolingStart = MolEnd + (int)Parameters["FrequencySettleTime"];
        ...
        p.AddEdge("v0rfswitch1", MolStart, false);
        p.AddEdge("v0rfswitch2", MolStart, false);
        p.AddEdge("v0rfswitch3", MolStart, false);
        p.AddEdge("v0rfswitch4", MolStart, false);

        p.AddEdge("v0rfswitch1", MolEnd, true);
        p.AddEdge("v0rfswitch2", MolEnd, true);
        p.AddEdge("v0rfswitch3", MolEnd, true);
        p.AddEdge("v0rfswitch4", MolEnd, true);
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("Rf1Amp", MolStart, (double)Parameters["SidebandAmp1"]);
        p.AddAnalogValue("Rf2Amp", MolStart, (double)Parameters["SidebandAmp2"]);
        p.AddAnalogValue("Rf3Amp", MolStart, (double)Parameters["SidebandAmp3"]);
        p.AddAnalogValue("Rf4Amp", MolStart, (double)Parameters["SidebandAmp4"]);
