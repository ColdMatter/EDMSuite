...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["yShimLoadCurrent"] = 0.0;// -1.92 is zero
        ...
        Parameters["MolassesEndFrequency"] = 1.5; //1.5
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int magTrapStartTime = molassesEndTime + (int)Parameters["RbOPDuration"] + (int)Parameters["FreeExpansionTime"];
        int cameraTrigger0 = magTrapStartTime;
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("slowingCoilsCurrent", magTrapStartTime, (double)Parameters["yShimMQTSwitchONValue"]);
        ...
        p.AddAnalogValue("rb3DCoolingFrequency", cameraTrigger0 - 50, 4.8);
        return p;
    }
