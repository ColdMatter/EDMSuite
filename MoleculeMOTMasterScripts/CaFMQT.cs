...
public class Patterns : MOTMasterScript
{
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        for (int t = 300000; t < (int)Parameters["PatternLength"]; t += 50000)
        {
        ...
        p.Pulse(patternStartBeforeQ, microwavePulseTime, motRecaptureTime - microwavePulseTime, "v00MOTAOM"); // turn off the MOT light for 1st, 2nd microwave pulses and MQT
        ...
        p.Pulse(patternStartBeforeQ, secondMicrowavePulseTime - 1800, finalImageTime - secondMicrowavePulseTime + 4000, "bXSlowingShutter"); //B-X shutter closed after blow away
