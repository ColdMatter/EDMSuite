...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        //Recapture to MOT:
        Parameters["MOTWaitBeforeImage"] = 100;// 10;//300;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        //int firstImageTime = motSwitchOffTime - (int)Parameters["Frame0TriggerDuration"];
        ...
        int finalImageTime = mqtTransferToExternalStartTime + (int)Parameters["MOTWaitBeforeImage"];
        ...
        p.Pulse(0, molassesEndTime, finalImageTime - molassesEndTime, "v00MOTAOM"); // Molasses in tweezer chamber
        ...
        if (finalImageTime - molassesEndTime + 1200 > 0)
        { 
            ...
            p.Pulse(0, molassesEndTime - 1950, finalImageTime - molassesEndTime + 1100, "v00MOTShutter"); //V00 shutter closed after optical pumping an opened for recpature into MOT
        }
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("MOTCoilsCurrent", mqtTransferToExternalStartTime, -0.1);
        ...
        //Swith off transport coils 
        //p.AddAnalogValue("transferCoils", mqtExternalEndTime, -0.1);
