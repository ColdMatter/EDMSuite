...
public class Patterns : MOTMasterScript
{
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int Image1 = BlueMOTRampStart + (int)Parameters["BlueMOTRampDuration"];
        int Image2 = Image1 + (int)Parameters["QCLshutterDur"] + (int)Parameters["Frame0TriggerDuration"];
        int FreeExp = Image2 + (int)Parameters["Frame0TriggerDuration"] + 1000;
        int BackgroundImage = FreeExp + 5000;
        ...
        addDDSPattern(p, "FreeExp", FreeExp,
        ...
        addDDSPattern(p, "BackgroundImage", BackgroundImage,
            (double)Parameters["FreqCVB1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["FreqCVB3"], (double)Parameters["FreqCVB4"],
            (double)Parameters["MOTAmpDDS1"], (double)Parameters["LightoffDDS2"], (double)Parameters["MOTAmpDDS3"], (double)Parameters["MOTAmpDDS4"]);
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int BlueMOTRampStart = lambdaCoolingStart + (int)Parameters["LambdaCoolingDuration"];
        int Image1 = BlueMOTRampStart + (int)Parameters["BlueMOTRampDuration"];
        int Image2 = Image1 + (int)Parameters["QCLshutterDur"] + (int)Parameters["Frame0TriggerDuration"]+ 500;
        int FreeExp = Image2 + (int)Parameters["Frame0TriggerDuration"] + 1000;
        int BackgroundImage = FreeExp + 5000;
        ...
        p.Pulse(0, BackgroundImage, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");
        ...
        // QCL shutter
        p.Pulse(0, Image1 + (int)Parameters["Frame0TriggerDuration"], (int)Parameters["QCLshutterDur"], "QCLShutter");
        return p;
    }
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("MOTCoilsCurrent", Image2 + 2000, 0.0);
