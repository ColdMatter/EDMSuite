...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["MOTCoilsCompressValue"] = 1.75;
        ...
        //20% saturation, May 1, 2025

        Parameters["SidebandAmpRampEnd1"] = 3.50;//3.2;// 3.5;
        Parameters["SidebandAmpRampEnd2"] = 4.00;//3.5;// 3.75;
        Parameters["SidebandAmpRampEnd3"] = 5.00;//3.9;// 4.2;
        Parameters["SidebandAmpRampEnd4"] = 4.00;//3.7;// 4.2;
        ...
        Parameters["MOTRampDuration"] = 500;
        Parameters["MOTRampDownHoldTime"] = 500;
        Parameters["CompressDuration"] = 500;
        Parameters["CompressHoldTime"] = 500; 
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int motRampStart = patternStartBeforeQ + (int)Parameters["MOTLoadTime"];
        int motRampEnd = motRampStart + (int)Parameters["MOTRampDuration"];
        int motEndTime = motRampEnd + (int)Parameters["MOTRampDownHoldTime"];
        ...
        //p.Pulse(patternStartBeforeQ, 4000, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger"); 
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        int motRampStart = (int)Parameters["MOTLoadTime"];
        int motRampEnd = motRampStart + (int)Parameters["MOTRampDuration"];
        int motEndTime = motRampEnd + (int)Parameters["MOTRampDownHoldTime"];
        int imageTime = motEndTime + (int)Parameters["FreeExpTime"];
        ...
        p.AddLinearRamp("MOTCoilsCurrent", motRampStart, (int)Parameters["CompressDuration"], (double)Parameters["MOTCoilsCompressValue"]);
        ...
        p.AddLinearRamp("Rf1Amp", motRampStart, (int)Parameters["MOTRampDuration"], (double)Parameters["SidebandAmpRampEnd1"]);
        p.AddLinearRamp("Rf2Amp", motRampStart, (int)Parameters["MOTRampDuration"], (double)Parameters["SidebandAmpRampEnd2"]);
        p.AddLinearRamp("Rf3Amp", motRampStart, (int)Parameters["MOTRampDuration"], (double)Parameters["SidebandAmpRampEnd3"]);
        p.AddLinearRamp("Rf4Amp", motRampStart, (int)Parameters["MOTRampDuration"], (double)Parameters["SidebandAmpRampEnd4"]);

        p.AddAnalogValue("Rf1Amp", motRampEnd, (double)Parameters["SidebandAmpRampEnd1"]);
        p.AddAnalogValue("Rf2Amp", motRampEnd, (double)Parameters["SidebandAmpRampEnd2"]);
        p.AddAnalogValue("Rf3Amp", motRampEnd, (double)Parameters["SidebandAmpRampEnd3"]);
        p.AddAnalogValue("Rf4Amp", motRampEnd, (double)Parameters["SidebandAmpRampEnd4"]);
