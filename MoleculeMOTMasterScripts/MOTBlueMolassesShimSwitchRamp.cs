...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["MolassesDuration"] = 400;//needs to be 100 higher than duration wanted due to 1ms of B field turning off before intensity is jumped
        ...
        Parameters["v0MolassesRampStartTime"] = 7700;
        Parameters["v0MolassesRampDuration"] = 100;
        Parameters["v0IntensityMolassesValue"] = 7.24;
        Parameters["v0IntensityMolassesRampEndValue"] = 7.25;
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddLinearRamp("v0IntensityRamp", (int)Parameters["v0MolassesRampStartTime"], (int)Parameters["MolassesDuration"]-200, (double)Parameters["v0IntensityMolassesRampEndValue"]);
