...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["MicrowaveSecondPulseDuration"] = 9;
        ...
        Parameters["CoilsSwitchOffTime"] = 45000;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(patternStartBeforeQ, magTrapStartTime, (int)Parameters["PokeDuration"], "aom"); // Blow away pulse furing magnetic trap 
        ...
        //p.Pulse(patternStartBeforeQ, magTrapStartTime - 1000, (int)Parameters["MagneticTrapDuration"], "bXShutter");// takes 12ms to shut, want 1 ms poke, don't care when it reopens
        p.Pulse(patternStartBeforeQ, magTrapStartTime - 1500, (int)Parameters["MagneticTrapDuration"] - 500, "v00Shutter");// takes 15ms to shut, 20ms to reopen, want open at end of trap but closed at start
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("v00Intensity", molassesRampTime + 50, 6.76);
        p.AddAnalogValue("v00Intensity", molassesRampTime + 200, 7.24);
        p.AddAnalogValue("v00Intensity", molassesRampTime + 150, 7.54);
