...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["xShimLoadCurrent"] = -2.29; //-2.21;
        Parameters["yShimLoadCurrent"] = -2.42; //-2.13;
        Parameters["zShimLoadCurrent"] = 0.377; //0.41;
        ...
        */
        ...
        Parameters["LambdaF1minusImage"] = 97.28;
        ...
        Parameters["DipoleLoading"] = 200;
        Parameters["FreeExpTime"] = 1200;
        Parameters["DipoleImagingTime"] = 10000;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        addDDSPattern(p, "LambdaCooling", lambdaCoolingStart,
            (double)Parameters["LambdaF1minus"], (double)Parameters["LambdaF1minus"], (double)Parameters["LambdaF1minus"], (double)Parameters["LambdaF1plus"],
        ...
        addDDSPattern(p, "BlueMOTRampStart", BlueMOTRampStart,
            (double)Parameters["FreqCVB1"], (double)Parameters["LambdaF1minus"], (double)Parameters["FreqCVB3"], (double)Parameters["FreqCVB4"],
        ...
        addDDSPattern(p, "SFstart", SFLoadingStart,
            ...
            (double)Parameters["SFamp"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS3"], (double)Parameters["LightoffDDS4"]);
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        // Dipole trap AOM
        //p.Pulse(0, SFLoadingStart, (int)Parameters["DipoleLoading"] + (int)Parameters["FreeExpTime"] + (int)Parameters["DipoleImagingTime"], "dipoleTrapAOM");
