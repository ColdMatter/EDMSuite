...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["Frame0TriggerDuration"] = 500;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int MOTRecap = SFLoadingEnd + (int)Parameters["FreeExpTime"];
        ...
        addDDSPattern(p, "Image", MOTRecap,
            (double)Parameters["MOTFreqDDS1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["MOTFreqDDS4"],
            (double)Parameters["MOTAmpDDS1"], (double)Parameters["MOTAmpDDS2"], (double)Parameters["MOTAmpDDS3"], (double)Parameters["MOTAmpDDS4"]);
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(0, MOTRecap, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");
        //p.Pulse(patternStartBeforeQ, (int)Parameters["MOTCoilsSwitchOff"] + 5000, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");
        ...
        // Dipole trap AOM
        p.Pulse(0, SFLoadingStart, (int)Parameters["DipoleLoading"] + (int)Parameters["FreeExpTime"]+1000, "dipoleTrapAOM");
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        //p.AddAnalogValue("MOTCoilsCurrent", MOTRecap, (double)Parameters["MOTCoilsCurrentValue"]);
