...
public class Patterns : MOTMasterScript
{
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        //p.Pulse(0, BlueMOTEnd - (int)Parameters["Frame0TriggerDuration"], (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");  //camera trigger imaging blue mot

        p.Pulse(0, Recap + (int)Parameters["RecapDelay"], (int)Parameters["Frame0TriggerDuration"], "cameraTrigger"); //camera trigger for recap
