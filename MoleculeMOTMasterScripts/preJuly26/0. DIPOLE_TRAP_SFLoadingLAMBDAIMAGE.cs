...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["LambdaImageDur"] = 4000;
        ...
        */
        ...
        Parameters["LambdaCoolingDuration1"] = 50;
        Parameters["DipoleLoading"] = 3250;
        ...
        Parameters["DipoleRetroX"] = 0.0;
        Parameters["DipoleRetroY"] = 0.0;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int SFLoadingStart = Lambda2start + (int)Parameters["LambdaCoolingDuration1"];
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(0, DipoleImagingStart, (int)Parameters["LambdaImageDur"], "cameraTrigger");
