...
public class Patterns : MOTMasterScript
{
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(0, Image+500, 4000, "cameraTrigger");
        ...
        // Dipole trap AOM
        //p.Pulse(0, SFLoadingStart+100, (int)Parameters["DipoleLoading"]-150, "dipoleTrapAOM");
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("ODT70att", Image, 10.0);
        p.AddAnalogValue("ODT90att", Image, 0.0);
