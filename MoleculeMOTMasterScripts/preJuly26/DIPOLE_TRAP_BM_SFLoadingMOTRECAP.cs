...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["Frame0TriggerDuration2"] = 4000;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        addDDSPattern(p, "MOTRECAP", MOTRecap,
            (double)Parameters["MOTFreqDDS1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["MOTFreqDDS4"],
            (double)Parameters["MOTAmpDDS1"], (double)Parameters["MOTAmpDDS2"], (double)Parameters["MOTAmpDDS3"], (double)Parameters["MOTAmpDDS4"]);
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(patternStartBeforeQ, (int)Parameters["Frame0Trigger"], (int)Parameters["Frame0TriggerDuration1"], "cameraTrigger"); //camera trigger for first frame
        //p.Pulse(0, lambdaCoolingStart, (int)Parameters["LambdaCoolingDuration"], "cameraTrigger"); //camera trigger for recap
        p.Pulse(0, MOTRecap+500, (int)Parameters["Frame0TriggerDuration2"], "cameraTrigger");
