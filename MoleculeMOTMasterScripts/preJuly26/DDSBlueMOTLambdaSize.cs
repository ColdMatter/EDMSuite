...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["Frame0TriggerDuration"] = 700;
        ...
        */
        ...
        Parameters["BlueMOTDuration"] = 3500;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int Imaging = BlueMOTEnd + (int)Parameters["LambdaCoolingDuration"];
        ...
        addDDSPattern(p, "LambdCooling2", BlueMOTEnd,
            (double)Parameters["LambdaF1minus"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["LambdaF1plus"],
            (double)Parameters["Lambda1Amp"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS3"], (double)Parameters["Lambda2Amp"]);

        addDDSPattern(p, "Imaging", Imaging,
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(0, Imaging, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");  //camera trigger imaging blue mot
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("xShimCoilCurrent", BlueMOTEnd, (double)Parameters["xShimLoadCurrentZeroField"]);
        p.AddAnalogValue("yShimCoilCurrent", BlueMOTEnd, (double)Parameters["yShimLoadCurrentZeroField"]);
        p.AddAnalogValue("zShimCoilCurrent", BlueMOTEnd, (double)Parameters["zShimLoadCurrentZeroField"]);
        ...
        p.AddAnalogValue("MOTCoilsCurrent", BlueMOTEnd, (double)Parameters["MOTCoilsOffValue"]); // switch off for molasses
