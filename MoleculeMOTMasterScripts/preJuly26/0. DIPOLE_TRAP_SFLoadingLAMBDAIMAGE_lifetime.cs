...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["Frame0TriggerDuration"] = 4000;
        ...
        */
        ...
        Parameters["FreeExpTime"] = 15000;
        Parameters["DipoleImagingTime"] = 140000;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        addDDSPattern(p, "SFstart", SFLoadingStart,
            (double)Parameters["SF"], (double)Parameters["SF"], (double)Parameters["SF"], (double)Parameters["SF"],
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        //p.Pulse(0, Lambda2start, (int)Parameters["LambdaCoolingDuration"], "cameraTrigger"); //camera trigger for recap
        p.Pulse(0, DipoleImagingStart, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");
        p.Pulse(0, DipoleImagingStart+10000, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");
        p.Pulse(0, DipoleImagingStart+20000, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");
        p.Pulse(0, DipoleImagingStart + 30000, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");
        p.Pulse(0, DipoleImagingStart + 40000, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");
        p.Pulse(0, DipoleImagingStart + 50000, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");
        p.Pulse(0, DipoleImagingStart + 60000, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");
        p.Pulse(0, DipoleImagingStart + 70000, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");
        p.Pulse(0, DipoleImagingStart + 80000, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");
        p.Pulse(0, DipoleImagingStart + 90000, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");
        p.Pulse(0, DipoleImagingStart + 100000, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("ODT70att", SFLoadingStart + 100, 0.0);
        p.AddAnalogValue("ODT90att", SFLoadingStart + 100, 10.0);

        p.AddAnalogValue("ODT70att", DipoleImagingEnd, 10.0);
        p.AddAnalogValue("ODT90att", DipoleImagingEnd, 0.0);
        */
