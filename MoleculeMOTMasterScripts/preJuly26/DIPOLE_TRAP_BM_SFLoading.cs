...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["Frame0TriggerDuration"] = 3000;
        ...
        Parameters["xShimLoadCurrentZeroField"] = -2.21;
        Parameters["yShimLoadCurrentZeroField"] = -2.13;
        Parameters["zShimLoadCurrentZeroField"] = 0.41;

        // SLOWING //

        // Slowing Chirp

        Parameters["SlowingChirpStartTime"] = 210;//360; //400;// 380;
        ...
        */
        ...
        // lambda rf amps
        /*
        Parameters["Lambda1Amp"] = 0.1831; // 80%
        Parameters["Lambda2Amp"] = 0.0779; // 80%
        */
        
        Parameters["Lambda1Amp"] = 0.25; // full
        Parameters["Lambda2Amp"] = 0.1; // full
        /*
        Parameters["Lambda1Amp"] = 0.218; // 90%
        Parameters["Lambda2Amp"] = 0.115; // 100%
        */
        // Ramp slopes
        ...
        Parameters["FreqCVB1"] = 100.0; //+ F = 1Delta 
        Parameters["FreqCVB3"] = 173.317; //- F = 2sig- delta_a
        Parameters["FreqCVB4"] = 174.942; //+ F = 2sig+ delta_b

        Parameters["BlueMOTField1"] = 1.0;
        Parameters["BlueMOTField2"] = 1.7;
        Parameters["BlueMOTRampDuration"] = 1;

        Parameters["LambdaCoolingDuration"] = 400;
        Parameters["DipoleLoading"] = 10000;
        Parameters["FreeExpTime"] = 10000;
        Parameters["DipoleImagingTime"] = 2500;

        // END OF PATTERN //

        Parameters["MOTCoilsSwitchOff"] = 55000;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int Lambda2start = BlueMOTRampStart + (int)Parameters["BlueMOTRampDuration"];
        int SFLoadingStart = Lambda2start + (int)Parameters["LambdaCoolingDuration"];
        int SFLoadingEnd = SFLoadingStart + (int)Parameters["DipoleLoading"];
        int BlueMOTRampStart2 = SFLoadingEnd + (int)Parameters["FreeExpTime"];
        int DipoleImagingStart= BlueMOTRampStart2 + (int)Parameters["BlueMOTRampDuration"];
        int DipoleImagingEnd = DipoleImagingStart + (int)Parameters["DipoleImagingTime"];
        ...
        addDDSPattern(p, "LambdaImaging", Lambda2start,
            (double)Parameters["LambdaF1minus"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["LambdaF1plus"],
            (double)Parameters["Lambda1Amp"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS3"], (double)Parameters["Lambda2Amp"]);
        */
        addDDSPattern(p, "SFstart", SFLoadingStart,
            (double)Parameters["SF"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["LambdaF1plus"],
            (double)Parameters["Lambda1Amp"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS3"], (double)Parameters["LightoffDDS4"]);

        addDDSPattern(p, "Freefall", SFLoadingEnd,
            (double)Parameters["MOTFreqDDS1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["MOTFreqDDS4"],
        ...
        addDDSPattern(p, "Image", DipoleImagingStart,
            (double)Parameters["FreqCVB1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["FreqCVB3"], (double)Parameters["FreqCVB4"],
            (double)Parameters["MOTAmpDDS1"], (double)Parameters["LightoffDDS2"], (double)Parameters["MOTAmpDDS3"], (double)Parameters["MOTAmpDDS4"]);
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        //p.Pulse(0, lambdaCoolingStart, (int)Parameters["LambdaCoolingDuration"], "cameraTrigger"); //camera trigger for recap
        p.Pulse(0, DipoleImagingStart, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");
        //p.Pulse(patternStartBeforeQ, (int)Parameters["MOTCoilsSwitchOff"] + 2000, (int)Parameters["LambdaCoolingDuration"], "cameraTrigger");
        ...
        // Dipole trap AOM
        p.Pulse(0, SFLoadingStart, (int)Parameters["DipoleLoading"] + (int)Parameters["FreeExpTime"], "dipoleTrapAOM");
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        int SFLoadingStart = Lambda2start + (int)Parameters["LambdaCoolingDuration"];
        int SFLoadingEnd = SFLoadingStart + (int)Parameters["DipoleLoading"];
        int DipoleImagingStart = SFLoadingEnd + (int)Parameters["FreeExpTime"];
        int DipoleImagingEnd = DipoleImagingStart + (int)Parameters["DipoleImagingTime"];
        ...
        p.AddAnalogValue("xShimCoilCurrent", lambdaCoolingStart, (double)Parameters["xShimLoadCurrentZeroField"]);
        p.AddAnalogValue("yShimCoilCurrent", lambdaCoolingStart, (double)Parameters["yShimLoadCurrentZeroField"]);
        p.AddAnalogValue("zShimCoilCurrent", lambdaCoolingStart, (double)Parameters["zShimLoadCurrentZeroField"]);

        p.AddAnalogValue("xShimCoilCurrent", BlueMOTRampStart, (double)Parameters["xShimLoadCurrent"]);
        p.AddAnalogValue("yShimCoilCurrent", BlueMOTRampStart, (double)Parameters["yShimLoadCurrent"]);
        p.AddAnalogValue("zShimCoilCurrent", BlueMOTRampStart, (double)Parameters["zShimLoadCurrent"]);

        p.AddAnalogValue("xShimCoilCurrent", Lambda2start, (double)Parameters["xShimLoadCurrentZeroField"]);
        p.AddAnalogValue("yShimCoilCurrent", Lambda2start, (double)Parameters["yShimLoadCurrentZeroField"]);
        p.AddAnalogValue("zShimCoilCurrent", Lambda2start, (double)Parameters["zShimLoadCurrentZeroField"]);
        ...
        //p.AddLinearRamp("MOTCoilsCurrent", BlueMOTRampStart, (int)Parameters["BlueMOTRampDuration"], (double)Parameters["BlueMOTField1"]);
        //p.AddAnalogValue("MOTCoilsCurrent", Lambda2start, (double)Parameters["MOTCoilsOffValue"]); // switch off for molasses
        p.AddAnalogValue("MOTCoilsCurrent", DipoleImagingStart, (double)Parameters["BlueMOTField2"]);
