...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["zShimLoadCurrent"] = 0.55;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int Image = SFLoadingEnd + (int)Parameters["FreeExpTime"];
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(0, Image, (int)Parameters["TempTriggerDuration"], "cameraTrigger");
        ...
        // Dipole trap AOM
        p.Pulse(0, SFLoadingStart + 100, (int)Parameters["DipoleLoading"] - 300, "dipoleTrapAOM");
