...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        */
        ...
        Parameters["LambdaBMHoldTime"] = 400;

        // Lambda MOT frequencies

        Parameters["LambdaMOTF1minus"] = 97.45;
        Parameters["LambdaMOTF1plus"] = 171.2;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int lambdaMOTStart = BlueMOTRampStart + (int)Parameters["BlueMOTRampDuration"];
        int lambdaMOTEnd = lambdaMOTStart + (int)Parameters["LambdaBMHoldTime"];
        int imageTime = lambdaMOTEnd + (int)Parameters["FreeExpTime"];
        ...
        */
        ...
        addDDSPattern(p, "LambdaMOT", lambdaMOTStart,
            (double)Parameters["LambdaMOTF1minus"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["LambdaMOTF1plus"],
            (double)Parameters["Lambda1Amp"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS3"], (double)Parameters["Lambda2Amp"]);

        addDDSPattern(p, "Freefall", lambdaMOTEnd,
            (double)Parameters["MOTFreqDDS1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["MOTFreqDDS4"],
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("MOTCoilsCurrent", lambdaMOTEnd, (double)Parameters["MOTCoilsOffValue"]);
