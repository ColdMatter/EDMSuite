...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["v0IntensityRampHoldDuration"] = 10000;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int Recap = RampEnd + (int)Parameters["v0IntensityRampHoldDuration"];
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("MOTCoilsCurrent", Recap, 1.0); // switch off for temp
