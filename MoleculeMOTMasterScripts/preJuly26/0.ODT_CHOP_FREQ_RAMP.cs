...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["xShimBM"] = -1.6;//-5.2;
        Parameters["yShimBM"] = 0.4;//2.0;
        Parameters["zShimBM"] = 0.0;//3.68;
        ...
        Parameters["RampEndAmpDDS4"] = 5.3431e-02; //33.3%
        Parameters["RampAmplitudeDDS4"] = -4.6569e-05;
        ...
        Parameters["ODTLambdaLoadDuration"] = 1;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        addDDSPattern(p, "BlueMOTFreqRampStart", ODTBMFreqRampStart,
            (double)Parameters["FreqCVB1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["FreqCVB3_cap"], (double)Parameters["FreqCVB4_cap"],
            (double)Parameters["MOTAmpDDS1"], (double)Parameters["LightoffDDS2"], (double)Parameters["MOTAmpDDS3"], (double)Parameters["MOTAmpDDS4"],
            0.0, 0.0, (double)Parameters["BMFreqRamp_AmplitudeDDS3"], (double)Parameters["BMFreqRamp_AmplitudeDDS4"]);

        addDDSPattern(p, "BlueMOTFreqRampEnd", ODTBMHoldStart2,
            (double)Parameters["FreqCVB1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["FreqCVB3_load"], (double)Parameters["FreqCVB4_load"],
            (double)Parameters["MOTAmpDDS1"], (double)Parameters["LightoffDDS2"], (double)Parameters["MOTAmpDDS3"], (double)Parameters["MOTAmpDDS4"]);
