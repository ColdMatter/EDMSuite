...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["MOTCoilsCurrentValue"] = 1.7; // 0.65;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        addDDSPattern(p, "MOT", 0,
            (double)Parameters["FreqCVB1"], (double)Parameters["FreqCVB3"], (double)Parameters["FreqCVB3"], (double)Parameters["FreqCVB4"],
            (double)Parameters["MOTAmpDDS0"], (double)Parameters["LightoffDDS2"], (double)Parameters["MOTAmpDDS2"], (double)Parameters["MOTAmpDDS3"]);
