...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        */
        ...
        // lambda rf amps
        /*
        Parameters["Lambda1Amp"] = 0.1831;
        Parameters["Lambda2Amp"] = 0.0779;
        */
        ...
        Parameters["LambdaF1minus"] = 97.45;
        Parameters["LambdaF1plus"] = 171.00;

        Parameters["LambdaCoolingDuration"] = 200;

        //Conveyor belt frequency
        Parameters["FreqCVB1"] = 97.45; //+ F = 1Delta 
        Parameters["FreqCVB3"] = 170.8; //- F = 2sig- 
        Parameters["FreqCVB4"] = 172.3; //+ F = 2sig+ 

        Parameters["BlueMOTField"] = 0.5;
        Parameters["BlueMOTField1"] = 1.0;
        Parameters["BlueMOTField2"] = 1.5;

        Parameters["BlueMOTRampDuration"] = 1000;

        Parameters["BfieldSettle"] = 10;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int lambdaCoolingStart1 = BlueMOTRampStart + (int)Parameters["BlueMOTRampDuration"];
        int lambdaCoolingEnd1 = lambdaCoolingStart1 + (int)Parameters["LambdaCoolingDuration"];
        int BlueMOTRampStart1 = lambdaCoolingEnd1 + (int)Parameters["BfieldSettle"];
        int lambdaCoolingStart2 = BlueMOTRampStart1 + (int)Parameters["BlueMOTRampDuration"];
        int lambdaCoolingEnd2 = lambdaCoolingStart2 + (int)Parameters["LambdaCoolingDuration"];
        int BlueMOTRampStart2 = lambdaCoolingEnd2 + (int)Parameters["BfieldSettle"];
        int lambdaCoolingStart3 = BlueMOTRampStart2 + (int)Parameters["BlueMOTRampDuration"];
        int Recap = lambdaCoolingStart3 + (int)Parameters["LambdaCoolingDuration"];

        /*
        int BlueMOTRampEnd = BlueMOTRampStart1 + (int)Parameters["BlueMOTRampDuration"];
        ...
        */
        ...
        addDDSPattern(p, "LambdaCooling1", lambdaCoolingStart1,
           (double)Parameters["LambdaF1minus"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["LambdaF1plus"],
           (double)Parameters["Lambda1Amp"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS3"], (double)Parameters["Lambda2Amp"]);

        addDDSPattern(p, "BlueMOTRampStart1", BlueMOTRampStart1,
            (double)Parameters["FreqCVB1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["FreqCVB3"], (double)Parameters["FreqCVB4"],
            (double)Parameters["MOTAmpDDS1"], (double)Parameters["LightoffDDS2"], (double)Parameters["MOTAmpDDS3"], (double)Parameters["MOTAmpDDS4"]);

        addDDSPattern(p, "LambdaCooling2", lambdaCoolingStart2,
            (double)Parameters["LambdaF1minus"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["LambdaF1plus"],
            (double)Parameters["Lambda1Amp"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS3"], (double)Parameters["Lambda2Amp"]);

        addDDSPattern(p, "BlueMOTRampStart2", BlueMOTRampStart2,
            (double)Parameters["FreqCVB1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["FreqCVB3"], (double)Parameters["FreqCVB4"],
            (double)Parameters["MOTAmpDDS1"], (double)Parameters["LightoffDDS2"], (double)Parameters["MOTAmpDDS3"], (double)Parameters["MOTAmpDDS4"]);

        addDDSPattern(p, "LambdaCooling3", lambdaCoolingStart3,
            (double)Parameters["LambdaF1minus"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["LambdaF1plus"],
            (double)Parameters["Lambda1Amp"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS3"], (double)Parameters["Lambda2Amp"]);

        addDDSPattern(p, "Recap", Recap,
            (double)Parameters["MOTFreqDDS1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["MOTFreqDDS4"],
            (double)Parameters["MOTAmpDDS1"], (double)Parameters["MOTAmpDDS2"], (double)Parameters["MOTAmpDDS3"], (double)Parameters["MOTAmpDDS4"]);
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(0, Recap, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");  //camera trigger imaging blue mot
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("MOTCoilsCurrent", lambdaCoolingStart1, (double)Parameters["MOTCoilsOffValue"]); // switch off for molasses
        p.AddAnalogValue("MOTCoilsCurrent", lambdaCoolingEnd1, (double)Parameters["BlueMOTField"]); // switch on to ramp1 end point
        p.AddLinearRamp("MOTCoilsCurrent", BlueMOTRampStart1, (int)Parameters["BlueMOTRampDuration"], (double)Parameters["BlueMOTField1"]);
        p.AddAnalogValue("MOTCoilsCurrent", lambdaCoolingStart2, (double)Parameters["MOTCoilsOffValue"]); // switch off for molasses
        p.AddAnalogValue("MOTCoilsCurrent", lambdaCoolingEnd2, (double)Parameters["BlueMOTField1"]); // switch on to ramp1 end point
        p.AddLinearRamp("MOTCoilsCurrent", BlueMOTRampStart2, (int)Parameters["BlueMOTRampDuration"], (double)Parameters["BlueMOTField2"]);
        p.AddAnalogValue("MOTCoilsCurrent", lambdaCoolingStart3, (double)Parameters["MOTCoilsOffValue"]); // switch off for molasses
