...
public class Patterns : MOTMasterScript
{
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int SFLoadingStart = lambdaCoolingStart + (int)Parameters["LambdaCoolingDuration"];
        ...
        int DipoleImagingEnd = DipoleImagingStart + (int)Parameters["DipoleImaging"];
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        // Dipole trap AOM
        p.Pulse(0, SFLoadingStart, (int)Parameters["DipoleLoading"] + (int)Parameters["FreeExpTime"] + (int)Parameters["DipoleImaging"], "dipoleTrapAOM");
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        /*
        p.AddAnalogValue("xShimCoilCurrent", lambdaCoolingStart + 200, (double)Parameters["xShimZeroField"]); 
        p.AddAnalogValue("yShimCoilCurrent", lambdaCoolingStart + 200, (double)Parameters["yShimZeroField"]);
        p.AddAnalogValue("zShimCoilCurrent", lambdaCoolingStart + 200, (double)Parameters["zShimZeroField"]);

        p.AddAnalogValue("xShimCoilCurrent", image-500, (double)Parameters["xShimDipole"]);
        p.AddAnalogValue("yShimCoilCurrent", image-500, (double)Parameters["yShimDipole"]);
        p.AddAnalogValue("zShimCoilCurrent", image-500, (double)Parameters["zShimDipole"]);
        */

        // SLOWING //

        // switch on and off with AOM
        p.AddAnalogValue("BXAOM1att", (int)Parameters["SlowingChirpStartTime"] - 100, (double)Parameters["BXAOMAttenuation"]);
        p.AddAnalogValue("BXAOM1att", (int)Parameters["SlowingChirpStartTime"] + (int)Parameters["SlowingChirpDuration"], 0.1);
