...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["Frame0TriggerDuration1"] = 100;
        ...
        Parameters["SlowingChirpStartTime"] = 325;//360; //400;// 380;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int SFCoolingStart = lambdaCoolingStart + (int)Parameters["LambdaCoolingDuration"];
        int SFCoolingEnd = SFCoolingStart + (int)Parameters["SFDuration"];
        int TempImage = SFCoolingEnd + (int)Parameters["FreeExpTime"];
        /*
        int FreeSpaceStart = SFCoolingStart + (int)Parameters["SFDuration"];
        int Recap = FreeSpaceStart + (int)Parameters["FreeExpTime"];
        */
        ...
        addDDSPattern(p, "LambdaCoolingStart", lambdaCoolingStart,
        ...
        addDDSPattern(p, "SFCoolingStart", SFCoolingStart,
            (double)Parameters["SF"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["LambdaF1plus"],
            (double)Parameters["MOTAmpDDS1"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS3"], (double)Parameters["LightoffDDS4"]);

        addDDSPattern(p, "SFCoolingEnd", SFCoolingEnd,
            (double)Parameters["LambdaF1minus"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["LambdaF1plus"],
        ...
        /*
        addDDSPattern(p, "SFCooling", SFCoolingStart,
            (double)Parameters["SF"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["LambdaF1plus"],
        ...
        addDDSPattern(p, "FreeSpaceStart", FreeSpaceStart,
            (double)Parameters["SF"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["LambdaF1plus"],
            (double)Parameters["LightoffDDS1"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS3"], (double)Parameters["LightoffDDS4"]);
        */
        addDDSPattern(p, "MOTRECAPRampStart", TempImage,
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        */
        ...
        //p.Pulse(0, Recap+500, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger"); //camera trigger for first frame
        p.Pulse(0, TempImage, (int)Parameters["Frame0TriggerDuration1"], "cameraTrigger");//camera trigger for recap
