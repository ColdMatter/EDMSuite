...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["xShimBM"] = 0.32;
        Parameters["yShimBM"] = -4.67;
        Parameters["zShimBM"] = 1.0;
        // SLOWING //
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int Temp = ODTLoadEnd + (int)Parameters["ODTHoldTime"];
        ...
        addDDSPattern(p, "BlueMOTRECAPRampStart", Temp + (int)Parameters["FreeExpTime"],
