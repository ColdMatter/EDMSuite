...
public class Patterns : MOTMasterScript
{
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int BlueMOTRampStart = SFLoadingEnd + (int)Parameters["FreeExpTime"];
        int DipoleImagingStart = BlueMOTRampStart + (int)Parameters["BlueMOTRampDuration"];
        ...
        addDDSPattern(p, "Image", BlueMOTRampStart,
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(0, DipoleImagingStart, (int)Parameters["DipoleImagingTime"], "cameraTrigger");
        //p.Pulse(patternStartBeforeQ, (int)Parameters["MOTCoilsSwitchOff"] + 2000, (int)Parameters["DipoleImagingTime"], "cameraTrigger");
