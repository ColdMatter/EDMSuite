...
public class Patterns : MOTMasterScript
{
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int ODTSFLoadStart = ODTLambdaLoadStart + (int)Parameters["ODTLambdaLoadDuration"];
        int ODTSFLoadEnd = ODTSFLoadStart + (int)Parameters["ODTLambdaLoadDuration"];
        int Temp = ODTSFLoadEnd + (int)Parameters["ODTHoldTime"];
        ...
        addDDSPattern(p, "SFstart", ODTSFLoadStart,
        ...
        addDDSPattern(p, "ODTHold", ODTSFLoadEnd,
            (double)Parameters["MOTFreqDDS1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["MOTFreqDDS4"],
        ...
        addDDSPattern(p, "Temp_image", Temp + (int)Parameters["FreeExpTime"],
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(0, Temp + (int)Parameters["FreeExpTime"], (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("ODT70att", Temp, 10.0);
        p.AddAnalogValue("ODT90att", Temp, 0.0);
