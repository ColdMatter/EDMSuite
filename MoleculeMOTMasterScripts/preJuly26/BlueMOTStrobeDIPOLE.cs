...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        */
        ...
        Parameters["LambdaF1minusDipole"] = 97.45;

        Parameters["LambdaCoolingDuration"] = 200;
        Parameters["DipoleDuration"] = 500;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int lambdaCoolingDipoleStart = BlueMOTRampStart + (int)Parameters["BlueMOTRampDuration"];
        int lambdaCoolingDipoleEnd = lambdaCoolingDipoleStart + (int)Parameters["DipoleDuration"];
        int imageTime = lambdaCoolingDipoleEnd + (int)Parameters["FreeExpTime"];
        ...
        */
        addDDSPattern(p, "LambdaCooling1", lambdaCoolingDipoleStart,
            (double)Parameters["LambdaF1minusDipole"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["LambdaF1plus"],
            (double)Parameters["Lambda1Amp"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS3"], (double)Parameters["Lambda2Amp"]);
        
        addDDSPattern(p, "Freefall", lambdaCoolingDipoleEnd,
            (double)Parameters["MOTFreqDDS1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["MOTFreqDDS4"],
        ...
        addDDSPattern(p, "Imaging", imageTime,
            (double)Parameters["MOTFreqDDS1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["MOTFreqDDS4"],
            (double)Parameters["MOTAmpDDS1"], (double)Parameters["MOTAmpDDS2"], (double)Parameters["MOTAmpDDS3"], (double)Parameters["MOTAmpDDS4"]);
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(0, imageTime , (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");  //camera trigger imaging blue mot
        ...
        // Dipole trap AOM
        //p.Pulse(0, lambdaCoolingDipoleStart, (int)Parameters["DipoleDuration"], "dipoleTrapAOM");
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        int lambdaCoolingEnd = lambdaCoolingStart1 + (int)Parameters["LambdaCoolingDuration"];
