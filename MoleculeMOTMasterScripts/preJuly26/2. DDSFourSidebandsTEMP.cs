...
public class Patterns : MOTMasterScript
{
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int MOTend = (int)Parameters["MOTEnd"];
        ...
        addDDSPattern(p, "MOTEND", MOTend,
            (double)Parameters["MOTFreqDDS0"], (double)Parameters["MOTFreqDDS1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"],
            (double)Parameters["LightoffDDS0"], (double)Parameters["LightoffDDS1"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS3"]);
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int MOTend = patternStartBeforeQ + (int)Parameters["MOTEnd"];
        int imageTime = MOTend + (int)Parameters["FreeExpTime"];
