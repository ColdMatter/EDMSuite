...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["xShimBM"] = -3.0;//-5.2;
        Parameters["yShimBM"] = -2.0;//2.0;
        Parameters["zShimBM"] = 1.43;//3.68;
        ...
        Parameters["FreqCVB3"] = 175.08;//175.817; //- F = 2sig- delta_a
        Parameters["FreqCVB4"] = 173.68;// 177.442; //+ F = 2sig+ delta_b
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int FreeExpTimeStart = ODTBMLoadStart + (int)Parameters["ODTBMLoadDuration"];
        int Image = FreeExpTimeStart + (int)Parameters["FreeExpTime"];
        ...
        addDDSPattern(p, "FreeExpTime", FreeExpTimeStart,
            (double)Parameters["MOTFreqDDS1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["MOTFreqDDS4"],
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        //p.Pulse(0, ODTBMLoadStart, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");//camera trigger for recap
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("MOTCoilsCurrent", FreeExpTimeStart, (double)Parameters["MOTCoilsOffValue"]); // switch off for molasses
        p.AddAnalogValue("MOTCoilsCurrent", Image + (int)Parameters["Frame0TriggerDuration1"] + 1000, 0.0);
