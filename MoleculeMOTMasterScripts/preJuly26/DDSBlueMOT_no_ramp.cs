...
public class Patterns : MOTMasterScript
{
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int BlueMOTStart = lambdaCoolingStart + (int)Parameters["LambdaCoolingDuration"];
        int BlueMOTEnd = BlueMOTStart + (int)Parameters["BlueMOTDuration"];
        ...
        addDDSPattern(p, "BlueMOTStart", BlueMOTStart,
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("MOTCoilsCurrent", BlueMOTStart, (double)Parameters["BlueMOTField"]);
