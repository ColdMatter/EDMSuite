...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        */
        ...
        Parameters["BlueMOTRampDuration"] = 2250;
        Parameters["BlueMOTRampDuration1"] = 2500;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int BlueMOTRampStart1 = lambdaCoolingStart1 + (int)Parameters["LambdaCoolingDuration"];
        int lambdaCoolingStart2 = BlueMOTRampStart1 + (int)Parameters["BlueMOTRampDuration1"];
        int imageTime = lambdaCoolingStart2 + (int)Parameters["LambdaCoolingDuration"];
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddLinearRamp("MOTCoilsCurrent", BlueMOTRampStart1, (int)Parameters["BlueMOTRampDuration1"], (double)Parameters["BlueMOTField1"]);
