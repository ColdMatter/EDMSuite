...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        */
        ...
        Parameters["SFDuration"] = 10000;
        Parameters["FreeExpTime"] = 10000;
        Parameters["DipoleImageDur"] = 3000;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int SFstart = lambdaCoolingStart + (int)Parameters["LambdaCoolingDuration"];
        int SFEnd = SFstart + (int)Parameters["SFDuration"];
        int DPimageStart = SFEnd + (int)Parameters["FreeExpTime"];
        int DPimageEnd = DPimageStart + (int)Parameters["DipoleImageDur"];
        ...
        addDDSPattern(p, "SFstart", SFstart,
        ...
        addDDSPattern(p, "Freefall", SFEnd,
            (double)Parameters["MOTFreqDDS1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["MOTFreqDDS4"],
        ...
        addDDSPattern(p, "Image", DPimageStart,
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(0, DPimageStart, (int)Parameters["DipoleImageDur"], "cameraTrigger"); //camera trigger for recap
        //p.Pulse(0, lambdaCoolingStart, (int)Parameters["LambdaCoolingDuration"], "cameraTrigger");
        ...
        // Dipole trap AOM
        p.Pulse(0, SFstart, (int)Parameters["SFDuration"] + (int)Parameters["FreeExpTime"] + (int)Parameters["DipoleImageDur"], "dipoleTrapAOM");
