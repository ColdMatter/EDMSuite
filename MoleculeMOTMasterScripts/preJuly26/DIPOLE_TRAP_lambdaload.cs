...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        */
        ...
        Parameters["LambdaF1minusScan"] = 97.45;

        Parameters["LambdaCoolingDuration"] = 500;
        Parameters["DipoleLoading"] = 15000;
        Parameters["FreeExpTime"] = 10000;
        Parameters["DipoleImaging"] = 5000;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int lambdaLoadingStart = lambdaCoolingStart + (int)Parameters["LambdaCoolingDuration"];
        int lambdaLoadingEnd = lambdaLoadingStart + (int)Parameters["DipoleLoading"];
        int DipoleImagingStart = lambdaLoadingEnd + (int)Parameters["FreeExpTime"];
        ...
        addDDSPattern(p, "SFstart", lambdaLoadingStart,
            (double)Parameters["LambdaF1minusScan"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["LambdaF1plus"],
            (double)Parameters["Lambda1Amp"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS3"], (double)Parameters["Lambda2Amp"]);

        addDDSPattern(p, "Freefall", lambdaLoadingEnd,
            (double)Parameters["MOTFreqDDS1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["MOTFreqDDS4"],
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(0, DipoleImagingStart, (int)Parameters["DipoleLoading"], "cameraTrigger");
        ...
        // Dipole trap AOM
        p.Pulse(0, lambdaLoadingStart, (int)Parameters["DipoleLoading"] + (int)Parameters["FreeExpTime"] + (int)Parameters["DipoleImaging"], "dipoleTrapAOM");
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        int lambdaLoadingStart = lambdaCoolingStart + (int)Parameters["LambdaCoolingDuration"];
        int lambdaLoadingEnd = lambdaLoadingStart + (int)Parameters["DipoleLoading"];
        int lambdaRecap = lambdaLoadingEnd + (int)Parameters["FreeExpTime"];
