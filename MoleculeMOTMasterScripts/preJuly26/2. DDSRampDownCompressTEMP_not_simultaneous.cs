...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["MOTCompressoinHoldDuratoin"] = 10;
        ...
        //Parameters["v0IntensityRampEndTime"] = (int)Parameters["v0IntensityRampStartTime"] + (int)Parameters["v0IntensityRampDuration"];//--> this is dangerous because if somebody wants to scan the ramp start or duration it wont work
        Parameters["v0IntensityRampDuration"] = 1000;
        Parameters["v0IntensityRampHoldDuration"] = 500;
        ...
        */
        ...
        Parameters["Lambda1"] = 98.00;
        Parameters["Lambda3"] = 171.00;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int RampStart = motCompressoinEndTime + (int)Parameters["MOTCompressoinHoldDuratoin"];
        int RampEnd = RampStart + (int)Parameters["v0IntensityRampDuration"];
        int MOTEnd = RampEnd + (int)Parameters["v0IntensityRampHoldDuration"];
        int imageTime = MOTEnd + (int)Parameters["FreeExpTime"];
        ...
        addDDSPattern(p, "RampStart", RampStart,
            (double)Parameters["MOTFreqDDS1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["MOTFreqDDS4"],
            (double)Parameters["MOTAmpDDS1"], (double)Parameters["MOTAmpDDS2"], (double)Parameters["MOTAmpDDS3"], (double)Parameters["MOTAmpDDS4"],
        ...
        addDDSPattern(p, "RampEnd", RampEnd,
            (double)Parameters["MOTFreqDDS1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["MOTFreqDDS4"],
        ...
        addDDSPattern(p, "Freefall", MOTEnd,
            (double)Parameters["MOTFreqDDS1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["MOTFreqDDS4"],
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int motCompressionStartTime = (int)Parameters["MOTCompressoinStartTime"] + patternStartBeforeQ;
        int motCompressoinEndTime = motCompressionStartTime + (int)Parameters["MOTCompressoinDuratoin"];
        int RampStart = motCompressoinEndTime + (int)Parameters["MOTCompressoinHoldDuratoin"];
        int RampEnd = RampStart + (int)Parameters["v0IntensityRampDuration"];
        int MOTEnd = RampEnd + (int)Parameters["v0IntensityRampHoldDuration"];
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("MOTCoilsCurrent", MOTEnd, 0.0); // switch off for temp
        //p.AddAnalogValue("MOTCoilsCurrent", imageTime, 1.0); // switch off for temp
