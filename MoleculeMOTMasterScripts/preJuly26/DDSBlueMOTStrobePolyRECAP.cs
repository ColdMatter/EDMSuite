...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        */
        ...
        Parameters["BlueMOTRampDuration"] = 3000;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        */
        ...
        addDDSPattern(p, "Recap", lambdaCoolingEnd,
            (double)Parameters["MOTFreqDDS1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["MOTFreqDDS4"],
            (double)Parameters["MOTAmpDDS1"], (double)Parameters["MOTAmpDDS2"], (double)Parameters["MOTAmpDDS3"], (double)Parameters["MOTAmpDDS4"]);
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(0, lambdaCoolingEnd, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");  //camera trigger imaging blue mot
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddPolynomialRamp("MOTCoilsCurrent",
            BlueMOTRampStart,
            BlueMOTRampEnd,
            (double)Parameters["BlueMOTField"],
            (double)Parameters["BlueMOTField"],   // Parameters["UpperThreshold"]
            0.0,                   // Parameters["LowerThreshold"]
            (double)Parameters["w1"],                    // Parameters["weight1"]
            (double)Parameters["w2"],                   // Parameters["weight2"]
            (double)Parameters["w3"],              // Parameters["weight3"]
            (double)Parameters["w4"]);           // Parameters["weight4"]
        p.AddAnalogValue("MOTCoilsCurrent", lambdaCoolingStart1, (double)Parameters["MOTCoilsOffValue"]); // switch off for molasses
        p.AddAnalogValue("MOTCoilsCurrent", lambdaCoolingEnd, (double)Parameters["MOTCoilsCurrentValue"]);
