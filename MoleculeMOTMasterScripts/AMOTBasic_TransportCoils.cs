...
public class Patterns : MOTMasterScript
{
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddLinearRamp("MOTCoilsCurrent", (int)Parameters["MOTCoilsSwitchOff"], 10000, 0.0);
        //p.AddAnalogValue("MOTCoilsCurrent", 0, 0.0);
        p.AddAnalogValue("transferCoils", 0, 0.0);
        p.AddLinearRamp("transferCoils", (int)Parameters["MOTCoilsSwitchOff"], 13300, 5.6);
        p.AddAnalogValue("transferCoils", (int)Parameters["MOTCoilsSwitchOff"], 0.0);
