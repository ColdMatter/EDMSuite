...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["MolassesDuration"] = 80; // THIS IS THE ACTUAL LENGTH OF THE MOLASSES (NOT 1ms LONGER AS PREVIOUSLY)
        Parameters["MolassesWaitTime"] = 100; // Wait time for B field to turn off before blue molasses light is switched on
        ...
        Parameters["v0IntensityMolassesRampStartTime"] = 7650;
        Parameters["v0IntensityMolassesRampDuration"] = 10;
        Parameters["v0IntensityMolassesRampStartValue"] = 7.24;
        Parameters["v0IntensityMolassesRampEndValue"] = 7.24;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(patternStartBeforeQ, (int)Parameters["MOTSwitchOffTime"] + (int)Parameters["MolassesWaitTime"] + (int)Parameters["MolassesDuration"], (int)Parameters["ExpansionTime"], "motAOM"); //pulse off the MOT light to release the cloud
        ...
        p.Pulse(patternStartBeforeQ, (int)Parameters["MOTSwitchOffTime"] + (int)Parameters["MolassesWaitTime"] + (int)Parameters["MolassesDuration"] + (int)Parameters["ExpansionTime"], (int)Parameters["Frame0TriggerDuration"], "cameraTrigger"); //camera trigger for first frame
        //
        return p;
    }
