...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        //Recapture to MOT:
        Parameters["WaitBeforeImage"] = 600;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int finalImageTime = molassesEndTime + (int)Parameters["WaitBeforeImage"];
        //int finalImageTime = molassesEndTime + (int)Parameters["OPDuration"] + (int)Parameters["WaitBeforeImage"];
        ...
        */
        ...
        p.AddEdge("rb2DMOTShutter", molassesEndTime + (int)Parameters["OPDuration"] - 1700, true);//Close the shutter for Mag trap.
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("v00Frequency", finalImageTime - 100, 10.0 - (double)Parameters["v0FrequencyStartValue"] / (double)Parameters["calibGradient"]); //jump aom frequency back to normal for imaging
