...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["TempTriggerDuration"] = 2000;
        ...
        */
        ...
        // magtrap //
        Parameters["MagtrapDuration"] = 283000;
        ...
        */
        ...
        Parameters["LambdaCooling2Duration"] = 500;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int imageTime = lambdaCooling2end + (int)Parameters["FreeExpTime"];
        ...
        addDDSPattern(p, "FreeFall", lambdaCooling2end,
        ...
        addDDSPattern(p, "image", imageTime,
            (double)Parameters["LambdaF1minus"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["LambdaF1plus"],
            (double)Parameters["MOTAmpDDS1"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS2"], (double)Parameters["MOTAmpDDS4"]);
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(patternStartBeforeQ, 0, (int)Parameters["QSwitchPulseDuration"], "cafOptPumpingAOM");
