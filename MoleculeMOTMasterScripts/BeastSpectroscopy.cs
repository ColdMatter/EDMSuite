...
public class Patterns : MOTMasterScript
{
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(patternStartBeforeQ, (int)Parameters["Frame0Trigger"], 2000, "v00MOTAOM");
        ...
        //p.AddEdge("rb2DMOTShutter", patternStartBeforeQ + (int)Parameters["Frame0Trigger"], true);
        //p.AddEdge("rb2DMOTShutter", patternStartBeforeQ + (int)Parameters["Frame0Trigger"] + 2000, false);
