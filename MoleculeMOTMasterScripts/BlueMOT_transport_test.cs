...
public class Patterns : MOTMasterScript
{
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int HandoverEnd = HandoverStart + (int)Parameters["HandoverDur"];
        int Image = HandoverEnd + (int)Parameters["TransportHoldDur"];
        int TransferCoilsOff = Image + (int)Parameters["Frame0TriggerDuration"];
