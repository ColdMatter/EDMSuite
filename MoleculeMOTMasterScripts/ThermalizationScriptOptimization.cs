...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["MOTCoilsCurrentRampEndValue"] = 1.0;
        ...
        Parameters["v0IntensityImagingValue"] = 7.78;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int secondMicrowavePulseTime = mqtStartTime + (int)Parameters["MQTHoldDuration"];
        ...
        p.AddEdge("rb3DMOTShutter", mqtStartTime - 1400, false);
        ...
        p.Pulse(0, imageTime + 500, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger"); // camera trigger

        //Mechanical CaF shutters:
        p.Pulse(0, blowAwayTime - 1500, imageTime - blowAwayTime + 8000, "bXSlowingShutter"); //B-X shutter closed after blow away
