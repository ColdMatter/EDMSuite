...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["xShimLoadCurrent"] = -3.00;// -3.00;// -1.35;// -1.35;
        Parameters["yShimLoadCurrent"] = -2.25;// -1.92;// -1.92;
        Parameters["zShimLoadCurrent"] = -0.25;


        //Parameters["xShimMolassesCurrent"] = -1.35;// -1.35;
        //Parameters["yShimMolassesCurrent"] = -2.30;// -1.92;
        //Parameters["zShimMolassesCurrent"] = -0.22;// -0.22;
        ...
        Parameters["MOTCoilsCompressionValue"] = 2.00; 
        ...
        //Lambda frequency
        Parameters["LambdaDetuning1"] = 31.00;
        ...
        //Parameters["SidebandFreqLambda3"] = (400.00 - (double)Parameters["LambdaDetuning3"]) / 2.0; //- F = 2
        Parameters["SidebandFreqLambda4"] = (380.00 - (double)Parameters["LambdaDetuning4"]) / 2.0; //+ F = 1+


        // Image
        Parameters["SidebandFreqIm1"] = 210.00 / 2.0; //+ F = 1- 
        Parameters["SidebandFreqIm2"] = 288.00 / 2.0; //- F = 0
        Parameters["SidebandFreqIm3"] = 384.00 / 2.0; //- F = 2
        Parameters["SidebandFreqIm4"] = 336.00 / 2.0; //+ F = 1+
        ...
        //10% saturation, Oct 01, 2024

        Parameters["SidebandAmpRampEnd1"] = 3.4;
        Parameters["SidebandAmpRampEnd2"] = 3.7;
        Parameters["SidebandAmpRampEnd3"] = 3.45;
        Parameters["SidebandAmpRampEnd4"] = 3.5;

        Parameters["SidebandAmpLambda4"] = 7.5;
        Parameters["SidebandAmpLambda1"] = 4.5;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int molassesStart = motEndTime + (int)Parameters["FrequencySettleTime"];
        int lambdaCoolingStart = molassesStart + (int)Parameters["MolassesDuration"];
        ...
        //p.AddEdge("v0rfswitch3", lambdaCoolingStart, false);
        //p.AddEdge("v0rfswitch4", lambdaCoolingStart, true);
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("MOTCoilsCurrent", motEndTime, -0.05);

        // Recapture
        //p.AddAnalogValue("MOTCoilsCurrent", imageTime - 100, (double)Parameters["MOTCoilsCurrentValue"]);
        //p.AddAnalogValue("MOTCoilsCurrent", imageTime + 1000, -0.05);
        ...
        //p.AddAnalogValue("xShimCoilCurrent", motEndTime, (double)Parameters["xShimMolassesCurrent"]);
        //p.AddAnalogValue("yShimCoilCurrent", motEndTime, (double)Parameters["yShimMolassesCurrent"]);
        //p.AddAnalogValue("zShimCoilCurrent", motEndTime, (double)Parameters["zShimMolassesCurrent"]);
        ...
        p.AddAnalogValue("Rf1Freq", motEndTime, ((double)Parameters["SidebandFreqLambda1"] - (double)Parameters["POS150OffsetFreq"]) / (double)Parameters["POS150Gradient"]);
        //p.AddAnalogValue("Rf2Freq", motHoldEnd, ((double)Parameters["SidebandFreqLambda2"] - (double)Parameters["POS300OffsetFreq"]) / (double)Parameters["POS300Gradient"]);
        //p.AddAnalogValue("Rf3Freq", motHoldEnd, ((double)Parameters["SidebandFreqLambda3"] - (double)Parameters["POS300OffsetFreq"]) / (double)Parameters["POS300Gradient"]);
        p.AddAnalogValue("Rf4Freq", motEndTime, ((double)Parameters["SidebandFreqLambda4"] - (double)Parameters["POS300OffsetFreq"]) / (double)Parameters["POS300Gradient"]);

        p.AddAnalogValue("Rf1Freq", imageTime - 50, ((double)Parameters["SidebandFreq1"] - (double)Parameters["POS150OffsetFreq"]) / (double)Parameters["POS150Gradient"]);
        p.AddAnalogValue("Rf2Freq", imageTime - 50, ((double)Parameters["SidebandFreq2"] - (double)Parameters["POS300OffsetFreq"]) / (double)Parameters["POS300Gradient"]);
        p.AddAnalogValue("Rf3Freq", imageTime - 50, ((double)Parameters["SidebandFreq3"] - (double)Parameters["POS300OffsetFreq"]) / (double)Parameters["POS300Gradient"]);
        p.AddAnalogValue("Rf4Freq", imageTime - 50, ((double)Parameters["SidebandFreq4"] - (double)Parameters["POS300OffsetFreq"]) / (double)Parameters["POS300Gradient"]);
        ...
        p.AddAnalogValue("Rf4Amp", motEndTime, (double)Parameters["SidebandAmpLambda4"]);
        p.AddAnalogValue("Rf1Amp", motEndTime, (double)Parameters["SidebandAmpLambda1"]);
        ...
        p.AddAnalogValue("Rf1Freq", imageTime, ((double)Parameters["SidebandFreqIm1"] - (double)Parameters["POS150OffsetFreq"]) / (double)Parameters["POS150Gradient"]);
        p.AddAnalogValue("Rf2Freq", imageTime, ((double)Parameters["SidebandFreqIm2"] - (double)Parameters["POS300OffsetFreq"]) / (double)Parameters["POS300Gradient"]);
        p.AddAnalogValue("Rf3Freq", imageTime, ((double)Parameters["SidebandFreqIm3"] - (double)Parameters["POS300OffsetFreq"]) / (double)Parameters["POS300Gradient"]);
        p.AddAnalogValue("Rf4Freq", imageTime, ((double)Parameters["SidebandFreqIm4"] - (double)Parameters["POS300OffsetFreq"]) / (double)Parameters["POS300Gradient"]);
