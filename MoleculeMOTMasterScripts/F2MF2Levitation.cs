...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["MOTCoilsCurrentLevitateValue"] = 0.1; //0.21

        Parameters["CoilsSwitchOffTime"] = 40000;

        // Shim fields
        Parameters["xShimLoadCurrent"] = 2.195;// 1.195; // 1.202;// 1.219;
        Parameters["yShimLoadCurrent"] = -0.175; //2.4
        Parameters["zShimLoadCurrent"] = 0.32;//-6.425;//0.26; //-6.39
        Parameters["zShimLevitateCurrent"] = 8.5;//-6.425;//0.26; //-6.39
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("MOTCoilsCurrent", levitationGradientTime, (double)Parameters["MOTCoilsCurrentLevitateValue"]);
        ...
        p.AddAnalogValue("zShimCoilCurrent", imageTime + 3000, (double)Parameters["zShimLoadCurrent"]);
        ...
        p.AddAnalogValue("v00Intensity", releaseTime, (double)Parameters["v0IntensityImageValue"]);
