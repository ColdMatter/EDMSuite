...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        */
        ...
        Parameters["LambdaF1minusLoad"] = 97.28;
        ...
        //Parameters["BlueMOTRampDuration1"] = 200;

        Parameters["LambdaCoolingDuration"] = 400;
        Parameters["LambdaCoolingDuration1"] = 1;
        Parameters["DipoleLoading"] = 3500;
        ...
        Parameters["MOTRecapImageDelay"] = 500;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int MOTRECAPStart = SFLoadingEnd + (int)Parameters["FreeExpTime"];
        ...
        addDDSPattern(p, "LambdaPreCool", Lambda2start,
            (double)Parameters["LambdaF1minus"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["LambdaF1plus"],
            (double)Parameters["Lambda1Amp"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS3"], (double)Parameters["Lambda2Amp"]);
        
        addDDSPattern(p, "LambdaLoad", SFLoadingStart,
            (double)Parameters["LambdaF1minusLoad"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["LambdaF1plus"],
            (double)Parameters["Lambda1Amp"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS3"], (double)Parameters["Lambda2Amp"]);
        ...
        addDDSPattern(p, "MOTRECAPStart", MOTRECAPStart,
            (double)Parameters["MOTFreqDDS1"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["MOTFreqDDS4"],
            (double)Parameters["MOTAmpDDS1"], (double)Parameters["MOTAmpDDS2"], (double)Parameters["MOTAmpDDS3"], (double)Parameters["MOTAmpDDS4"]);
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(0, MOTRECAPStart + 500, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("MOTCoilsCurrent", MOTRECAPStart, (double)Parameters["MOTCoilsCurrentValue"]);
        p.AddAnalogValue("MOTCoilsCurrent", MOTRECAPStart + 4000, 0.0);
        ...
        p.AddAnalogValue("ODT70att", SFLoadingStart, 0.0);
        p.AddAnalogValue("ODT90att", SFLoadingStart, 10.0);

        p.AddAnalogValue("ODT70att", MOTRECAPStart, 10.0);
        p.AddAnalogValue("ODT90att", MOTRECAPStart, 0.0);
