...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        */
        ...
        Parameters["FreqCVB1"] = 97.50; //+ F = 1Delta 97.50MHz 195.00MHz
        Parameters["FreqCVB3"] = 171.32; //- F = 2sig- 170.78MHz 341.56MHz
        Parameters["FreqCVB4"] = 172.06; //+ F = 2sig+ 170.48MHz 340.96MHz

        Parameters["BlueMOTField"] = 0.2;
        Parameters["BlueMOTField1"] = 1.2;

        Parameters["BlueMOTRampDuration"] = 200;
