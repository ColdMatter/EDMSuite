...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        // Camera
        Parameters["MOTLoadTime"] = 50000;//100000;
        ...
        Parameters["DelayFromTransferStart"] = 10;//10000;//210000;//180000;


        //Rb light
        Parameters["ImagingFrequency"] = 2.65;//old value :2.58; //Resonance at aroun 2.65
        ...
        Parameters["MagneticTrapDuration"] = 100000; //Accel 3500
        ...
        Parameters["DipoleTrapMagTrapOverlapDuration"] = 5000;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        //int cameraTrigger1 = rampUpInternalTweezerMagTrap + (int)Parameters["DelayFromTransferStart"];
        ...
        p.AddEdge("rbAbsImagingBeam", InternalTweezerMagTrapEndTime + 250, false); //turn on probe beam to image cloud after holding in mag trap for some time
        p.AddEdge("rbAbsImagingBeam", 300000, true);
        ...
        p.Pulse(0, InternalTweezerMagTrapEndTime + 250, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger"); //1st camera frame
