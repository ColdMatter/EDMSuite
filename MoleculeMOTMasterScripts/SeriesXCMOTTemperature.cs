...
// After the compression, by switching off of the magnetic field and v00 light
// the cloud is made to expand to extimate the temperature
public class Patterns : MOTMasterScript
{
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int imagingLightOnTime = cmotEndTime + (int)Parameters["ExpansionTime"];
        int imageTime = imagingLightOnTime + (int)Parameters["WaitBeforeImage"];
        int endOfTime = imageTime + 3000;

        MOTMasterScriptSnippet lm = new LoadMoleculeMOT(p, Parameters);
        //V00 AOM switch:
        //p.Pulse(0, cmotEndTime, imagingLightOnTime - cmotEndTime, "v00MOTAOM");
        //Camera triggers:
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("v00Frequency", cmotEndTime, 10.0 - (double)Parameters["v0FrequencyMOTValue"] / (double)Parameters["calibGradient"]);
