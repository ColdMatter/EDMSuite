...
public class Patterns : MOTMasterScript
{
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int v0IntensityRampStartTime = patternStartBeforeQ + (int)Parameters["MOTLoadDuration"];
        int cmotStartTime = v0IntensityRampStartTime + (int)Parameters["V0IntensityRampDuration"];
        int cmotEndTime = cmotStartTime + (int)Parameters["CMOTRampDuration"];
        int imageTime = cmotEndTime;
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        int v0IntensityRampStartTime = (int)Parameters["MOTLoadDuration"];
        int cmotStartTime = v0IntensityRampStartTime + (int)Parameters["V0IntensityRampDuration"];
        int cmotEndTime = cmotStartTime + (int)Parameters["CMOTRampDuration"];
        int imageTime = cmotEndTime;
        ...
        p.AddLinearRamp("v00Intensity", cmotStartTime, (int)Parameters["CMOTRampDuration"], (double)Parameters["CMOTGradient"]);
