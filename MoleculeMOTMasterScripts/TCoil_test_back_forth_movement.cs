...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        */
        ...
        Parameters["MoveTime"] = 200000;

        Parameters["TransportEdgeDur"] = 180000;

        Parameters["ShutterEdgeDur"] = (int)Parameters["MagtrapDuration"] + (int)Parameters["HandoverDur"] + (int)Parameters["MoveTime"] + (int)Parameters["MoveTime"];
    }
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int TweezerArrive = MoveStart + (int)Parameters["MoveTime"];
        int ImageMOTChamber = TweezerArrive + (int)Parameters["MoveTime"];
        int TransferCoilsOff = ImageMOTChamber + (int)Parameters["Frame0TriggerDuration"] + 2000;
        ...
        addDDSPattern(p, "image", ImageMOTChamber-1000,
            (double)Parameters["FreqCVB1"], (double)Parameters["FreqCVB2"], (double)Parameters["FreqCVB3"], (double)Parameters["FreqCVB4"],
            (double)Parameters["BMOTAmpDDS1"], (double)Parameters["BMOTAmpDDS2"], (double)Parameters["BMOTAmpDDS3"], (double)Parameters["BMOTAmpDDS4"]);
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(0, TweezerArrive, (int)Parameters["Frame0TriggerDuration"], "rbAbsImgCamTrig");  //camera trigger for MOT recap 
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        */
        ...
        p.AddLinearRamp("TweezerCoils", HandoverStart, (int)Parameters["HandoverDur"], 0.48);
        p.AddLinearRamp("TweezerCoils", TransferCoilsOff, (int)Parameters["HandoverDur"], 0.0);
