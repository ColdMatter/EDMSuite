...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        */
        ...
        Parameters["LambdaF1minus"] = 97.45;//97.45;
        Parameters["LambdaF1plus"] = 171.00;

        Parameters["SF"] = 95.0;

        Parameters["LambdaRampAmplitudeDDS1"] = 0.0;
        Parameters["LambdaRampAmplitudeDDS4"] = 0.0;
        ...
        Parameters["ImFreqDDS1"] = 97.45;
        Parameters["ImFreqDDS2"] = 139.55;
        Parameters["ImFreqDDS3"] = 171.42;
        Parameters["ImFreqDDS4"] = 171.00;


        Parameters["LambdaCoolingDuration"] = 200;
        Parameters["SFDuration"] = 4000;
    ...
    public override Dictionary<string, List<List<double>>> GetDDSPattern()
    {
        ...
        int imageTime = SFEnd + (int)Parameters["FreeExpTime"];
        ...
        //0.0, 0.0, 0.0, 0.0, (double)Parameters["LambdaRampAmplitudeDDS1"], 0.0, 0.0, (double)Parameters["LambdaRampAmplitudeDDS4"]);
        ...
        addDDSPattern(p, "Imaging", imageTime,
            (double)Parameters["LambdaF1minus"], (double)Parameters["MOTFreqDDS2"], (double)Parameters["MOTFreqDDS3"], (double)Parameters["LambdaF1plus"],
            (double)Parameters["Lambda1Amp"], (double)Parameters["LightoffDDS2"], (double)Parameters["LightoffDDS3"], (double)Parameters["Lambda1Amp"]);
        */
        return p;
    }
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(0, imageTime, (int)Parameters["Frame0TriggerDuration"], "cameraTrigger"); //camera trigger for temperature
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("MOTCoilsCurrent", imageTime, 1.0); // switch on for recap
