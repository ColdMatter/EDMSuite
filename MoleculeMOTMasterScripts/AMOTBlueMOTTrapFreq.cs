...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["BlueMOTReleaseTime"] = 1000;
        Parameters["SecondBlueMOTDuration"] = 5000;
    ...
    private void prePatternSetup()
    {
        ...
        DDSCtrl.addPatternToBufferSingle(new List<double> { 
            (double)Parameters["DDSFreq0"], (double)Parameters["DDSAmp0"],
            (double)Parameters["DDSFreq1"], (double)Parameters["DDSAmp1"],
            (double)Parameters["DDSFreq2"], (double)Parameters["DDSAmp2"],
            (double)Parameters["DDSFreq3"], (double)Parameters["DDSAmp3"] });
    }
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int blueMOTRestart = blueMOTEnd + (int)Parameters["BlueMOTReleaseTime"];
        int secondBlueMOTEnd = blueMOTRestart + (int)Parameters["SecondBlueMOTDuration"];
        int imageTime = secondBlueMOTEnd + (int)Parameters["FreeExpTime"];
        ...
        p.Pulse(0, secondBlueMOTEnd - (int)Parameters["Frame0TriggerDuration"], (int)Parameters["Frame0TriggerDuration"], "cameraTrigger");
        ...
        p.AddEdge("v0rfswitch1", blueMOTRestart, false);
        p.AddEdge("v0rfswitch3", blueMOTRestart, false);
        p.AddEdge("v0rfswitch4", blueMOTRestart, false);

        // switch back off

        p.AddEdge("v0rfswitch1", secondBlueMOTEnd, true);
        p.AddEdge("v0rfswitch3", secondBlueMOTEnd, true);
        p.AddEdge("v0rfswitch4", secondBlueMOTEnd, true);

        p.AddEdge("v0ddsSwitchA", secondBlueMOTEnd, false);
        p.AddEdge("v0ddsSwitchB", secondBlueMOTEnd, false);
        p.AddEdge("v0ddsSwitchC", secondBlueMOTEnd, false);
        p.AddEdge("v0ddsSwitchD", secondBlueMOTEnd, false);
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("MOTCoilsCurrent", blueMOTRestart, (double)Parameters["BlueMOTField"]);
        p.AddAnalogValue("MOTCoilsCurrent", secondBlueMOTEnd, -0.00);
