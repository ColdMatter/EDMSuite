...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        //Rb light:
        Parameters["ImagingFrequency"] = 1.9;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(0, microwavePulseTime - 1200, motRecaptureTime - microwavePulseTime - 1300, "v00MOTShutter"); //V00 shutter closed after optical pumping and opened for recpature into MOT
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("MOTCoilsCurrent", motRecaptureTime - 30, -0.05);
        ...
        p.AddAnalogValue("v00EOMAmp", motRecaptureTime - 200, (double)Parameters["v0EOMMOTValue"]);
