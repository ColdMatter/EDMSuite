...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["PatternLength"] = 50000;//170000
        ...
        Parameters["MolassesHoldTime"] = 1000;//200;
        ...
        //Bowtie light detuning
        Parameters["BowtieDetuning"] = 10.0;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        //int finalImageTime =  OPbiasfieldSettleTime + (int)Parameters["OPDuration"];
        int finalImageTime = molassesStartTime+500;
        ...
        */
        ...
        //p.Pulse(0, molassesEndTime, finalImageTime - molassesEndTime, "v00MOTAOM"); // turn off the MOT light for optical pumping and magnetic trapping. 
        p.Pulse(0, finalImageTime, 3000, "v00MOTAOM"); 
        p.Pulse(finalImageTime, 0, 3000, "TransverseCoolingShutter"); // turn on the bowtie light for imaging. 
       ...
       // p.AddEdge("motLightSwitch", 0, false);
        ...
        //p.AddEdge("motLightSwitch", (int)Parameters["PatternLength"] - 1000, false);
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        //Bowtie light detuning
        p.AddAnalogValue("lightSwitch", 0, (double)Parameters["BowtieDetuning"]);
        ...
        //p.AddAnalogValue("MOTCoilsCurrent", molassesEndTime, (double)Parameters["MOTCoilsCurrentRampStartValue"]);
        p.AddAnalogValue("MOTCoilsCurrent", rbMQTImageTime - 150, 0.0);

        // Shim Fields
        p.AddAnalogValue("xShimCoilCurrent", 0, (double)Parameters["xShimLoadCurrent"]);
        p.AddAnalogValue("yShimCoilCurrent", 0, (double)Parameters["xShimLoadCurrent"]);
        p.AddAnalogValue("zShimCoilCurrent", 0, (double)Parameters["zShimLoadCurrent"]);


        p.AddAnalogValue("xShimCoilCurrent", molassesStartTime+400, (double)Parameters["xShimLoadCurrentOP"]);
        p.AddAnalogValue("yShimCoilCurrent", molassesStartTime+400, (double)Parameters["yShimLoadCurrentOP"]);
        p.AddAnalogValue("zShimCoilCurrent", molassesStartTime+400, (double)Parameters["zShimLoadCurrentOP"]);
        ...
        p.AddAnalogValue("v00Frequency", finalImageTime - 100, 10.0 - (double)Parameters["v0FrequencyImagingValue"] / (double)Parameters["calibGradient"]); //jump aom frequency back to normal for imaging
