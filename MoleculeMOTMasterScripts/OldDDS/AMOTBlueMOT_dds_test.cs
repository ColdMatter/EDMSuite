...
public class Patterns : MOTMasterScript
{
    ...
    private void prePatternSetup()
    {
        ...
        addDDSPattern(DDSCtrl, "PatternStart", 0,
            (double)Parameters["DDSFreq0"], (double)Parameters["DDSFreq1"], (double)Parameters["DDSFreq2"], (double)Parameters["DDSFreq3"],
            (double)Parameters["DDSAmp0"], (double)Parameters["DDSAmp1"], (double)Parameters["DDSAmp2"], (double)Parameters["DDSAmp3"]);
