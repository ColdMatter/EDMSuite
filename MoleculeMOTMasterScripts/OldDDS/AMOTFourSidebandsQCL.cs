...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        // Slowing Chirp
        Parameters["SlowingChirpStartTime"] = 290;//360; //400;// 380;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        // QCL shutter
        p.Pulse(patternStartBeforeQ, (int)Parameters["Frame0Trigger"] + (int)Parameters["Frame0TriggerDuration"] - 200, 10000, "QCLShutter");
        //p.Pulse(0, lambdaCoolingEnd - 200, (int)Parameters["FreeExpTime"], "QCLShutter"); 
