...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["SidebandOPAmp1"] = 10.0; // F = - 1
        Parameters["SidebandOPAmp2"] = 0.0; // F = 0
        Parameters["SidebandOPAmp3"] = 10.0; // F = 2 
        Parameters["SidebandOPAmp4"] = 10.0; // F = + 1


        //10% saturation, Dec 13, 2024
        ...
        Parameters["OpticalPumpDuration"] = 10;
