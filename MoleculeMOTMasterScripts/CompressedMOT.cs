...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["MOTCoilsCompressionValue"] = 1.6;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int mqtStartTime = cafOPStartTime;
        //int rbOPStartTime = mqtStartTime - (int)Parameters["RbOPDuration"];
        int motRecaptureTime = mqtStartTime + (int)Parameters["FreeExpansionTime"];
