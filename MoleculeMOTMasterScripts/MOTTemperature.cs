...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        // B Field
        Parameters["MOTCoilsSwitchOnTime"] = 0;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int bRampStartTime = (int)Parameters["MOTCoilsRampStartTime"];
        int bRampEndTime = bRampStartTime + (int)Parameters["MOTCoilsRampDuration"];
        int intensityRampStartTime = bRampEndTime + (int)Parameters["CompressionSettleTime"];
        int intensityRampEndTime = intensityRampStartTime + (int)Parameters["v0IntensityRampDuration"];
        int motSwitchOffTime = intensityRampEndTime + (int)Parameters["IntensityRampSettleTime"];
        int imageTime = motSwitchOffTime + (int)Parameters["ExpansionTime"];
        int patternStartBeforeQ = (int)Parameters["TCLBlockStart"];

        MOTMasterScriptSnippet lm = new LoadMoleculeMOT(p, Parameters);  // This is how you load "preset" patterns.          
        p.Pulse(patternStartBeforeQ, motSwitchOffTime, (int)Parameters["ExpansionTime"], "v00MOTAOM"); //pulse off the MOT light whilst MOT fields are turning off
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddLinearRamp("v00Intensity", intensityRampStartTime, intensityRampEndTime - intensityRampStartTime, (double)Parameters["v0IntensityRampEndValue"]);
