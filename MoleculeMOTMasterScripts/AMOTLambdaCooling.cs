...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        Parameters["SidebandFreqLambda1"] = (248.00 - (double)Parameters["LambdaDetuning1"]) / 2.0; //+ F = 1-
        ...
        Parameters["SidebandFreqLambda4"] = (400.00 - (double)Parameters["LambdaDetuning4"]) / 2.0; //+ F = 1+
