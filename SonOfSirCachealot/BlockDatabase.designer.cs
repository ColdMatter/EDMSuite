...
namespace SonOfSirCachealot
{
    ...
    partial void InsertDBDBlock(DBDBlock instance);
    partial void UpdateDBDBlock(DBDBlock instance);
    partial void DeleteDBDBlock(DBDBlock instance);
    #endregion
		...
		public System.Data.Linq.Table<DBDBlock> DBDBlocks
		{
			get
			{
				return this.GetTable<DBDBlock>();
			}
		}
	}
	...
	public partial class DBBlock : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<DBDBlock> _DBDBlocks;
    ...
    partial void OnconfigBytesChanged();
		...
		public DBBlock()
		{
			...
			this._DBDBlocks = new EntitySet<DBDBlock>(new Action<DBDBlock>(this.attach_DBDBlocks), new Action<DBDBlock>(this.detach_DBDBlocks));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DBBlock_DBDBlock", Storage="_DBDBlocks", ThisKey="blockID", OtherKey="blockID")]
		public EntitySet<DBDBlock> DBDBlocks
		{
			get
			{
				return this._DBDBlocks;
			}
			set
			{
				this._DBDBlocks.Assign(value);
			}
		}
		...
		private void attach_DBDBlocks(DBDBlock entity)
		{
			this.SendPropertyChanging();
			entity.DBBlock = this;
		}
		
		private void detach_DBDBlocks(DBDBlock entity)
		{
			this.SendPropertyChanging();
			entity.DBBlock = null;
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.DBDBlocks")]
	public partial class DBDBlock : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private int _dblockID;
		...
		private System.Data.Linq.Binary _dblockData;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OndblockIDChanging(int value);
    partial void OndblockIDChanged();
    partial void OnblockIDChanging(int value);
    partial void OnblockIDChanged();
    partial void OnaTagChanging(string value);
    partial void OnaTagChanged();
    partial void OnFileIDChanging(System.Guid value);
    partial void OnFileIDChanged();
    partial void OndblockDataChanging(System.Data.Linq.Binary value);
    partial void OndblockDataChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_dblockID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int dblockID
		{
			get
			{
				return this._dblockID;
			}
			set
			{
				if ((this._dblockID != value))
				{
					this.OndblockIDChanging(value);
					this.SendPropertyChanging();
					this._dblockID = value;
					this.SendPropertyChanged("dblockID");
					this.OndblockIDChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_aTag", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		public string aTag
		{
			get
			{
			...
			set
			{
				if ((this._aTag != value))
				{
					this.OnaTagChanging(value);
					this.SendPropertyChanging();
					this._aTag = value;
					this.SendPropertyChanged("aTag");
					this.OnaTagChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_dblockData", DbType="VarBinary(MAX) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		public System.Data.Linq.Binary dblockData
		{
			get
			{
				return this._dblockData;
			}
			set
			{
				if ((this._dblockData != value))
				{
					this.OndblockDataChanging(value);
					this.SendPropertyChanging();
					this._dblockData = value;
					this.SendPropertyChanged("dblockData");
					this.OndblockDataChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DBBlock_DBDBlock", Storage="_DBBlock", ThisKey="blockID", OtherKey="blockID", IsForeignKey=true)]
		public DBBlock DBBlock
		{
			get
			{
			...
			set
			{
							...
							|| (this._DBBlock.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._DBBlock.Entity = null;
						previousValue.DBDBlocks.Remove(this);
					}
					this._DBBlock.Entity = value;
					if ((value != null))
					{
						value.DBDBlocks.Add(this);
						this._blockID = value.blockID;
					}
					else
					{
