...
BeginPackage["SEDM4`EDMSuite`", "NETLink`","JLink`"];
...
(* ::Input::Initialization:: *)
Begin["`Private`"];
thisFileName=$InputFileName;


(* ::Input::Initialization:: *)
initialiseSharedCode[]:=Module[{},
ReinstallNET[];
LoadNETAssembly[DirectoryName[thisFileName]<>"Libraries\\SharedCode.dll"];
LoadNETAssembly[DirectoryName[thisFileName]<>"Libraries\\SirCachealot.exe"];
...
(* ::Input::Initialization:: *)
createBlockSerializer[]:=SEDM4`EDMSuite`$blockSerializer = NETNew["Data.EDM.BlockSerializer"];


(* ::Input::Initialization:: *)
createScanSerializer[]:=SEDM4`EDMSuite`$scanSerializer = NETNew["Data.Scans.ScanSerializer"];
...
SEDM4`EDMSuite`$sirCachealot =NETNew["SirCachealot.Controller"]
]
