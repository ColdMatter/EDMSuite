...
plateSpacing=1.2;
curveHalfWidthCurrent= 0.5362  (*1260 us 0.49265*);(*long machine 0.5362*)(*Short Machine 0.665*) (*should be half the idea DB step*);
...
magCal=16.8(*dblock@Config@Settings["magnetCalibration"]*);
...
gamma[dblock_]:=(curveHalfWidthCurrent-dblock@Config@GetModulationByName["B"]@PhysicalStep)/dblock@Config@GetModulationByName["DB"]@PhysicalStep;
...
correctedEDMNL[dblock_]:=
edmFactor[dblock](dblock@GetSpecialChannelValueAndError["EDMCORRDB","top"])[[1]]+edmSign[dblock]SEDM3`Blind`blindEDM;


correctedEDMErrNL[dblock_]:=
edmFactor[dblock](dblock@GetSpecialChannelValueAndError["EDMCORRDB","top"])[[2]];
...
"signedCorrectedEDMNL"->edmSign[dblock]correctedEDMNL[dblock],
"correctedEDMErrNL"->correctedEDMErrNL[dblock],
...
"E"->(getChannel[{"E"},"mag1",dbl]),
"B"->(getChannel[{"SIG"},"mag1",dbl]),
"EErr"->(getError[{"E"},"mag1",dbl]),
...
"rfCurrent"-> (dbl@GetChannelValueAndError[{"SIG"},"rfCurrent"]),
"rfCurrentE"-> (dbl@GetChannelValueAndError[{"E"},"rfCurrent"]),
...
"CORRDB"->(dbl@ChannelValues[6]@SpecialValues["CORRDB"]),
"RF1FDBNL"->(dbl@ChannelValues[6]@SpecialValues["RF1FDB"]),
"RF2FDBNL"->(dbl@ChannelValues[6]@SpecialValues["RF2FDB"]),
"RF1FDBDBNL"->(dbl@ChannelValues[6]@SpecialValues["RF1FDBDB"]),
"RF2FDBDBNL"->(dbl@ChannelValues[6]@SpecialValues["RF2FDBDB"]),
"ERF1FDBNL"->(dbl@ChannelValues[6]@SpecialValues["ERF1FDB"]),
"ERF2FDBNL"->(dbl@ChannelValues[6]@SpecialValues["ERF2FDB"]),
"ERF1FDBDBNL"->(dbl@ChannelValues[6]@SpecialValues["ERF1FDBDB"]),
"ERF2FDBDBNL"->(dbl@ChannelValues[6]@SpecialValues["ERF2FDBDB"]),
"BRF1FCORRDB"->(dbl@ChannelValues[6]@SpecialValues["BRF1FCORRDB"]),
"BRF2FCORRDB"->(dbl@ChannelValues[6]@SpecialValues["BRF2FCORRDB"])
}*) 


extractSummaryData[dbl_,abl_]:={
"E"->Check[(getChannel[{"E"},"magnetometer",dbl]),(getChannel[{"E"},"mag1",dbl])],
"Ex"->Check[(getChannel[{"E"},"magnetometer",dbl]),(getChannel[{"SIG"},"mag1",dbl])],
"Ey"->Check[(getChannel[{"E"},"battery",dbl]),(getChannel[{"SIG"},"mag1",dbl])],
"Ez"->Check[(getChannel[{"E"},"gnd",dbl]),(getChannel[{"SIG"},"mag1",dbl])],
"B"->Check[(getChannel[{"SIG"},"magnetometer",dbl]),(getChannel[{"SIG"},"mag1",dbl])],
"Bx"->Check[(getChannel[{"SIG"},"magnetometer",dbl]),(getChannel[{"SIG"},"mag1",dbl])],
"By"->Check[(getChannel[{"SIG"},"battery",dbl]),(getChannel[{"SIG"},"mag1",dbl])],
"Bz"->(getChannel[{"SIG"},"gnd",dbl]),
"Bsx"->(getChannel[{"B"},"magnetometer",dbl]),
"Bsy"->(getChannel[{"B"},"battery",dbl]),
"Bsz"->(getChannel[{"B"},"gnd",dbl]),
"BdBx"->(getChannel[{"B","DB"},"magnetometer",dbl]),
"BdBy"->(getChannel[{"B","DB"},"battery",dbl]),
"BdBz"->(getChannel[{"B","DB"},"gnd",dbl]),
...
"B\[Alpha]E"->(getChannel[{"B","E"},"top",dbl]),
"B\[Alpha]Etop"->(getChannel[{"B","E"},"top",dbl]),
"B\[Alpha]E\[Alpha]DB"->(getChannel[{"B","E","DB"},"top",dbl]),
"B\[Alpha]E\[Alpha]DBtop"->(getChannel[{"B","E","DB"},"top",dbl]),
"DB"->(getChannel[{"DB"},"top",dbl]),
...
"RF1F"->(getChannelAndError[{"RF1F"},"top",dbl]),
"RF2F"->(getChannelAndError[{"RF2F"},"top",dbl]),
"RF1A"->(getChannelAndError[{"RF1A"},"top",dbl]),
"RF2A"->(getChannelAndError[{"RF2A"},"top",dbl]),
"RF1FDB"->(getChannelAndError[{"RF1F","DB"},"top",dbl]),
"RF2FDB"->(getChannelAndError[{"RF2F","DB"},"top",dbl]),
"RF1FE"->(getChannelAndError[{"RF1F","E"},"top",dbl]),
"RF2FE"->(getChannelAndError[{"RF2F","E"},"top",dbl]),
"RF1AE"->(getChannelAndError[{"RF1A","E"},"top",dbl]),
"RF2AE"->(getChannelAndError[{"RF2A","E"},"top",dbl]),
"RF1AB"->(getChannelAndError[{"RF1A","B"},"top",dbl]),
"RF2AB"->(getChannelAndError[{"RF2A","B"},"top",dbl]),
"RF1FEDB"->(getChannelAndError[{"RF1F","E","DB"},"top",dbl]),
"RF2FEDB"->(getChannelAndError[{"RF2F","E","DB"},"top",dbl]),
"Bmol"->(getChannel[{"B"},"top",dbl]),
...
"E\[Alpha]DB"->(getChannel[{"E","DB"},"top",dbl]),
"E\[Alpha]DBtop"->(getChannel[{"E","DB"},"top",dbl]),
"B\[Alpha]DB"->(getError[{"B","DB"},"top",dbl]),
"E\[Alpha]B"->(getChannel[{"E","B"},"top",dbl]),
"E\[Alpha]B2"->(getChannel[{"B","E"},"top",dbl]),
...
"signedCorrectedEDMNL"->("signedCorrectedEDMNL"/.("analysisResults"/.abl)),
"correctedEDMErrNL"->("correctedEDMErrNL"/.("analysisResults"/.abl)),
"edmFactor"->edmFactor[dbl],
"Pi"->(getChannel[{"PI"},"top",dbl]),
"LF2"->(getChannel[{"LF2"},"top",dbl]),
"LF1"->(getChannel[{"LF1"},"top",dbl]),
"LF1Err"->(getError[{"LF1"},"top",dbl]),
"LF1B"->(getChannel[{"LF1","B"},"top",dbl]),
"LF1B"->(getChannel[{"LF1","E"},"top",dbl]),
"LF1Btop"->(getChannel[{"LF1","B"},"top",dbl]),
"LF2Err"->(getError[{"LF2"},"top",dbl]),
...
"LF2DB"->(getChannelAndError[{"LF2","DB"},"top",dbl]),
...
"BDBNL"->dbl@GetSpecialChannelValueAndError["BDB","top"],
"CORRDB"->dbl@GetSpecialChannelValueAndError["CORRDB","top"],
"choCorrection"->dbl@GetSpecialChannelValueAndError["CORRDB_OLD","top"],
"RF1FDBNL"->dbl@GetSpecialChannelValueAndError["RF1FDB","top"],
"RF2FDBNL"->dbl@GetSpecialChannelValueAndError["RF2FDB","top"],
"RF1FDBDBNL"->dbl@GetSpecialChannelValueAndError["RF1FDBDB","top"],
"RF2FDBDBNL"->dbl@GetSpecialChannelValueAndError["RF2FDBDB","top"],
"ERF1FDBNL"->dbl@GetSpecialChannelValueAndError["ERF1FDB","top"],
"ERF2FDBNL"->dbl@GetSpecialChannelValueAndError["ERF2FDB","top"],
"ERF1FDBDBNL"->dbl@GetSpecialChannelValueAndError["ERF1FDBDB","top"],
"ERF2FDBDBNL"->dbl@GetSpecialChannelValueAndError["ERF2FDBDB","top"],
"BRF1FCORRDB"->dbl@GetSpecialChannelValueAndError["BRF1FCORRDB","top"],
"BRF2FCORRDB"->dbl@GetSpecialChannelValueAndError["BRF2FCORRDB","top"],
"LF2DBDBNL"->dbl@GetSpecialChannelValueAndError["LF2DBDB","top"],
(*"LF2DBDBNL"->(dbl@ChannelValues[0]@SpecialValues["LF2DBDB"])*)
