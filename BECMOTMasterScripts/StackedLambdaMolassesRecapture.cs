 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["LambdaMolassesHoldDuration"] = 500;
        ...
        Parameters["MOTRecaptureStartDelay"] = 500;
        ...
        Parameters["V00R1plusAOMAmpMOTRecapture"] = 0.75;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int motRecaptureStart = lambdaMolassesStop + (int)Parameters["MOTRecaptureStartDelay"];
