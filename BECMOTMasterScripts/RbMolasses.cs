 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["RbPushBeamDuration"] = 90000;
        ...
        Parameters["XShimCoilsMOTValue"] = -2.0; // -6.0 for CMOT
        Parameters["YShimCoilsMOTValue"] = -2.0; // -4.0 for CMOT
        ...
        Parameters["RbCMOTVCAAmp"] = 3.0; // 1.75 for CMOT
        Parameters["RbCMOTBField"] = 1.9; // 6.0 for CMOT
        Parameters["XShimCoilsCMOTValue"] = -2.0; // -6.0 for CMOT
        Parameters["YShimCoilsCMOTValue"] = -2.0; // -4.0 for CMOT
        ...
        Parameters["XShimCoilsMolassesValue"] = -2.0; // -6.0 for CMOT
        Parameters["YShimCoilsMolassesValue"] = -2.0; // -4.0 for CMOT
        ...
        Parameters["BackgroundImageTime"] = 170000; // half the pattern length
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        // int Rb3DMOTCameraStart = Rb3DMOTStart - (int)Parameters["CameraExposureDelay"];
