 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["V00R1plusAOMAmpMOTCompression"] = 0.69;
        Parameters["MOTCompressionFieldValue"] = 6.0;

        // Molasses
        Parameters["MolassesONorOFF"] = 10.0;
        Parameters["BlueMolassesRampDuration"] = 0;
        Parameters["BlueMolassesHoldDuration"] = 300;
        Parameters["V00R0AOMVCOFreqBlueMolasses"] = 4.4;
        Parameters["V00R0AOMVCOAmpBlueMolasses"] = 0.30;
        Parameters["V00R1plusAOMAmpBlueMolasses"] = 0.8;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int blueMolassesRampStart = motCompressionStop + (int)Parameters["MOTFieldDecayDuration"];
        int blueMolassesStart = blueMolassesRampStart + (int)Parameters["BlueMolassesRampDuration"];
        int blueMolassesStop = blueMolassesStart + (int)Parameters["BlueMolassesHoldDuration"];
        int imagingLightStart = blueMolassesStop + (int)Parameters["CameraTriggerStartDelay"];
        ...
        p.Pulse(
            patternStartBeforeQ,
            blueMolassesRampStart,
            blueMolassesStop - blueMolassesRampStart,
            "V00R0AOM"
        );
        p.Pulse(
            patternStartBeforeQ,
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        if ((double)Parameters["MolassesONorOFF"] > 5.0)
        {
            p.AddAnalogValue(
                "V00R0AOMVCOFreq",
                motCompressionStop,
                (double)Parameters["V00R0AOMVCOFreqBlueMolasses"]
            );
            p.AddAnalogValue(
                "V00R0AOMVCOAmp",
                motCompressionStop,
                (double)Parameters["V00R0AOMVCOAmpBlueMolasses"]
            );
            p.AddAnalogValue(
                "V00R1plusAOMAmp",
                motCompressionStop,
                (double)Parameters["V00R1plusAOMAmpBlueMolasses"]
            );
            p.AddAnalogValue(
                "ShimCoilX",
                motCompressionStop,
