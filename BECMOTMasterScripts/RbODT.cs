 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["PatternLength"] = 1200000;
        ...
        Parameters["RbPushBeamDuration"] = 75000;
        ...
        Parameters["XShimCoilsMOTValue"] = -2.0;
        ...
        Parameters["RbCMOTBField"] = 1.9; // 2.0 
        Parameters["XShimCoilsCMOTValue"] = -2.0; // -2.0 for no CMOT
        Parameters["YShimCoilsCMOTValue"] = -2.0; // -2.0 for no CMOT
        ...
        Parameters["XShimCoilsMolassesValue"] = -2.0;
        Parameters["YShimCoilsMolassesValue"] = -2.0;
        ...
        Parameters["ODTDuration"] = 40000; // heating and non-heating part
        ...
        Parameters["ODTHeatingCycles"] = 400; 
        Parameters["ODTHeatingFrequency"] = 4000.0; // Hz
        Parameters["ODTHeatingAmp"] = 0.05; // fraction of max power
        Parameters["ODTHeatingOffset"] = 0.90; // fraction of max power
        ...
        Parameters["CameraTriggerStartDelay"] = 980000; // 12000;
        Parameters["NormalisationTriggerStartDelay"] = 10000;
        Parameters["CameraTriggerDuration"] = 50;
        Parameters["BackgroundImageTime"] = 1190000; 
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int imagingLightStart = RbMolassesStop + (int)Parameters["CameraTriggerStartDelay"];
        int CameraStart = RbMolassesStop + (int)Parameters["CameraTriggerStartDelay"] - (int)Parameters["CameraExposureDelay"];
        ...
        if ((double)Parameters["ODTONorOFF"] > 5.0)
        {
            ...
            p.Pulse(
                patternStartBeforeQ,
                (int)Parameters["BackgroundImageTime"] - 100,
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        if ((double)Parameters["ParametricHeatingONorOFF"] > 5.0)
        {
            ...
            for (int i = 0; i < steps - 1; i++)
            {
                ...
                double voltage = a * Math.Sqrt(Math.Abs(value - b)) + c;
