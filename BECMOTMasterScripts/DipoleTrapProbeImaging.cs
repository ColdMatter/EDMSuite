 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["MOTCompressionDuration"] = 0;
        ...
        Parameters["MOTCompressionFieldValue"] = 3.0;
        ...
        Parameters["CameraTriggerStartDelay"] = 200;
        ...
        Parameters["shutterONorOFF"] = 10.0;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int cameraStart = motCompressionStop + (int)Parameters["CameraTriggerStartDelay"];
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        if ((double)Parameters["slowingONorOFF"] > 5.0)
        {
            ...
            p.AddLinearRamp(
                "BXChirp",
                slowingChirpStop + 100,
                500,
                ((double)Parameters["SlowingChirpMHzSpan"] - 100.0) / (double)Parameters["SlowingMHzPerVolt"]
            );
            p.AddLinearRamp(
                "BXChirp",
