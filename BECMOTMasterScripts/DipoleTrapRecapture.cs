 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["DipoleTrapLoadingDuration"] = 10000;
        Parameters["DipoleTrapHoldingDuration"] = 10000;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int dipoleTrapStart = blueMOTSecondStop + (int)Parameters["DipoleTrapLoadingDuration"];
        int dipoleTrapStop = dipoleTrapStart + (int)Parameters["DipoleTrapHoldingDuration"];
        int cameraStart = dipoleTrapStop + (int)Parameters["CameraTriggerStartDelay"];
        int cameraStop = cameraStart + (int)Parameters["CameraTriggerDuration"] + 1000;
        ...
        p.Pulse(
            patternStartBeforeQ,
            lambdaMolassesStart,
            dipoleTrapStart - lambdaMolassesStart,
            "V00B2AOM"
        );
        ...
        p.Pulse(
            patternStartBeforeQ,
            blueMOTSecondStop,
            dipoleTrapStart - blueMOTSecondStop,
            "V00B1minusAOM"
        );
        ...
        if ((double)Parameters["dipoleONorOFF"] > 5.0)
        {
            p.Pulse(
                patternStartBeforeQ,
                lambdaMolassesStart,
                dipoleTrapStop - lambdaMolassesStart,
                "DipoleTrapAOM"
            );
        }
