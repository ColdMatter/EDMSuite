 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["BXAOMChirpDuration"] = 500;
        ...
        // Molasses (Dummy, not used actually inside)
        Parameters["MolassesONorOFF"] = 10.0;
        Parameters["LambdaMolassesHoldDuration"] = 1;
        ...
        Parameters["deltaDetuning"] = 0.0;

        // Blue MOT (Dummy, not used actually inside)
        ...
        Parameters["V00R1plusAOMAmpBlueMOT"] = 1.0;
        ...
        Parameters["CameraTriggerStartDelay"] = 450;
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        if ((double)Parameters["MOTONorOFF"] > 5.0)
        {
            ...
            // EOM MOT sidebands only while optical pumping is set up
            p.AddAnalogValue(
               "V00B2AOMAmp",
               0,
               0.53
