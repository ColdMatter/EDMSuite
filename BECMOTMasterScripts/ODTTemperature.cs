 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["ODTOnlyDuration"] = 20000; // 15000; // after blue MOT stop
        ...
        // imaging
        Parameters["CameraTriggerStartDelay"] = 1000; // imaging
        Parameters["CameraTriggerDuration"] = 500; // blue imaging at the moment
