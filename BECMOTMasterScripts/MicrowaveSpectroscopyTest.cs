 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["MOTCompressionDuration"] = 900;              //////////////////
        ...
        Parameters["OpticalPumpingDuration"] = 30;
        ...
        Parameters["MOTCameraTriggerStartDelay"] = 0;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse(
            ...
            motCompressionStop + 80 + (int)Parameters["OpticalPumpingDuration"],
            "V00R0AOM"
        );
        ...
        p.Pulse(
            patternStartBeforeQ,
            MicrowavesStop,
            (int)Parameters["CameraTriggerStartDelay"] + (int)Parameters["CameraTriggerDuration"],   ///////////
            "V00R0AOM"
        );
        ...
        p.Pulse(
             patternStartBeforeQ,
             2500 - (int)Parameters["CameraExposureDelay"] + (int)Parameters["MOTCameraTriggerStartDelay"],
             (int)Parameters["CameraTriggerDuration"],
             "cameraTrigger"
        );
