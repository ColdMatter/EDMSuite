 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["V00R1plusAOMAmpMOTLoading"] = 0.70;
        ...
        Parameters["MOTCompressionFieldValue"] = 7.0;
        Parameters["XShimCoilsCMOTValue"] = -1.0;
        Parameters["YShimCoilsCMOTValue"] = -6.0;
        ...
        Parameters["BlueMOTFirstRampDuration"] = 600;
        Parameters["BlueMOTFirstFieldValue"] = -2.0;
        Parameters["BlueMOTSecondRampDuration"] = 600;
        Parameters["BlueMOTSecondFieldValue"] = -2.0;
        ...
        Parameters["MOTRecaptureStartDelay"] = 1;
        Parameters["MOTRecaptureDuration"] = 200;
        Parameters["MOTRecaptureFieldValue"] = 6.0;
        Parameters["V00R0AOMVCOFreqMOTRecapture"] = 3.1;
        Parameters["V00R0AOMVCOAmpMOTRecapture"] = 0.34;
        Parameters["V00R1plusAOMAmpMOTRecapture"] = 0.73;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int motRecaptureStart = blueMOTStop + (int)Parameters["MOTRecaptureStartDelay"];
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        if ((double)Parameters["MOTRecaptureONorOFF"] > 5.0)
        {
            ...
            p.AddAnalogValue(
                "motCoils",
                motRecaptureStart,
                (double)Parameters["MOTRecaptureFieldValue"]
            );
            p.AddAnalogValue(
                "motCoils",
                cameraStop,
