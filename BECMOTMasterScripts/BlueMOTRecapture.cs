 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["BlueMOTRampDuration"] = 600;
        Parameters["BlueMOTDuration"] = 500;
        Parameters["RedMOTRecaptureDelay"] = 200;
        ...
        Parameters["BlueMOTCoilsOnValue"] = -4.0;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int blueMOTStop = lambdaMolassesStop + (int)Parameters["BlueMOTRampDuration"] + (int)Parameters["BlueMOTDuration"];
        int recaptureStart = blueMOTStop + (int)Parameters["RedMOTRecaptureDelay"];
        int cameraStart = recaptureStart + (int)Parameters["CameraTriggerStartDelay"];
        ...
        p.Pulse(
            patternStartBeforeQ,
            lambdaMolassesStart,
            blueMOTStop - lambdaMolassesStart,
            "V00B2AOM"
        );
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddLinearRamp(
            "motCoils",
            lambdaMolassesStop,
            (int)Parameters["BlueMOTRampDuration"],
            (double)Parameters["BlueMOTCoilsOnValue"]
        );
        p.AddAnalogValue(
           "motCoils",
           blueMOTStop,
