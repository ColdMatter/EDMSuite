 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["YShimCoilsMOTValue"] = -6.0;
        Parameters["ZShimCoilsMOTValue"] = 2.0;
        ...
        Parameters["ZShimCoilsCMOTValue"] = 2.0;
        ...
        Parameters["YShimCoilsLambdaMolassesValue"] = -6.0;
        Parameters["ZShimCoilsLambdaMolassesValue"] = 2.0;
        Parameters["deltaDetuning"] = 0.0; //dummy
        Parameters["molassesPower"] = 0.0; //dummy
        Parameters["externalShimCoilValue"] = 0.0; //dummy

        // Imaging
        Parameters["CloudImageONorOFF"] = 10.0;
        Parameters["BackgroundImageONorOFF"] = 10.0;
        Parameters["CameraTriggerStartDelay"] = 1200;
        ...
        Parameters["YShimCoilsOffValue"] = -6.0;
        Parameters["ZShimCoilsOffValue"] = 2.0;
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        if ((double)Parameters["CMOTONorOFF"] > 5.0)
        {
            ...
            p.AddLinearRamp(
                "motCoils",
                motCompressionStop + 10,
                200,
                -0.5
            );
            p.AddLinearRamp(
                "motCoils",
                motCompressionStop + 210,
                200,
                (double)Parameters["MOTCoilsOffValue"]
            );
        }
