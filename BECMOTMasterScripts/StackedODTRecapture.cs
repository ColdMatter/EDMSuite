 ...
 * */
{
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        if ((double)Parameters["BackgroundImageONorOFF"] > 5.0)
        {
            ...
            p.Pulse(
                patternStartBeforeQ,
                (int)Parameters["BackgroundImageTime"]-1000,
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        if ((double)Parameters["BlueMOTONorOFF"] > 5.0)
        {
            p.AddLinearRamp(
                "ShimCoilX",
                lambdaMolassesStop,
                (int)Parameters["BlueMOTFirstRampDuration"] + (int)Parameters["BlueMOTSecondRampDuration"],
