...
/*
 * This script is designed to create the quadrupole trap
 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["QuadrupoleTrapRampDuration"] = 100;
        Parameters["QuadrupoleTrapDuration"] = 300;
        ...
        Parameters["V00R0AOMVCOAmpMOTLoading"] = 0.3;
        Parameters["V00R0AOMVCOAmpMOTRetaining"] = 0.35;
        ...
        Parameters["V00R1plusAOMAmpMOTCompression"] = 0.7;
        ...
        Parameters["QuadrupoleTrapOnValue"] = 6.0;
        ...
        Parameters["XShimCoilsQuadrupoleTrapValue"] = 0.0;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int quadrupoleTrapStop = lambdaMolassesStop + (int)Parameters["QuadrupoleTrapRampDuration"] + (int)Parameters["QuadrupoleTrapDuration"];
        int cameraStop = quadrupoleTrapStop + (int)Parameters["CameraTriggerStartDelay"] + (int)Parameters["CameraTriggerDuration"];
        ...
        p.Pulse(
            patternStartBeforeQ,
            quadrupoleTrapStop + (int)Parameters["CameraTriggerStartDelay"],
        ...
        p.Pulse(
            patternStartBeforeQ,
            lambdaMolassesStart,
            (int)Parameters["LambdaMolassesDuration"],
            "V00B2AOM"
        );
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddLinearRamp(
            "motCoils",
            lambdaMolassesStop,
            (int)Parameters["QuadrupoleTrapRampDuration"],
            (double)Parameters["QuadrupoleTrapOnValue"]
        );
        p.AddAnalogValue(
           "motCoils",
           quadrupoleTrapStop,
        ...
        p.AddAnalogValue(
            "ShimCoilX",
            lambdaMolassesStop,
            (double)Parameters["XShimCoilsQuadrupoleTrapValue"]
        );
        p.AddAnalogValue(
            "ShimCoilX",
            cameraStop,
