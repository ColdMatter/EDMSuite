...
def EDMGo():
	...
	while blockIndex < maxBlockIndex:
		...
		rf1adbdbValue = [normedpmtChannelValues.GetSpecialValue("RF1ADBDB"), normedpmtChannelValues.GetSpecialError("RF1ADBDB")]
		pumpVValue = hc.PumpAOMFrequencyCentre

		lf2dbdbValueList.append(rf1adbdbValue)
		print "rf1adbdb Values: " + str(lf2dbdbValueList).strip('[]')
