...
def updateLocksNL(bState, blockIndex):
	pmtChannelValues = bh.DBlock.ChannelValues[0]
	...
	print "probe AOM Frequency: " + str(hc.I2LockAOMFrequencyCentre) + " MHz"
	print "probe AOM Frequency: " + str(hc.PumpAOMFrequencyCentre) + " MHz"
	print "pump + probe AOM Frequency: " + str(hc.I2LockAOMFrequencyCentre + hc.PumpAOMFrequencyCentre) + " MHz"
	# print "Total Frequency scanned: " + str(-deltaLF1) + " MHz" 
...
def EDMGo():
	...
	while blockIndex < maxBlockIndex:
		...
		normedpmtChannelValues = bh.DBlock.ChannelValues[6]
		lf1dbdbValue = normedpmtChannelValues.GetSpecialValue("LF1DBDB")
		I2VValue = hc.FLPZTVoltage

		lf1dbdbValueList.append(lf1dbdbValue)
		print "lf1dbdb Values: " + str(lf1dbdbValueList).strip('[]')
		
		I2VValueList.append(I2VValue)
		print "I2 Voltage Values: " + str(I2VValueList).strip('[]')

		updateLocksNL(bState, blockIndex)
		# randomise Ramsey phase
		scramblerV = 0.799718 * r.NextDouble()
		hc.SetScramblerVoltage(scramblerV)
		# randomise polarizations
