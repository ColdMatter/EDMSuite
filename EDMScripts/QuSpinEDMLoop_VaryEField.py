...
def measureParametersAndMakeBC(cluster, eState, bState, rfState, mwState, scramblerV, eFastFlag):
	...
	if eFastFlag:
		eWave = bc.GetModulationByName("EFast").Waveform
	else:
		eWave = bc.GetModulationByName("ESlow").Waveform
	eWave.Name = "E"
	...
	# change e-switch parameters depending on speed of switch
	if eFastFlag:
		hc.SetERampDownTime(0.0)
		hc.SetERampDownDelay(0.05)
		hc.SetEBleedTime(0.05)
		hc.SetESwitchTime(0.05)
		hc.SetERampUpTime(0.0)
		hc.SetERampUpDelay(1.0)
		hc.SetEOvershootHold(2.5)
	else:
		hc.SetERampDownTime(0.0)
		hc.SetERampDownDelay(1.0)
		hc.SetEBleedTime(1.0)
		hc.SetESwitchTime(1.0)
		hc.SetERampUpTime(0.0)
		hc.SetERampUpDelay(2.0)
		hc.SetEOvershootHold(5.0)
	...
	bc.Settings["eOvershootHold"] = hc.EOvershootHold
