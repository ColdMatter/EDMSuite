...
public class Patterns : MOTMasterScript
{
    public Patterns()
    {
        ...
        this.switchConfiguration = new Dictionary<string, List<object>>
            {
                {"SlowerSwitch", new List<object>{true, true, false, false } },
                {"ShutterSwitch", new List<object>{true, false, true, false } }
            };

        this.switchConfiguration = new Dictionary<string, List<object>>
            {
                {"SlowerSwitch", new List<object>{true, false} },
                {"ShutterSwitch", new List<object>{true, true} }
            };


        //this.switchConfiguration = new Dictionary<string, List<object>>
        //    {
        //        {"SlowerSwitch", new List<object>{true, true} },
        //        {"ShutterSwitch", new List<object>{true, false} }
        //    };

        //this.switchConfiguration = new Dictionary<string, List<object>>
        //    {
        //        {"SlowerSwitch", new List<object>{true} },
        //        {"ShutterSwitch", new List<object>{true} }
        //    };
    }
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.AddEdge("q", 10 + shutterDelay, false);
        ...
        if ((bool)Parameters["ShutterSwitch"])
        {
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("AOM1_VCA", shutterDelay + pumpDelay, 0);
