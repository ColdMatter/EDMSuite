...
public class Patterns : MOTMasterScript
{
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int pumpWidth = Convert.ToInt32(Parameters["AOMWidth"]);
        ...
        p.AddEdge("VECSEL2_Shutter", Convert.ToInt32(Parameters["PatternLength"]) - 1, false);

        p.AddEdge("He_Shutter", 0, true);
        p.AddEdge("He_Shutter", pumpWidth, false);
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("AOM1_VCA", 0, 10);
        p.AddAnalogValue("AOM1_VCA", pumpWidth, 0);

        p.AddAnalogValue("AOM2_VCA", 0, 10);
