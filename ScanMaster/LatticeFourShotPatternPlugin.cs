...
namespace ScanMaster.Acquire.Plugins
{
	...
	/// </summary>
	[Serializable]
	public class LatticeFourShotPatternPlugin : SupersonicPGPluginBase
	{
		[NonSerialized]
		private LatticeFourShotPatternBuilder scanPatternBuilder;
		...
		{
			scanPatternBuilder = new LatticeFourShotPatternBuilder();
		}
