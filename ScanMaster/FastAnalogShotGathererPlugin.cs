...
{
	/// <summary>
	/// A plugin to capture time of flight data by sampling an analog input by Retriggering an existing task. 
    /// This is faster than the AnalogShotGathererPlugin.
    /// It can't be used in combination with other analogue acquisitions.
	/// </summary>
	[Serializable]
	public class FastAnalogShotGathererPlugin : ShotGathererPlugin
	{
