...
namespace ScanMaster.Acquire.Plugins
{
	...
	/// </summary>
	[Serializable]
	public class LatticeBFieldFourShotPatternPlugin : SupersonicPGPluginBase
	{
		[NonSerialized]
		private LatticeBFieldFourShotBuilder scanPatternBuilder;
		...
		protected override void InitialiseCustomSettings()
		{
			...
			settings["bfieldDelay"] = 10000;
			settings["bfieldDuration"] = 10000;
		}

		protected override void DoAcquisitionStarting()
		{
			scanPatternBuilder = new LatticeBFieldFourShotBuilder();
		}
		...
		protected override IPatternSource GetScanPattern()
		{
			...
			int time = scanPatternBuilder.ShotSequence(
				...
				(int)settings["bfieldDelay"],
				(int)settings["bfieldDuration"]);
			/*
