...
namespace ScanMaster.Acquire.Plugins
{
	...
	/// </summary>
	[Serializable]
	public class FastCountingShotGathererPlugin : ShotGathererPlugin
	{
		[NonSerialized]
		...
		public override void AcquisitionStarting()
		{
			...
			countingTask.Timing.ConfigureSampleClock(
                ...
                ((int)settings["gateLength"] + 1) * (int)settings["pointsPerScan"]);

			countingTask.Control(TaskAction.Verify);

            //countStream = new DaqStream(countingTask);
            //countingTask.Stream.Buffer.InputBufferSize = ((int)settings["gateLength"] + 1) * (int)settings["pointsPerScan"];
		...
		public override void ScanStarting()
		{
            ...
            //I have to manually change the state of the switch plugin if this is the first shot
            //this is because Acquisitor executes things in the wrong order this is why switch plugins
            //don't work.
