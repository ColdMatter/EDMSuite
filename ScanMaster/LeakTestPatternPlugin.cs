...
namespace ScanMaster.Acquire.Plugins
{
    ...
    /// </summary>
    [Serializable]
    public class LeakTestPatternPlugin : SupersonicPGPluginBase
    {
        [NonSerialized]
        private LeakTestPatternBuilder scanPatternBuilder;
        ...
        {
            scanPatternBuilder = new LeakTestPatternBuilder();
        }
