...
namespace ScanMaster.Acquire.Plugins
{
	...
	/// </summary>
	[Serializable]
	public class ClassicBasicBeamPatternPlugin : SupersonicPGPluginBase
	{
		[NonSerialized]
		private ClassicBasicBeamPatternBuilder scanPatternBuilder;
		...
		protected override void InitialiseCustomSettings()
		{
			...
			settings["shutterDelay"] = 11600;
			settings["shutterDuration"] = 20000;
			settings["shutter"] = "v0Shutter1";
		}

		protected override void DoAcquisitionStarting()
		{
            scanPatternBuilder = new ClassicBasicBeamPatternBuilder();
		}
		...
		protected override IPatternSource GetScanPattern()
		{
			...
			int time = scanPatternBuilder.ShotSequence(
				...
				(int)settings["valve"],
				(int)settings["shutterDelay"],
				(int)settings["shutterDuration"],
				(string)settings["shutter"]
				);
