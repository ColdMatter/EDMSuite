            ...
            int ttlSwitchPort, int ttlSwitchLine, int switchLineDuration, int switchLineDelay, bool modulation)
        {
            ...
            for (int i = 0; i < numberOfOnOffShots; i++)
            {
                ...
                Shot(time, valvePulseLength, valveToQ, flashToQ, flashlampPulseLength, delayToDetectorTrigger, "detector");
                    ...
                    if (i < 3)
                    {
                        AddEdge(((DigitalOutputChannel)Environs.Hardware.DigitalOutputChannels["shutter1"]).BitNumber, time + switchLineDelay, true);
                        AddEdge(((DigitalOutputChannel)Environs.Hardware.DigitalOutputChannels["shutter1"]).BitNumber, time + 2 * flashlampPulseInterval +switchLineDelay- 1000, false);
                        AddEdge(((DigitalOutputChannel)Environs.Hardware.DigitalOutputChannels["aom"]).BitNumber, time + valveToQ + 0 * flashlampPulseInterval + ccd1Start1, true);
                        AddEdge(((DigitalOutputChannel)Environs.Hardware.DigitalOutputChannels["aom"]).BitNumber, time + valveToQ + 0 * flashlampPulseInterval + ccd1Start1 + 5000, false);
                        AddEdge(((DigitalOutputChannel)Environs.Hardware.DigitalOutputChannels["aom"]).BitNumber, time + valveToQ + 0 * flashlampPulseInterval + ccd1Start2, true);
                        AddEdge(((DigitalOutputChannel)Environs.Hardware.DigitalOutputChannels["aom"]).BitNumber, time + valveToQ + 0 * flashlampPulseInterval + ccd1Start2 + 5000, false);
                        AddEdge(((DigitalOutputChannel)Environs.Hardware.DigitalOutputChannels["aom"]).BitNumber, time + valveToQ + 1 * flashlampPulseInterval + ccd1Start1, true);
                        AddEdge(((DigitalOutputChannel)Environs.Hardware.DigitalOutputChannels["aom"]).BitNumber, time + valveToQ + 1 * flashlampPulseInterval + ccd1Start1 + 5000, false);
                        AddEdge(((DigitalOutputChannel)Environs.Hardware.DigitalOutputChannels["aom"]).BitNumber, time + valveToQ + 1 * flashlampPulseInterval + ccd1Start2, true);
                        AddEdge(((DigitalOutputChannel)Environs.Hardware.DigitalOutputChannels["aom"]).BitNumber, time + valveToQ + 1 * flashlampPulseInterval + ccd1Start2 + 5000, false);                      
                    }
                    else
                    {
                        AddEdge(((DigitalOutputChannel)Environs.Hardware.DigitalOutputChannels["aom2"]).BitNumber, time + valveToQ + 0 * flashlampPulseInterval + ccd2Start1, true);
                        AddEdge(((DigitalOutputChannel)Environs.Hardware.DigitalOutputChannels["aom2"]).BitNumber, time + valveToQ + 0 * flashlampPulseInterval + ccd2Start1 + 5000, false);
                        AddEdge(((DigitalOutputChannel)Environs.Hardware.DigitalOutputChannels["aom2"]).BitNumber, time + valveToQ + 0 * flashlampPulseInterval + ccd2Start2, true);
                        AddEdge(((DigitalOutputChannel)Environs.Hardware.DigitalOutputChannels["aom2"]).BitNumber, time + valveToQ + 0 * flashlampPulseInterval + ccd2Start2 + 5000, false);
                        AddEdge(((DigitalOutputChannel)Environs.Hardware.DigitalOutputChannels["aom2"]).BitNumber, time + valveToQ + 1 * flashlampPulseInterval + ccd2Start1, true);
                        AddEdge(((DigitalOutputChannel)Environs.Hardware.DigitalOutputChannels["aom2"]).BitNumber, time + valveToQ + 1 * flashlampPulseInterval + ccd2Start1 + 5000, false);
                        AddEdge(((DigitalOutputChannel)Environs.Hardware.DigitalOutputChannels["aom2"]).BitNumber, time + valveToQ + 1 * flashlampPulseInterval + ccd2Start2, true);
                        AddEdge(((DigitalOutputChannel)Environs.Hardware.DigitalOutputChannels["aom2"]).BitNumber, time + valveToQ + 1 * flashlampPulseInterval + ccd2Start2 + 5000, false);
