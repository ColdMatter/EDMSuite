...
namespace ScanMaster.Acquire.Plugins
{
	...
	/// </summary>
	[Serializable]
    public class SuperPumpingPulsedRFDoubleSwitchScanPatternPlugin : SupersonicPGPluginBase
	{

		[NonSerialized]
        private SuperPumpingPulsedRFDoubleSwitchScanPatternBuilder scanPatternBuilder;
		...
		{
            scanPatternBuilder = new SuperPumpingPulsedRFDoubleSwitchScanPatternBuilder();
		}
