...
namespace ScanMaster.Acquire.Plugins
{
	...
	/// </summary>
	[Serializable]
	public class BasicBeamTwoYAGPatternPlugin : SupersonicPGPluginBase
	{
		[NonSerialized]
		private BasicBeamTwoYAGPatternBuilder scanPatternBuilder;
		...
		{
            scanPatternBuilder = new BasicBeamTwoYAGPatternBuilder();
		}
