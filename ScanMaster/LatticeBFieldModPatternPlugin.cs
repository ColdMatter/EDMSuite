...
namespace ScanMaster.Acquire.Plugins
{
	...
	/// </summary>
	[Serializable]
	public class LatticeBFieldModPatternPlugin : SupersonicPGPluginBase
	{
		[NonSerialized]
		private LatticeBFieldModPatternBuilder scanPatternBuilder;
		...
		{
			scanPatternBuilder = new LatticeBFieldModPatternBuilder();
		}
