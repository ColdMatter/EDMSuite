...
namespace ScanMaster.Acquire.Plugins
{
    ...
    /// </summary>
    [Serializable]
    public class LeakTestPatternPluginModified : SupersonicPGPluginBase
    {
        [NonSerialized]
        private LeakTestPatternBuilderModified scanPatternBuilder;
        ...
        {
            scanPatternBuilder = new LeakTestPatternBuilderModified();
        }
