...
{
	/// <summary>
	/// This is basically the same as BasicBeam only I've attempted to add the flow controller as a variable
	/// in the pattern generator
	/// </summary>
	public class BasicBeamFlowPatternBuilder : DAQ.Pattern.PatternBuilder32
	{
		public BasicBeamFlowPatternBuilder()
		{
		}
