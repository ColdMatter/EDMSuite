...
namespace ScanMaster.Acquire.Plugin
{
	...
	XmlInclude(typeof(ModulatedAnalogShotGathererPlugin)), XmlInclude(typeof(BufferedEventCountingShotGathererPlugin)), XmlInclude(typeof(AnalogCameraShotGathererPlugin))]
