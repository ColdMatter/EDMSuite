...
namespace ScanMaster.Acquire.Plugin
{
    ...
    XmlInclude(typeof(ImageGrabbingAnalogShotGathererPlugin)), XmlInclude(typeof(ModulatedFourAnalogShotGathererPlugin)), XmlInclude(typeof(ModulatedFourHybridShotGathererPlugin)),
		XmlInclude(typeof(BufferedEventCountingTwoShotGathererPlugin))]
