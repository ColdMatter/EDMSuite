...
namespace LatticeEDMHardwareControl
{
    public partial class WarmUpModeOptionsDialog : Form
    {
        ...
        {
            // General constants
            TurbomolecularPumpUpperPressureLimitInitialTextValue = LatticeEDMController.SourceWarmUpConstants.TurbomolecularPumpUpperPressureLimit.ToString("E3");

            // Desorbing process
            GasEvaporationCycleTemperatureMaxInitialTextValue = LatticeEDMController.SourceWarmUpConstants.GasEvaporationCycleTemperatureMax.ToString("E3");
            DesorbingPTPollPeriodInitialTextValue = LatticeEDMController.SourceWarmUpConstants.DesorbingPTPollPeriod.ToString();

            // Warmup
            CryoStoppingPressureInitialTextValue = LatticeEDMController.SourceWarmUpConstants.CryoStoppingPressure.ToString("E3");
            WarmupPTPollPeriodInitialTextValue = LatticeEDMController.SourceWarmUpConstants.WarmupPTPollPeriod.ToString();

            // Wait at target temperature
            SourceModeWaitPTPollPeriodInitialTextValue = LatticeEDMController.SourceWarmUpConstants.SourceModeWaitPTPollPeriod.ToString();

            // Other parameters
            PTPollPeriodMinimum = LatticeEDMController.SourceWarmUpConstants.PTPollPeriodMinimum;
