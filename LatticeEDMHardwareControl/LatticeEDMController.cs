...
{
    public class LatticeEDMController : MarshalByRefObject
    {
        /// <summary>
        ...
        LatticeEDMHardwareControllerAIs hardwareControllerAIs = new LatticeEDMHardwareControllerAIs(AINames, AIChannelNames);
        ...
        public static class SourceRefreshConstants
        {
            ...
            public static Int32 PTPollPeriodMinimum = LatticeEDMController.PTMonitorPollPeriodLowerLimit;      // ms
        ...
        internal void StopAnalogueInputsMonitorPoll()
        {
            ...
            LatticeEDMSavePlotDataDialog saveAIDataDialog = new LatticeEDMSavePlotDataDialog("Save data message", "Would you like to save the analogue inputs data now? \n\nThe data will not be cleared.");
        ...
        private void IMonitorPollWorker()
        {
            for (; ; )
            {
                ...
                lock (iMonitorLock)
                {
                    ...
                    if (window.logCurrentDataCheckBox.Checked)
                    {
                        //string folder = @" C:\Users\Rhys\Documents\Imperial Postdoc\EDMSuite test data\";
