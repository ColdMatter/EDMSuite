 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["tRbRedMolassesLoadStart"] = 0;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.AddEdge("tTweezerSwitch", RedMolassesStart + (int)Parameters["tRbRedMolassesLoadStart"], false); // Turn ON tweezer switch at start of molasses loading
