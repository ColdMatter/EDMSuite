 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["tImgCool"] = 1.5; // 3.6 - 4.0, resonance is 4.0
        ...
        Parameters["tPumpVCO"] = 2.0;
        Parameters["tPumpVVA"] = 3.5;
        ...
        Parameters["TOF1"] = 1000;
        // Image 1
        Parameters["tBiasShimRampDuration"] = 100; // should be less than TOF2
        Parameters["TOF2"] = 5000;
        Parameters["PumpPulseDuration"] = 10;
        Parameters["RePumpPulseDuration"] = 10;
