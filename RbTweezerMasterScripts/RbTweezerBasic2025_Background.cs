 ...
 * */
{
    public Patterns()
    {
        ...
        // Shim Coils Default
        Parameters["tShimXccValue"] = 9.878; // 8.8; //8.8; //  0.0
        Parameters["tShimYccValue"] = -2.375; // 3.8;//3.8; // -2.0
        ...
        Parameters["tTweezerBackgroundDelay"] = 1; // 20000
    }
    // Digital Pattern
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.AddEdge("tTweezerSwitch", End, false); // Turn ON tweezer switch at start of molasses loading
