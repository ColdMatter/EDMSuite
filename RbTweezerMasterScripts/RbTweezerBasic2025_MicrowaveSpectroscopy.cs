 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["tMicrowaveVCF3"] = -1.118;
        Parameters["tMicrowaveVCF4"] = -1.178;
        Parameters["tMicrowaveVCF5"] = -2.2945;
        //Parameters["tMicrowaveVCF6"] = -1.178;
        ...
        Parameters["TOF1"] = 1;
        // Image 1
        Parameters["tBiasShimRampDuration"] = 10; // should be less than TOF2
        Parameters["TOF2"] = 5000;
        Parameters["PumpPulseDuration"] = 20;
        Parameters["RePumpPulseDuration"] = 20;
        Parameters["MicrowavePulse1Duration"] = 100;
        Parameters["CleanPulseDuration"] = 100;
        Parameters["MicrowavePulse2Duration"] = 500;
        Parameters["MicrowavePulse3Duration"] = 1200;
        Parameters["TOF3"] = 100;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int MicrowavePulse1Start = PumpPulseStart + (int)Parameters["PumpPulseDuration"];
        int CleanPulseStart = MicrowavePulse1Start + (int)Parameters["MicrowavePulse1Duration"] + 10;
        int MicrowavePulse2Start = CleanPulseStart + (int)Parameters["CleanPulseDuration"] + 10;
        int MicrowavePulse3Start = MicrowavePulse2Start + (int)Parameters["MicrowavePulse2Duration"] + 10;
        int TOF3Start = MicrowavePulse3Start + (int)Parameters["MicrowavePulse3Duration"];
        ...
        p.AddEdge("tD1AOMSwitch", MicrowavePulse1Start, true);
        p.Pulse(PumpPulseStart, 0, (int)Parameters["PumpPulseDuration"], "tRepSwitch");

        // Microwave Pulse
        p.Pulse(MicrowavePulse1Start, 0, (int)Parameters["MicrowavePulse1Duration"], "tMicrowaveSwitch");
        p.Pulse(MicrowavePulse2Start, 0, (int)Parameters["MicrowavePulse2Duration"], "tMicrowaveSwitch");
        p.Pulse(MicrowavePulse3Start, 0, (int)Parameters["MicrowavePulse3Duration"], "tMicrowaveSwitch");

        // Push Pulse
        //p.Pulse(CleanPulseStart, 0, (int)Parameters["CleanPulseDuration"], "tCoolSwitch"); // Red Molasses Coolng Pulse
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddLinearRamp("tMicrowaveModVCF", MicrowavePulse1Start, (int)Parameters["MicrowavePulse1Duration"], (double)Parameters["tMicrowaveVCF2"]);

        p.AddAnalogValue("tMicrowaveModVCF", MicrowavePulse2Start - 5, (double)Parameters["tMicrowaveVCF3"]);
        p.AddLinearRamp("tMicrowaveModVCF", MicrowavePulse2Start, (int)Parameters["MicrowavePulse2Duration"], (double)Parameters["tMicrowaveVCF4"]);

        p.AddAnalogValue("tMicrowaveModVCF", MicrowavePulse3Start - 5, (double)Parameters["tMicrowaveVCF5"]);
        //p.AddLinearRamp("tMicrowaveModVCF", MicrowavePulse3Start, (int)Parameters["MicrowavePulse3Duration"], (double)Parameters["tMicrowaveVCF6"]);
