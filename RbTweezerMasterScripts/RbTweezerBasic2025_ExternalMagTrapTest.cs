 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["tCMOTccValue"] = 1.8;// 1.8;
        Parameters["tIntMagTrapccValue"] = 1.8;// 1.8;
        Parameters["tExtMagTrapccValue"] = 10.0;

        Parameters["tMOTccSwitchON"] = 0.0;
        Parameters["tMOTccSwitchOFF"] = 5.5;
        ...
        Parameters["tRbRedCompressedMOTRampDuration"] = 100;
        Parameters["tRbRedCompressedMOTDuration"] = 1000;
        Parameters["tRbRedMolassesDuration"] = 2000;
        Parameters["tRbRedPumpPulseDuration"] = 1; // 100 = 1 ms pulse
        Parameters["InternalMagTrapRampDuration"] = 1; // 200;
        Parameters["InternalMagTrapDuration"] = 1; // 2000;
        Parameters["ExternalMagTrapRampDuration"] = 1; // 10000 = 100 ms MUST!
        Parameters["ExternalMagTrapDuration"] = 1; // 1000
        Parameters["InternalMagTrapDuration2"] = 1;
        Parameters["tImgTOF"] = 1000;
        Parameters["tMOTExposure"] = 200;
        Parameters["tTweezerExposure"] = 200;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int ExternalMagTrapRampUpStart = InternalMagTrapStart + (int)Parameters["InternalMagTrapDuration"];
        int ExternalMagTrapStart = ExternalMagTrapRampUpStart + (int)Parameters["ExternalMagTrapRampDuration"];
        int ExternalMagTrapRampDownStart = ExternalMagTrapStart + (int)Parameters["ExternalMagTrapDuration"];
        int InternalMagTrap2Start = ExternalMagTrapRampDownStart + (int)Parameters["ExternalMagTrapRampDuration"];
        int ImgTOFStart = InternalMagTrap2Start + (int)Parameters["InternalMagTrapDuration2"];
        ...
        //p.Pulse(ExternalMagTrapStart, 0, (int)Parameters["ExternalMagTrapDuration"], "tCoolSwitch"); // Red MOT Coolng Pulse
        //p.Pulse(ExternalMagTrapStart, 0, (int)Parameters["ExternalMagTrapDuration"], "tRepSwitch"); // Red MOT Repump Pulse
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        // MOT Coils
        p.AddAnalogValue("tMOTccSwitch", RedMOTStart, (double)Parameters["tMOTccSwitchON"]); // MOT coils switch-on (RSD)
        p.AddAnalogValue("tMOTccSwitch", ImgTOFStart, (double)Parameters["tMOTccSwitchOFF"]); // MOT coils switch-off (RSD)
        ...
        p.AddLinearRamp("tMOTcc", InternalMagTrapRampStart, (int)Parameters["InternalMagTrapRampDuration"], (double)Parameters["tIntMagTrapccValue"]);
        p.AddAnalogValue("tMOTcc", InternalMagTrapStart, (double)Parameters["tIntMagTrapccValue"]); // MOT Mag field
        p.AddLinearRamp("tMOTcc", ExternalMagTrapRampUpStart, (int)Parameters["ExternalMagTrapRampDuration"], 0.0);

        p.AddAnalogValue("tMagneticTrapcc", RedMOTStart, 0.0);
        p.AddLinearRamp("tMagneticTrapcc", ExternalMagTrapRampUpStart, (int)Parameters["ExternalMagTrapRampDuration"], (double)Parameters["tExtMagTrapccValue"]);
        p.AddAnalogValue("tMagneticTrapcc", ExternalMagTrapStart, (double)Parameters["tExtMagTrapccValue"]); // MOT Mag field
        p.AddLinearRamp("tMagneticTrapcc", ExternalMagTrapRampDownStart, (int)Parameters["ExternalMagTrapRampDuration"], 0.0);

        p.AddLinearRamp("tMOTcc", ExternalMagTrapRampDownStart, (int)Parameters["ExternalMagTrapRampDuration"], (double)Parameters["tIntMagTrapccValue"]);
        p.AddAnalogValue("tMOTcc", InternalMagTrap2Start, (double)Parameters["tIntMagTrapccValue"]); // MOT Mag field
        p.AddAnalogValue("tMOTcc", ImgTOFStart, 0.0); // MOT Mag field
