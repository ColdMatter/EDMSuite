 ...
 * */
{
    public Patterns()
    {
        ...
        // General
        Parameters["PatternLength"] = 320000;
        ...
        Parameters["tMOTRep"] = 3.6;
        Parameters["tMOTCoolVVA"] = 2.0; // 0.6 
        Parameters["tMOTRepVVA"] = 2.0;

        // Imaging Cooling and Repump VCO & VVA
        Parameters["tImgCool"] = 3.6; // 3.6 - 4.0, resonance is 4.0
        Parameters["tImgRep"] = 3.6; // 3.0
        Parameters["tImgCoolVVA"] = 2.0;
        Parameters["tImgRepVVA"] = 2.0;

        // Molasses Cooling and Repump VCO & VVA
        Parameters["tMolCool"] = 3.6; //1.2
        Parameters["tMolRep"] =3.6; //1.0
        Parameters["tMolCoolVVA"] = 5.0;
        Parameters["tMolRepVVA"] = 5.0;
        ...
        Parameters["tTweezerLoadVCA"] = 0.0; // 1 -> 100% power
        Parameters["tTweezerImgVCA"] = 0.0; // 1 -> 100% power

        // Timing
        Parameters["tRbMOTStart"] = 10;
        Parameters["tRbRedMOTDuration"] = 240000;
        ...
        Parameters["tTweezerModulationDuration"] = 4000;
        Parameters["tImgTOF"] = 400;
        Parameters["tMOTExposure"] = 8000;
        Parameters["tTweezerExposure"] = 20000;
        Parameters["tTweezerBackgroundDelay"] = 30000;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int TweezerModulationStart = RedMolassesStart + (int)Parameters["tRbRedMolassesDuration"];
        int ImgTOFStart = TweezerModulationStart + (int)Parameters["tTweezerModulationDuration"];
        ...
        // Red MOT Laser
        p.AddEdge("tRbShutter", RedMOTStart, true);
        ...
        // Tweezer
        //p.AddEdge("tTweezerModSwitch", TweezerModulationStart, true); // Turn ON tweezer modulation 
        //p.AddEdge("tTweezerModSwitch", ImgTOFStart, false); // Turn OFF tweezer modulation 
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("tMOTccSwitch", RedMolDelayStart, (double)Parameters["tMOTccSwitch"]); // MOT coils switch-off (RSD)
        ...
        p.AddAnalogValue("tTweezerVCA", BgStart + (int)Parameters["tTweezerExposure"], (double)Parameters["tTweezerLoadVCA"]);
