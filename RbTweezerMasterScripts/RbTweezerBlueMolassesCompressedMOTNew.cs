 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["tShimXccValue"] = 0.0; //  7.5
        ...
        Parameters["tBlueMolassesVVA"] = 0.0; // 10.0
        Parameters["tBlueMolassesVVARamp"] = 0.0; // 4.0, 10.0
 
        Parameters["tBlueMotVCO"] = 3.0; // 5.0 for blue MOT
        Parameters["tBlueMotVVA"] = 0.0;// 6.5 for blue MOT
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        // MOT Laser
        p.Pulse(rbMOTStart, 0, (int)Parameters["tRbMOTDuration"] + (int)Parameters["tRbcMOTDuration"], "tCoolSwitch"); // Red MOT Coolng Pulse //+ (int)Parameters["tRbBlueMOTDuration"]
