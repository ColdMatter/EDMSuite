 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["TOF2"] = 2000; // Freefall and expansion
        Parameters["tTweezerModulationDuration"] = 10000;
        ...
        Parameters["tMOTCoolImg"] = 2.6; // 4.2 V On-resonance
        ...
        Parameters["tTweezerVCF"] = 10.0; // Tweezer modulation VCF (-10 -> 10 V)
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int ModulationStart = TOF2Start + (int)Parameters["TOF2"];
        int imagingStart = ModulationStart + (int)Parameters["tTweezerModulationDuration"];
        ...
        // Tweezer Modulation Switch
        p.AddEdge("tTweezerModSwitch", ModulationStart, true); // Turn on modulation
        p.AddEdge("tTweezerModSwitch", imagingStart, false);
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        // Tweezer Modulation VCF
        p.AddAnalogValue("tTweezerModVCF", rbMOTStart, (double)Parameters["tTweezerVCF"]);
