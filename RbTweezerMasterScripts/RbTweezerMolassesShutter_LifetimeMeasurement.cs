 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["tMOTCoolImg"] = 4.2; // 4.2 V On-resonance
        Parameters["tMOTRepImg"] = 4.2; // 3.0
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int End = (int)Parameters["PatternLength"] + (int)Parameters["TOF2"];
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        AnalogPatternBuilder p = new AnalogPatternBuilder((int)Parameters["PatternLength"] + (int)Parameters["TOF2"]);
