 ...
 * */
{
    public Patterns()
    {
        ...
        // General
        Parameters["PatternLength"] = 110000;
        ...
        Parameters["tMOTCool"] = 3.5; //Cool at 2.4 - 2.6
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int TweezerModStart = BlueMolassesStart + (int)Parameters["tRbBlueMolassesDuration"];
        int ImgTOFStart = TweezerModStart + (int)Parameters["tTweezerModDuration"];
