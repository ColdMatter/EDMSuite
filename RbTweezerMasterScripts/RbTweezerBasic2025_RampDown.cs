 ...
 * */
{
    public Patterns()
    {
        ...
        // Shim Coils Default
        Parameters["tShimXccValue"] = 8.8; // 8.8; //8.8; //  4.0
        ...
        Parameters["tMOTCool"] = 2.8; //Cool at 2.4 - 2.6
        Parameters["tMOTRep"] = 3.5;
        Parameters["tMOTCoolVVA"] = 1.0; // between 0 and 1 V
        Parameters["tMOTRepVVA"] = 1.0;

        // Imaging Cooling and Repump VCO & VVA
        Parameters["tImgCool"] = 4.5; // 3.6 - 4.0, resonance is 4.0
        Parameters["tImgRep"] = 4.25; // 3.0
        Parameters["tImgCoolVVA"] = 1.0;
        Parameters["tImgRepVVA"] = 1.0;

        // Molasses Cooling and Repump VCO & VVA
        Parameters["tMolCool"] = 1.2;
        Parameters["tMolRep"] = 2.0;
        Parameters["tMolCoolVVA"] = 0.0;
        Parameters["tMolRepVVA"] = 0.0;
        ...
        Parameters["tRbRedMOTDuration"] = 320000;
        Parameters["tMolassesDelay"] = 1;
        Parameters["tRbRedMolassesDuration"] = 1;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.AddEdge("tD1AOMSwitch", RedMOTStart + 1, false); // Turn off D1 light for sequence
        ...
        // Tweezer
        //p.AddEdge("tTweezerSwitch", RedMOTStart, false); // Turn ON tweezer switch at start of red MOT
        //p.AddEdge("tTweezerModSwitch", RedMOTStart, false); // Turn OFF tweezer modulation 
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddLinearRamp("tMOTcc", ImgTOFStart - 300000, 300000, 0.0); // Ramp down
