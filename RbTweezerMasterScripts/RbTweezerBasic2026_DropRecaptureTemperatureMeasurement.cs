 ...
 * */
{
    public Patterns()
    {
        ...
        // Shim Coils Default
        Parameters["tShimXccValue"] = 9.8780; // 8.8; //8.8; //  0.0
        Parameters["tShimYccValue"] = -2.3751; // 3.8;//3.8; // -2.0
        Parameters["tShimZccValue"] = -0.0378; // 0.3; //0.3; // -0.85
        ...
        Parameters["tDropDuration"] = 20;
        Parameters["tTweezerImg2Delay"] = 900; 
    }
