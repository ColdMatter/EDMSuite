 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["tShimXccValue"] = 4.0; //8.8; //  8.0
        Parameters["tShimYccValue"] = -2.0;//3.8; // -5.0
        Parameters["tShimZccValue"] = -0.85; //0.3; // -1.0
        ...
        Parameters["tMOTExpo"] = 200;
        Parameters["tRbMOTDuration"] = 170000;
        Parameters["tRbcMOTDuration"] = 1; //1000
        Parameters["tRbMolassesDuration"] = 1;
        Parameters["tRbBlueMolassesDuration"] = 10000; // 500
        ...
        // tRb AOMs
        Parameters["tMOTCool"] = 2.4; //Cool at 2.4 - 2.6
        Parameters["tMOTRep"] = 2.4;

        Parameters["tMOTCoolImg"] = 2.2; // 3.6 - 4.0, resonance is 4.0
        Parameters["tMOTRepImg"] = 2.2; // 3.0
        ...
        Parameters["tMOTColVVAMol"] = 1.0;
        Parameters["tMOTRepVVAMol"] = 1.0;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        int rbMolStart = RbcMOTStart + (int)Parameters["tRbcMOTDuration"];
        int TOF1Start = rbMolStart + (int)Parameters["tRbMolassesDuration"];
        ...
        // MOT Laser
        p.Pulse(rbMOTStart-10, 0, (int)Parameters["tRbMOTDuration"] + (int)Parameters["tRbcMOTDuration"] + (int)Parameters["tRbMolassesDuration"], "tCoolSwitch"); // Red MOT Coolng Pulse //+ (int)Parameters["tRbBlueMOTDuration"]
        p.Pulse(rbMOTStart, 0, (int)Parameters["tRbMOTDuration"] + (int)Parameters["tRbcMOTDuration"] + (int)Parameters["tRbMolassesDuration"], "tRepSwitch"); // Red MOT Repump Pulse
        ...
        p.AddEdge("tTweezerSwitch", TOF1Start, true); // Turn on Tweezer   rbBlueMOTStart    rbMOTStart + 2000
        ...
        //p.Pulse(rbMolStart + 10, 0, (int)Parameters["tRbMolassesDuration"], "tCoolSwitch"); //D2 Molasses Cooling
        //p.Pulse(rbMolStart + 10, 0, (int)Parameters["tRbMolassesDuration"], "tRepSwitch"); //D2 Molasses Repump

        //p.AddEdge("tCoolSwitch", rbMolStart + 10, false);
        //p.AddEdge("tCoolSwitch", TOFStart, true);

        //p.AddEdge("tRepSwitch", rbMolStart + 10, false);
        //p.AddEdge("tRepSwitch", TOFStart, true);
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        p.AddAnalogValue("tMOTcc", rbMolStart, 0.01);// Molasses   
        ...
        p.AddAnalogValue("tRbCoolVCO", rbMolStart, (double)Parameters["tMOTCoolMol"]);// Cooling Frequency
        p.AddAnalogValue("tRbRepVCO", rbMolStart, (double)Parameters["tMOTRepMol"]);// Repump Frequency

        p.AddAnalogValue("tRbD2CoolVVA", rbMolStart, (double)Parameters["tMOTColVVAMol"]);// Cooling Power
        p.AddAnalogValue("tRbD2RepVVA", rbMolStart, (double)Parameters["tMOTRepVVAMol"]);// Repump Power
        ...
        p.AddAnalogValue("tD1Sideband" +
            "Control", End, (double)Parameters["tD1SidebandBlueMolasses"]);
