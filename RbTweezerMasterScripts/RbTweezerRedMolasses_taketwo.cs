 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["tShimXccValue"] = 8.8; //8.8; //  8.0
        Parameters["tShimYccValue"] = 3.8;//3.8; // -5.0
        Parameters["tShimZccValue"] = 0.3; //0.3; // -1.0
        ...
        Parameters["tMOTCoolImg"] = 3.4; // 3.6 - 4.0, resonance is 4.0
        Parameters["tMOTRepImg"] = 3.0; // 3.0

        Parameters["tMOTCoolMol"] = 2.8;
        Parameters["tMOTRepMol"] = 2.8;
        ...
        Parameters["TweezerExposure"] = 8000;
