 ...
 * */
{
    public Patterns()
    {
        ...
        Parameters["tScanCount"] = 1182;

        // tMOT coils
        Parameters["tMOTccValue"] = 0.48; //0.48
        Parameters["tBlueMOTccValue"] = 1.8; // 1.8 for blue MOT
        //Parameters["tcMOTccValue"] = 0.48;

        Parameters["tMOTccSwitch"] = 5.5;

        Parameters["tShimXccValue"] = 8.8; //  7.5
        Parameters["tShimYccValue"] = 3.8; // -8.0
        Parameters["tShimZccValue"] = 0.3; // -2.3
        ...
        //Parameters["tRbcMOTDuration"] = 1000;
        Parameters["tMOTExpo"] = 100;
        Parameters["tRbMOTDuration"] = 100000;
        Parameters["tRbBlueMolassesDuration"] = 500; // 500
        Parameters["tRbBlueMOTRampDuration"] = 1; // 500 for blue MOT
        Parameters["tRbBlueMOTDuration"] = 1000; // 500 for blue MOT



        // tRb AOMs
        Parameters["tMOTTopticaCool"] = 3.2; //Cool at 2.4 - 2.6
        ...
        Parameters["tBlueMotVVA"] =6.5;// 4.5 for blue MOT

        // tRb D1 sideband repump (limited between 0.15V and 0.45V)
        Parameters["tD1SidebandBlueMolasses"] = 0.40;
        Parameters["tD1SidebandBlueMOT"] = 0.35; // 0.24 for blue MOT 

        Parameters["TweezerExposure"] = 1000;
        Parameters["TweezerBackgroundWaitTime"] = 1000;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
       ...
       // p.AddEdge("tTweezerSwitch", rbBlueMolassesStart-2000, true); // Turn on Tweezer
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
       ...
       // p.AddAnalogValue("tMOTcc", RbcMOTStart, (double)Parameters["tcMOTccValue"]);// MOT coils
