...
namespace csAcq4
{
    public partial class FormMain : Form
    {
        ...
        //// Event handler for Camera Name Query
        //private void QueryCameraNameButton_Click(object sender, EventArgs e)
        //{
        //    MyDcamProp cameranameProp = new MyDcamProp(mydcam, dcamprop.getname);
        //    double cameraname = 0;
        //    if (getname.getvalue
        //        lue(ref roundedTemperature))
        //    {
        //        Console.WriteLine($"Current Sensor Temperature: {roundedTemperature:F2} degrees");
        //        SensorTemperatureLabel.Text = $"Current Sensor Temperature: {roundedTemperature:F2} degrees";
        //    }
        //    else
        //    {
