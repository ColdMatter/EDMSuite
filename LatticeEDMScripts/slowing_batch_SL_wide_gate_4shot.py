...
#%% Set data path
datadrive=str(os.environ["Onedrive"]+"\\Lattice EDM\\data")
month= "November2025"#"Slowing data to publish\\Slowing\\Free space\\White light\\70_20 MWV0V1V2"
date= "25"#"20June2025 Downstream"#
...
if len(files) > 0:
    ...
    if len(filesTXT) != 0:    
        ...
        with open(filesTXT[0]) as f:
                ...
                print("Probe default frequency (THz): ", RestWM)
    else:
