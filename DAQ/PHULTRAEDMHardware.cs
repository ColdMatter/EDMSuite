...
namespace DAQ.HAL
{
    ...
    public class PHULTRAEDMHardware : DAQ.HAL.Hardware
    {
        ...
        public PHULTRAEDMHardware()
        {
            ...
            tclConfigProbe.Cavities[probe].AddDefaultGain("LatticeProbeLaser", 0.04);
            ...
            AddDigitalOutputChannel("valve", digitalPatternBoardAddress, 0, 8);//it seeems to like having this here
            ...
            Info.Add("analogTrigger0", usbbreakout + "/PFI1");
            Info.Add("analogTrigger1", usbbreakout + "/PFI2");
