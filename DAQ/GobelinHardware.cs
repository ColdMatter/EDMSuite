...
namespace DAQ.HAL
{
    public class GobelinHardware : DAQ.HAL.Hardware
    {
        public GobelinHardware()
        {
            ...
            AddDigitalOutputChannel("ePol", daqBoard, 1, 0);
            AddDigitalOutputChannel("notEPol", daqBoard, 1, 1);
            AddDigitalOutputChannel("eBleed", daqBoard, 1, 2);
            ...
            AddAnalogInputChannel("cPlusMonitor", daqBoard + "/ai1", AITerminalConfiguration.Differential);
            AddAnalogInputChannel("cMinusMonitor", daqBoard + "/ai2", AITerminalConfiguration.Differential);


            //Counter Channels
            AddCounterChannel("westLeakage", daqBoard + "/ctr0");
            AddCounterChannel("eastLeakage", daqBoard + "/ctr1");
