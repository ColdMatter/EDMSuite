...
namespace DAQ.HAL
{
    public class LatticeEDMHardwareControllerAIs
    {
        ...
        public LatticeEDMHardwareControllerAIs()
        {

        }

        public LatticeEDMHardwareControllerAIs(string[] name, string[] channelName)
        {
            if (!Environs.Debug)
            {
