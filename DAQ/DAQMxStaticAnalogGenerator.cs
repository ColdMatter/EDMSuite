...
{
    public class DAQMxAnalogStaticGenerator
    {
        ...
        public void Configure(AnalogStaticBuilderSingleBoard aPattern, int clockRate)
        {
            Configure(aPattern, clockRate, false, true);
        }

        public void Configure(AnalogStaticBuilderSingleBoard aPattern, int clockRate, bool loop)
        {
            Configure(aPattern, clockRate, loop, true);
        }

        public void Configure(string taskName, AnalogStaticBuilderSingleBoard aPattern, int clockRate, bool loop, bool internalClk)
        {
        ...
        public void Configure(AnalogStaticBuilderSingleBoard aPattern, int clockRate, bool loop, bool internalClk)
        {
        ...
        public void configure_AO(AnalogStaticBuilderSingleBoard aPattern, int clockRate, bool loop, bool internalClk)
        {

            foreach (string keys in aPattern.StaticAnalogValues.Keys)
            {
