...
namespace DAQ.Analog
{
    ...
    public class AnalogPatternBuilderSingleBoard
    {
        [DataMember]
        ...
        public AnalogPatternBuilderSingleBoard(string[] channelNames, int patternLength)
        {
        ...
        public AnalogPatternBuilderSingleBoard(int patternLength)
        {
            AnalogPatterns = new Dictionary<string, Dictionary<int, double>>();
            PatternLength = patternLength;
        }
        ...
        public double[] buildSinglePattern(string channel)
        {
