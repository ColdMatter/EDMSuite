...
namespace TransferCavityLock2023
{
    public partial class LockControlPanel : UserControl
    {
        ...
        public void DisplayFit(double peakLocation)
        {
            UIHelper.ScatterGraphPlot(SlaveLaserIntensityScatterGraph, SlaveFitPlot, new double[] { peakLocation, peakLocation, peakLocation }, new double[] { 0, 0.5, 1 });
        }
