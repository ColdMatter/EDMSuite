...
namespace TransferCavityLock2023
{
    ...
    public class SlaveLaser : Laser
    {
        ...
        public override double VoltageError
        {
            get
            {
                double voltageDifferenceFromMaster = (double) peakLocation - (double) ParentCavity.Master.peakLocation;
        ...
        protected override void Lock()
        {
            ...
            LaserSetPoint = (double) peakLocation - (double) ParentCavity.Master.peakLocation;
