...
namespace TransferCavityLock2023
{
    public partial class CavityControlPanel : UserControl
    {
        ...
        public void DisplayMasterFitData(double peakLocation)
        {
            UIHelper.ScatterGraphPlot(MasterLaserIntensityScatterGraph, MasterFitPlot, new double[] { peakLocation, peakLocation, peakLocation}, new double[] { 0, 0.5, 1});
        }
    }
}
